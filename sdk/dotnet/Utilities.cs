...
namespace Pulumi.Sdwan
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Sdwan.version.txt");
    ...
    internal sealed class SdwanResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SdwanResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
