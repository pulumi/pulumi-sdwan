...
namespace Pulumi.Sdwan
{
    ...
    /// {
    ///     var example = new Sdwan.SystemOmpProfileParcel("example", new()
    ///     {
    ///         Name = "Example",
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/systemOmpProfileParcel:SystemOmpProfileParcel")]
    public partial class SystemOmpProfileParcel : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SystemOmpProfileParcel(string name, SystemOmpProfileParcelArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/systemOmpProfileParcel:SystemOmpProfileParcel", name, args ?? new SystemOmpProfileParcelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemOmpProfileParcel(string name, Input<string> id, SystemOmpProfileParcelState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/systemOmpProfileParcel:SystemOmpProfileParcel", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemOmpProfileParcel Get(string name, Input<string> id, SystemOmpProfileParcelState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemOmpProfileParcel(name, id, state, options);
        }
    }

    public sealed class SystemOmpProfileParcelArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// BGP - Default value: `false`
        /// </summary>
        ...
        public SystemOmpProfileParcelArgs()
        {
        }
        public static new SystemOmpProfileParcelArgs Empty => new SystemOmpProfileParcelArgs();
    }

    public sealed class SystemOmpProfileParcelState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// BGP - Default value: `false`
        /// </summary>
        ...
        public SystemOmpProfileParcelState()
        {
        }
        public static new SystemOmpProfileParcelState Empty => new SystemOmpProfileParcelState();
    }
}
