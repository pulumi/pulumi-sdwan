...
namespace Pulumi.Sdwan
{
    ...
    /// {
    ///     var example = new Sdwan.Index.SystemGlobalFeature("example", new()
    ///     {
    ///         Name = "Example",
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/systemGlobalFeature:SystemGlobalFeature")]
    public partial class SystemGlobalFeature : global::Pulumi.CustomResource
    {
        ...
        public SystemGlobalFeature(string name, SystemGlobalFeatureArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/systemGlobalFeature:SystemGlobalFeature", name, args ?? new SystemGlobalFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemGlobalFeature(string name, Input<string> id, SystemGlobalFeatureState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/systemGlobalFeature:SystemGlobalFeature", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemGlobalFeature Get(string name, Input<string> id, SystemGlobalFeatureState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class SystemGlobalFeatureArgs : global::Pulumi.ResourceArgs
    {
        ...
        public SystemGlobalFeatureArgs()
        {
        }
        public static new SystemGlobalFeatureArgs Empty => new SystemGlobalFeatureArgs();
    }
    ...
    public sealed class SystemGlobalFeatureState : global::Pulumi.ResourceArgs
    {
        ...
        public SystemGlobalFeatureState()
        {
        }
        public static new SystemGlobalFeatureState Empty => new SystemGlobalFeatureState();
    }
}
