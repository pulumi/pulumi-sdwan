...
namespace Pulumi.Sdwan
{
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/systemMrfProfileParcel:SystemMrfProfileParcel")]
    public partial class SystemMrfProfileParcel : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a SystemMrfProfileParcel resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public SystemMrfProfileParcel(string name, SystemMrfProfileParcelArgs? args = null, CustomResourceOptions? options = null)
            : base("sdwan:index/systemMrfProfileParcel:SystemMrfProfileParcel", name, args ?? new SystemMrfProfileParcelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SystemMrfProfileParcel(string name, Input<string> id, SystemMrfProfileParcelState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/systemMrfProfileParcel:SystemMrfProfileParcel", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SystemMrfProfileParcel Get(string name, Input<string> id, SystemMrfProfileParcelState? state = null, CustomResourceOptions? options = null)
        {
            return new SystemMrfProfileParcel(name, id, state, options);
        }
    }

    public sealed class SystemMrfProfileParcelArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The description of the profile parcel
        /// </summary>
        ...
        public SystemMrfProfileParcelArgs()
        {
        }
        public static new SystemMrfProfileParcelArgs Empty => new SystemMrfProfileParcelArgs();
    }

    public sealed class SystemMrfProfileParcelState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The description of the profile parcel
        /// </summary>
        ...
        public SystemMrfProfileParcelState()
        {
        }
        public static new SystemMrfProfileParcelState Empty => new SystemMrfProfileParcelState();
    }
}
