...
namespace Pulumi.Sdwan
{
    ...
    /// {
    ///     var example = new Sdwan.Index.ServiceRoutingOspfv3Ipv6Feature("example", new()
    ///     {
    ///         Name = "Example",
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/serviceRoutingOspfv3Ipv6Feature:ServiceRoutingOspfv3Ipv6Feature")]
    public partial class ServiceRoutingOspfv3Ipv6Feature : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Configure OSPFv3 IPv6 area
        /// </summary>
        [Output("areas")]
        public Output<ImmutableArray<Outputs.ServiceRoutingOspfv3Ipv6FeatureArea>> Areas { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ServiceRoutingOspfv3Ipv6FeatureRedistribute>> Redistributes { get; private set; } = null!;
        ...
        public ServiceRoutingOspfv3Ipv6Feature(string name, ServiceRoutingOspfv3Ipv6FeatureArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/serviceRoutingOspfv3Ipv6Feature:ServiceRoutingOspfv3Ipv6Feature", name, args ?? new ServiceRoutingOspfv3Ipv6FeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceRoutingOspfv3Ipv6Feature(string name, Input<string> id, ServiceRoutingOspfv3Ipv6FeatureState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/serviceRoutingOspfv3Ipv6Feature:ServiceRoutingOspfv3Ipv6Feature", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceRoutingOspfv3Ipv6Feature Get(string name, Input<string> id, ServiceRoutingOspfv3Ipv6FeatureState? state = null, CustomResourceOptions? options = null)
        {
            return new ServiceRoutingOspfv3Ipv6Feature(name, id, state, options);
        }
    }

    public sealed class ServiceRoutingOspfv3Ipv6FeatureArgs : global::Pulumi.ResourceArgs
    {
        [Input("areas")]
        private InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureAreaArgs>? _areas;

        /// <summary>
        /// Configure OSPFv3 IPv6 area
        /// </summary>
        public InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureAreaArgs> Areas
        {
            get => _areas ?? (_areas = new InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureAreaArgs>());
            set => _areas = value;
        }
        ...
        [Input("redistributes")]
        private InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs>? _redistributes;

        /// <summary>
        /// Redistribute routes
        /// </summary>
        public InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs>());
        ...
        public ServiceRoutingOspfv3Ipv6FeatureArgs()
        {
        }
        public static new ServiceRoutingOspfv3Ipv6FeatureArgs Empty => new ServiceRoutingOspfv3Ipv6FeatureArgs();
    }

    public sealed class ServiceRoutingOspfv3Ipv6FeatureState : global::Pulumi.ResourceArgs
    {
        [Input("areas")]
        private InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureAreaGetArgs>? _areas;

        /// <summary>
        /// Configure OSPFv3 IPv6 area
        /// </summary>
        public InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureAreaGetArgs> Areas
        {
            get => _areas ?? (_areas = new InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureAreaGetArgs>());
            set => _areas = value;
        }
        ...
        [Input("redistributes")]
        private InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureRedistributeGetArgs>? _redistributes;

        /// <summary>
        /// Redistribute routes
        /// </summary>
        public InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureRedistributeGetArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.ServiceRoutingOspfv3Ipv6FeatureRedistributeGetArgs>());
            set => _redistributes = value;
        }
        ...
        public ServiceRoutingOspfv3Ipv6FeatureState()
        {
        }
        public static new ServiceRoutingOspfv3Ipv6FeatureState Empty => new ServiceRoutingOspfv3Ipv6FeatureState();
    }
}
