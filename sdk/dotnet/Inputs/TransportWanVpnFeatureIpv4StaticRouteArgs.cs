...
namespace Pulumi.Sdwan.Inputs
{
    ...
    public sealed class TransportWanVpnFeatureIpv4StaticRouteArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("nextHops")]
        private InputList<Inputs.TransportWanVpnFeatureIpv4StaticRouteNextHopArgs>? _nextHops;

        /// <summary>
        /// IPv4 Route Gateway Next Hop, Attribute conditional on `gateway` being equal to `nextHop`
        /// </summary>
        public InputList<Inputs.TransportWanVpnFeatureIpv4StaticRouteNextHopArgs> NextHops
        {
            get => _nextHops ?? (_nextHops = new InputList<Inputs.TransportWanVpnFeatureIpv4StaticRouteNextHopArgs>());
            set => _nextHops = value;
        }
        ...
        public TransportWanVpnFeatureIpv4StaticRouteArgs()
        {
        }
        public static new TransportWanVpnFeatureIpv4StaticRouteArgs Empty => new TransportWanVpnFeatureIpv4StaticRouteArgs();
    }
}
