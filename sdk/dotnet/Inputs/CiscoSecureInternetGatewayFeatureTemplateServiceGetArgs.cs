...
namespace Pulumi.Sdwan.Inputs
{
    ...
    public sealed class CiscoSecureInternetGatewayFeatureTemplateServiceGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("interfacePairs")]
        private InputList<Inputs.CiscoSecureInternetGatewayFeatureTemplateServiceInterfacePairGetArgs>? _interfacePairs;

        /// <summary>
        /// Interface Pair for active and backup
        /// </summary>
        public InputList<Inputs.CiscoSecureInternetGatewayFeatureTemplateServiceInterfacePairGetArgs> InterfacePairs
        {
            get => _interfacePairs ?? (_interfacePairs = new InputList<Inputs.CiscoSecureInternetGatewayFeatureTemplateServiceInterfacePairGetArgs>());
        ...
        public CiscoSecureInternetGatewayFeatureTemplateServiceGetArgs()
        {
        }
        public static new CiscoSecureInternetGatewayFeatureTemplateServiceGetArgs Empty => new CiscoSecureInternetGatewayFeatureTemplateServiceGetArgs();
    }
}
