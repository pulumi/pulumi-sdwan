...
namespace Pulumi.Sdwan.Inputs
{
    ...
    public sealed class TransportManagementVpnFeatureIpv4StaticRouteArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("nextHops")]
        private InputList<Inputs.TransportManagementVpnFeatureIpv4StaticRouteNextHopArgs>? _nextHops;

        /// <summary>
        /// IPv4 Route Gateway Next Hop, Attribute conditional on `Gateway` being equal to `nextHop`
        /// </summary>
        public InputList<Inputs.TransportManagementVpnFeatureIpv4StaticRouteNextHopArgs> NextHops
        {
            get => _nextHops ?? (_nextHops = new InputList<Inputs.TransportManagementVpnFeatureIpv4StaticRouteNextHopArgs>());
            set => _nextHops = value;
        }
        ...
        public TransportManagementVpnFeatureIpv4StaticRouteArgs()
        {
        }
        public static new TransportManagementVpnFeatureIpv4StaticRouteArgs Empty => new TransportManagementVpnFeatureIpv4StaticRouteArgs();
    }
}
