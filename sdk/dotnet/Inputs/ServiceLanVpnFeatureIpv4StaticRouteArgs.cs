...
namespace Pulumi.Sdwan.Inputs
{
    ...
    public sealed class ServiceLanVpnFeatureIpv4StaticRouteArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceArgs>? _ipStaticRouteInterfaces;

        /// <summary>
        /// , Attribute conditional on `Gateway` being equal to `staticRouteInterface`
        /// </summary>
        public InputList<Inputs.ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceArgs> IpStaticRouteInterfaces
        {
            get => _ipStaticRouteInterfaces ?? (_ipStaticRouteInterfaces = new InputList<Inputs.ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceArgs>());
