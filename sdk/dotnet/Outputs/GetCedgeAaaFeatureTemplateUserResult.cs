...
namespace Pulumi.Sdwan.Outputs
{
    ...
    [OutputType]
    public sealed class GetCedgeAaaFeatureTemplateUserResult
    {
        /// <summary>
        /// Set the username
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCedgeAaaFeatureTemplateUserSshPubkeyResult> SshPubkeys;

        [OutputConstructor]
        private GetCedgeAaaFeatureTemplateUserResult(
            string name,
            ...
            ImmutableArray<Outputs.GetCedgeAaaFeatureTemplateUserSshPubkeyResult> sshPubkeys)
        {
            Name = name;
