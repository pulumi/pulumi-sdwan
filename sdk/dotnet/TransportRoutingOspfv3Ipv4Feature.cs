...
namespace Pulumi.Sdwan
{
    ...
    /// {
    ///     var example = new Sdwan.Index.TransportRoutingOspfv3Ipv4Feature("example", new()
    ///     {
    ///         Name = "Example",
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/transportRoutingOspfv3Ipv4Feature:TransportRoutingOspfv3Ipv4Feature")]
    public partial class TransportRoutingOspfv3Ipv4Feature : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Configure OSPFv3 IPv4 area
        /// </summary>
        [Output("areas")]
        public Output<ImmutableArray<Outputs.TransportRoutingOspfv3Ipv4FeatureArea>> Areas { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.TransportRoutingOspfv3Ipv4FeatureRedistribute>> Redistributes { get; private set; } = null!;
        ...
        public TransportRoutingOspfv3Ipv4Feature(string name, TransportRoutingOspfv3Ipv4FeatureArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/transportRoutingOspfv3Ipv4Feature:TransportRoutingOspfv3Ipv4Feature", name, args ?? new TransportRoutingOspfv3Ipv4FeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransportRoutingOspfv3Ipv4Feature(string name, Input<string> id, TransportRoutingOspfv3Ipv4FeatureState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/transportRoutingOspfv3Ipv4Feature:TransportRoutingOspfv3Ipv4Feature", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TransportRoutingOspfv3Ipv4Feature Get(string name, Input<string> id, TransportRoutingOspfv3Ipv4FeatureState? state = null, CustomResourceOptions? options = null)
        {
            return new TransportRoutingOspfv3Ipv4Feature(name, id, state, options);
        }
    }

    public sealed class TransportRoutingOspfv3Ipv4FeatureArgs : global::Pulumi.ResourceArgs
    {
        [Input("areas")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureAreaArgs>? _areas;

        /// <summary>
        /// Configure OSPFv3 IPv4 area
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureAreaArgs> Areas
        {
            get => _areas ?? (_areas = new InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureAreaArgs>());
            set => _areas = value;
        }
        ...
        [Input("redistributes")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureRedistributeArgs>? _redistributes;

        /// <summary>
        /// Redistribute routes
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureRedistributeArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureRedistributeArgs>());
        ...
        public TransportRoutingOspfv3Ipv4FeatureArgs()
        {
        }
        public static new TransportRoutingOspfv3Ipv4FeatureArgs Empty => new TransportRoutingOspfv3Ipv4FeatureArgs();
    }

    public sealed class TransportRoutingOspfv3Ipv4FeatureState : global::Pulumi.ResourceArgs
    {
        [Input("areas")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureAreaGetArgs>? _areas;

        /// <summary>
        /// Configure OSPFv3 IPv4 area
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureAreaGetArgs> Areas
        {
            get => _areas ?? (_areas = new InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureAreaGetArgs>());
            set => _areas = value;
        }
        ...
        [Input("redistributes")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureRedistributeGetArgs>? _redistributes;

        /// <summary>
        /// Redistribute routes
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureRedistributeGetArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.TransportRoutingOspfv3Ipv4FeatureRedistributeGetArgs>());
            set => _redistributes = value;
        }
        ...
        public TransportRoutingOspfv3Ipv4FeatureState()
        {
        }
        public static new TransportRoutingOspfv3Ipv4FeatureState Empty => new TransportRoutingOspfv3Ipv4FeatureState();
    }
}
