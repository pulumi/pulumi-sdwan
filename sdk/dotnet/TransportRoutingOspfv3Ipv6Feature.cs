...
namespace Pulumi.Sdwan
{
    ...
    /// {
    ///     var example = new Sdwan.Index.TransportRoutingOspfv3Ipv6Feature("example", new()
    ///     {
    ///         Name = "Example",
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/transportRoutingOspfv3Ipv6Feature:TransportRoutingOspfv3Ipv6Feature")]
    public partial class TransportRoutingOspfv3Ipv6Feature : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Configure OSPFv3 IPv6 area
        /// </summary>
        [Output("areas")]
        public Output<ImmutableArray<Outputs.TransportRoutingOspfv3Ipv6FeatureArea>> Areas { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.TransportRoutingOspfv3Ipv6FeatureRedistribute>> Redistributes { get; private set; } = null!;
        ...
        public TransportRoutingOspfv3Ipv6Feature(string name, TransportRoutingOspfv3Ipv6FeatureArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/transportRoutingOspfv3Ipv6Feature:TransportRoutingOspfv3Ipv6Feature", name, args ?? new TransportRoutingOspfv3Ipv6FeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransportRoutingOspfv3Ipv6Feature(string name, Input<string> id, TransportRoutingOspfv3Ipv6FeatureState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/transportRoutingOspfv3Ipv6Feature:TransportRoutingOspfv3Ipv6Feature", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TransportRoutingOspfv3Ipv6Feature Get(string name, Input<string> id, TransportRoutingOspfv3Ipv6FeatureState? state = null, CustomResourceOptions? options = null)
        {
            return new TransportRoutingOspfv3Ipv6Feature(name, id, state, options);
        }
    }

    public sealed class TransportRoutingOspfv3Ipv6FeatureArgs : global::Pulumi.ResourceArgs
    {
        [Input("areas")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureAreaArgs>? _areas;

        /// <summary>
        /// Configure OSPFv3 IPv6 area
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureAreaArgs> Areas
        {
            get => _areas ?? (_areas = new InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureAreaArgs>());
            set => _areas = value;
        }
        ...
        [Input("redistributes")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureRedistributeArgs>? _redistributes;

        /// <summary>
        /// Redistribute routes
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureRedistributeArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureRedistributeArgs>());
        ...
        public TransportRoutingOspfv3Ipv6FeatureArgs()
        {
        }
        public static new TransportRoutingOspfv3Ipv6FeatureArgs Empty => new TransportRoutingOspfv3Ipv6FeatureArgs();
    }

    public sealed class TransportRoutingOspfv3Ipv6FeatureState : global::Pulumi.ResourceArgs
    {
        [Input("areas")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureAreaGetArgs>? _areas;

        /// <summary>
        /// Configure OSPFv3 IPv6 area
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureAreaGetArgs> Areas
        {
            get => _areas ?? (_areas = new InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureAreaGetArgs>());
            set => _areas = value;
        }
        ...
        [Input("redistributes")]
        private InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureRedistributeGetArgs>? _redistributes;

        /// <summary>
        /// Redistribute routes
        /// </summary>
        public InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureRedistributeGetArgs> Redistributes
        {
            get => _redistributes ?? (_redistributes = new InputList<Inputs.TransportRoutingOspfv3Ipv6FeatureRedistributeGetArgs>());
            set => _redistributes = value;
        }
        ...
        public TransportRoutingOspfv3Ipv6FeatureState()
        {
        }
        public static new TransportRoutingOspfv3Ipv6FeatureState Empty => new TransportRoutingOspfv3Ipv6FeatureState();
    }
}
