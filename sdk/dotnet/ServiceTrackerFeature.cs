...
namespace Pulumi.Sdwan
{
    ...
    /// {
    ///     var example = new Sdwan.Index.ServiceTrackerFeature("example", new()
    ///     {
    ///         Name = "Example",
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/serviceTrackerFeature:ServiceTrackerFeature")]
    public partial class ServiceTrackerFeature : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ServiceTrackerFeature(string name, ServiceTrackerFeatureArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/serviceTrackerFeature:ServiceTrackerFeature", name, args ?? new ServiceTrackerFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceTrackerFeature(string name, Input<string> id, ServiceTrackerFeatureState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/serviceTrackerFeature:ServiceTrackerFeature", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceTrackerFeature Get(string name, Input<string> id, ServiceTrackerFeatureState? state = null, CustomResourceOptions? options = null)
        {
            return new ServiceTrackerFeature(name, id, state, options);
        }
    }

    public sealed class ServiceTrackerFeatureArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The description of the Feature
        /// </summary>
        ...
        public ServiceTrackerFeatureArgs()
        {
        }
        public static new ServiceTrackerFeatureArgs Empty => new ServiceTrackerFeatureArgs();
    }

    public sealed class ServiceTrackerFeatureState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The description of the Feature
        /// </summary>
        ...
        public ServiceTrackerFeatureState()
        {
        }
        public static new ServiceTrackerFeatureState Empty => new ServiceTrackerFeatureState();
    }
}
