...
namespace Pulumi.Sdwan
{
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/transportManagementVpnInterfaceEthernetProfileParcel:TransportManagementVpnInterfaceEthernetProfileParcel")]
    public partial class TransportManagementVpnInterfaceEthernetProfileParcel : global::Pulumi.CustomResource
    {
        /// <summary>
        /// Configure ARP entries
        /// </summary>
        [Output("arpEntries")]
        public Output<ImmutableArray<Outputs.TransportManagementVpnInterfaceEthernetProfileParcelArpEntry>> ArpEntries { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddress>> Ipv4SecondaryAddresses { get; private set; } = null!;
        ...
        /// </summary>
        [Output("transportManagementVpnProfileParcelId")]
        public Output<string?> TransportManagementVpnProfileParcelId { get; private set; } = null!;
        ...
        public TransportManagementVpnInterfaceEthernetProfileParcel(string name, TransportManagementVpnInterfaceEthernetProfileParcelArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/transportManagementVpnInterfaceEthernetProfileParcel:TransportManagementVpnInterfaceEthernetProfileParcel", name, args ?? new TransportManagementVpnInterfaceEthernetProfileParcelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransportManagementVpnInterfaceEthernetProfileParcel(string name, Input<string> id, TransportManagementVpnInterfaceEthernetProfileParcelState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/transportManagementVpnInterfaceEthernetProfileParcel:TransportManagementVpnInterfaceEthernetProfileParcel", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TransportManagementVpnInterfaceEthernetProfileParcel Get(string name, Input<string> id, TransportManagementVpnInterfaceEthernetProfileParcelState? state = null, CustomResourceOptions? options = null)
        {
            return new TransportManagementVpnInterfaceEthernetProfileParcel(name, id, state, options);
        }
    }

    public sealed class TransportManagementVpnInterfaceEthernetProfileParcelArgs : global::Pulumi.ResourceArgs
    {
        [Input("arpEntries")]
        private InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs>? _arpEntries;

        /// <summary>
        /// Configure ARP entries
        /// </summary>
        public InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs> ArpEntries
        {
            get => _arpEntries ?? (_arpEntries = new InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs>());
        ...
        private InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddressArgs>? _ipv4SecondaryAddresses;

        /// <summary>
        /// Secondary IpV4 Addresses
        /// </summary>
        public InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddressArgs> Ipv4SecondaryAddresses
        {
            get => _ipv4SecondaryAddresses ?? (_ipv4SecondaryAddresses = new InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddressArgs>());
        ...
        /// Transport Management VPN Profile Parcel ID
        /// </summary>
        [Input("transportManagementVpnProfileParcelId")]
        public Input<string>? TransportManagementVpnProfileParcelId { get; set; }

        public TransportManagementVpnInterfaceEthernetProfileParcelArgs()
        {
        }
        public static new TransportManagementVpnInterfaceEthernetProfileParcelArgs Empty => new TransportManagementVpnInterfaceEthernetProfileParcelArgs();
    }

    public sealed class TransportManagementVpnInterfaceEthernetProfileParcelState : global::Pulumi.ResourceArgs
    {
        [Input("arpEntries")]
        private InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelArpEntryGetArgs>? _arpEntries;

        /// <summary>
        /// Configure ARP entries
        /// </summary>
        public InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelArpEntryGetArgs> ArpEntries
        {
            get => _arpEntries ?? (_arpEntries = new InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelArpEntryGetArgs>());
            set => _arpEntries = value;
        }
        ...
        [Input("ipv4SecondaryAddresses")]
        private InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddressGetArgs>? _ipv4SecondaryAddresses;

        /// <summary>
        /// Secondary IpV4 Addresses
        /// </summary>
        public InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddressGetArgs> Ipv4SecondaryAddresses
        {
            get => _ipv4SecondaryAddresses ?? (_ipv4SecondaryAddresses = new InputList<Inputs.TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddressGetArgs>());
            set => _ipv4SecondaryAddresses = value;
        }
        ...
        public TransportManagementVpnInterfaceEthernetProfileParcelState()
        {
        }
        public static new TransportManagementVpnInterfaceEthernetProfileParcelState Empty => new TransportManagementVpnInterfaceEthernetProfileParcelState();
    }
}
