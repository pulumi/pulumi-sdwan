...
namespace Pulumi.Sdwan
{
    ...
    /// {
    ///     var example = new Sdwan.Index.TransportWanVpnInterfaceIpsecFeature("example", new()
    ///     {
    ///         Name = "Example",
    ...
    /// ```
    /// </summary>
    [SdwanResourceType("sdwan:index/transportWanVpnInterfaceIpsecFeature:TransportWanVpnInterfaceIpsecFeature")]
    public partial class TransportWanVpnInterfaceIpsecFeature : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("multiplexing")]
        public Output<bool?> Multiplexing { get; private set; } = null!;

        /// <summary>
        /// Variable name
        /// </summary>
        [Output("multiplexingVariable")]
        public Output<string?> MultiplexingVariable { get; private set; } = null!;
        ...
        public TransportWanVpnInterfaceIpsecFeature(string name, TransportWanVpnInterfaceIpsecFeatureArgs args, CustomResourceOptions? options = null)
            : base("sdwan:index/transportWanVpnInterfaceIpsecFeature:TransportWanVpnInterfaceIpsecFeature", name, args ?? new TransportWanVpnInterfaceIpsecFeatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransportWanVpnInterfaceIpsecFeature(string name, Input<string> id, TransportWanVpnInterfaceIpsecFeatureState? state = null, CustomResourceOptions? options = null)
            : base("sdwan:index/transportWanVpnInterfaceIpsecFeature:TransportWanVpnInterfaceIpsecFeature", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TransportWanVpnInterfaceIpsecFeature Get(string name, Input<string> id, TransportWanVpnInterfaceIpsecFeatureState? state = null, CustomResourceOptions? options = null)
        {
            return new TransportWanVpnInterfaceIpsecFeature(name, id, state, options);
        }
    }

    public sealed class TransportWanVpnInterfaceIpsecFeatureArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable Application Tunnel Type
        ///   - Choices: `None`, `Sig`
        ...
        /// </summary>
        [Input("multiplexing")]
        public Input<bool>? Multiplexing { get; set; }

        /// <summary>
        /// Variable name
        /// </summary>
        [Input("multiplexingVariable")]
        public Input<string>? MultiplexingVariable { get; set; }
        ...
        public TransportWanVpnInterfaceIpsecFeatureArgs()
        {
        }
        public static new TransportWanVpnInterfaceIpsecFeatureArgs Empty => new TransportWanVpnInterfaceIpsecFeatureArgs();
    }

    public sealed class TransportWanVpnInterfaceIpsecFeatureState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable Application Tunnel Type
        ///   - Choices: `None`, `Sig`
        ...
        public TransportWanVpnInterfaceIpsecFeatureState()
        {
        }
        public static new TransportWanVpnInterfaceIpsecFeatureState Empty => new TransportWanVpnInterfaceIpsecFeatureState();
    }
}
