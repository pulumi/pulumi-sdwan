...
// The version of the object
func (o TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureOutput) Version() pulumi.IntOutput {
	return o.ApplyT(func(v *TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature) pulumi.IntOutput {
		return v.Version
	}).(pulumi.IntOutput)
}
