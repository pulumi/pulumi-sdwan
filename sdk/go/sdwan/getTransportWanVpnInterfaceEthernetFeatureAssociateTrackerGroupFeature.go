...
//			_, err := sdwan.GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeature(ctx, &sdwan.LookupTransportWanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs{
