...
//			_, err := sdwan.GetServiceRoutingBgpFeature(ctx, &sdwan.LookupServiceRoutingBgpFeatureArgs{
...
// Set autonomous system number \n\n or \n\n
func (o LookupServiceRoutingBgpFeatureResultOutput) AsNumber() pulumi.StringOutput {
	return o.ApplyT(func(v LookupServiceRoutingBgpFeatureResult) string { return v.AsNumber }).(pulumi.StringOutput)
}
