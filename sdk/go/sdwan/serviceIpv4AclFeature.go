...
// Feature Profile ID
func (o ServiceIpv4AclFeatureOutput) FeatureProfileId() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceIpv4AclFeature) pulumi.StringOutput { return v.FeatureProfileId }).(pulumi.StringOutput)
}
