...
type TransportIpv6TrackerFeature struct {
	...
	//   - Range: `2`-`1000`
	//   - Default value: `2`
	IcmpInterval pulumi.IntPtrOutput `pulumi:"icmpInterval"`
	// Variable name, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface-icmp`
	IcmpIntervalVariable pulumi.StringPtrOutput `pulumi:"icmpIntervalVariable"`
...
type TransportIpv6TrackerFeatureState struct {
	...
	//   - Range: `2`-`1000`
	//   - Default value: `2`
	IcmpInterval pulumi.IntPtrInput
	// Variable name, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface-icmp`
	IcmpIntervalVariable pulumi.StringPtrInput
	// Probe Interval, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface`
	//   - Range: `20`-`600`
	//   - Default value: `60`
...
//   - Range: `2`-`1000`
//   - Default value: `2`
func (o TransportIpv6TrackerFeatureOutput) IcmpInterval() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *TransportIpv6TrackerFeature) pulumi.IntPtrOutput { return v.IcmpInterval }).(pulumi.IntPtrOutput)
}

// Variable name, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface-icmp`
func (o TransportIpv6TrackerFeatureOutput) IcmpIntervalVariable() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *TransportIpv6TrackerFeature) pulumi.StringPtrOutput { return v.IcmpIntervalVariable }).(pulumi.StringPtrOutput)
}
