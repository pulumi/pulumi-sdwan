...
class TlocListPolicyObject(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TlocListPolicyObjectEntryArgs', 'TlocListPolicyObjectEntryArgsDict', 'outputs.TlocListPolicyObjectEntry']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['TlocListPolicyObjectEntryArgs', 'TlocListPolicyObjectEntryArgsDict', 'outputs.TlocListPolicyObjectEntry']]]] entries: List of entries
        :param pulumi.Input[_builtins.str] name: The name of the policy object
        """
        ...
    @overload
