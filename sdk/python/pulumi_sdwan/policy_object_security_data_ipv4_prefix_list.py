...
class _PolicyObjectSecurityDataIpv4PrefixListState:
    def __init__(__self__, *,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectSecurityDataIpv4PrefixListEntryArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectSecurityDataIpv4PrefixListEntryArgs']]]]:
        return pulumi.get(self, "entries")

    @entries.setter
    def entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectSecurityDataIpv4PrefixListEntryArgs']]]]):
        pulumi.set(self, "entries", value)
