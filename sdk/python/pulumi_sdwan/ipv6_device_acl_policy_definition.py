...
class _Ipv6DeviceAclPolicyDefinitionState:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 sequences: pulumi.Input[Optional[Sequence[pulumi.Input['Ipv6DeviceAclPolicyDefinitionSequenceArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def sequences(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['Ipv6DeviceAclPolicyDefinitionSequenceArgs']]]]:
        """
        List of ACL sequences
        """
        return pulumi.get(self, "sequences")
    ...
    @sequences.setter
    def sequences(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['Ipv6DeviceAclPolicyDefinitionSequenceArgs']]]]):
        pulumi.set(self, "sequences", value)
...
class Ipv6DeviceAclPolicyDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 sequences: pulumi.Input[Optional[Sequence[pulumi.Input[Union['Ipv6DeviceAclPolicyDefinitionSequenceArgs', 'Ipv6DeviceAclPolicyDefinitionSequenceArgsDict', 'outputs.Ipv6DeviceAclPolicyDefinitionSequence']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: The description of the policy definition
        :param pulumi.Input[_builtins.str] name: The name of the policy definition
        :param pulumi.Input[Sequence[pulumi.Input[Union['Ipv6DeviceAclPolicyDefinitionSequenceArgs', 'Ipv6DeviceAclPolicyDefinitionSequenceArgsDict', 'outputs.Ipv6DeviceAclPolicyDefinitionSequence']]]] sequences: List of ACL sequences
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            sequences: pulumi.Input[Optional[Sequence[pulumi.Input[Union['Ipv6DeviceAclPolicyDefinitionSequenceArgs', 'Ipv6DeviceAclPolicyDefinitionSequenceArgsDict', 'outputs.Ipv6DeviceAclPolicyDefinitionSequence']]]]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.int]] = None) -> 'Ipv6DeviceAclPolicyDefinition':
        """
