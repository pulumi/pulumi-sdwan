...
class _PolicyObjectIpv6PrefixListState:
    def __init__(__self__, *,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectIpv6PrefixListEntryArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectIpv6PrefixListEntryArgs']]]]:
        """
        IPv6 Prefix List
        """
        return pulumi.get(self, "entries")
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectIpv6PrefixListEntryArgs']]]]):
        pulumi.set(self, "entries", value)
...
class PolicyObjectIpv6PrefixList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PolicyObjectIpv6PrefixListEntryArgs', 'PolicyObjectIpv6PrefixListEntryArgsDict', 'outputs.PolicyObjectIpv6PrefixListEntry']]]]] = None,
                 feature_profile_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: The description of the Policy_object
        :param pulumi.Input[Sequence[pulumi.Input[Union['PolicyObjectIpv6PrefixListEntryArgs', 'PolicyObjectIpv6PrefixListEntryArgsDict', 'outputs.PolicyObjectIpv6PrefixListEntry']]]] entries: IPv6 Prefix List
        :param pulumi.Input[_builtins.str] feature_profile_id: Feature Profile ID
        :param pulumi.Input[_builtins.str] name: The name of the Policy_object
        """
        ...
    ...
    def get(resource_name: str,
            ...
            feature_profile_id: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.int]] = None) -> 'PolicyObjectIpv6PrefixList':
        """
