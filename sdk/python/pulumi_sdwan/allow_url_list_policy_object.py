...
class _AllowUrlListPolicyObjectState:
    def __init__(__self__, *,
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input['AllowUrlListPolicyObjectEntryArgs']]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AllowUrlListPolicyObjectEntryArgs']]]]:
        """
        List of entries
        """
        return pulumi.get(self, "entries")
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AllowUrlListPolicyObjectEntryArgs']]]]):
        pulumi.set(self, "entries", value)
