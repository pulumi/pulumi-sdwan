...
class GetTransportWanVpnInterfaceGreFeatureResult:
    ...
    def __init__(__self__, application_tunnel_type=None, application_tunnel_type_variable=None, clear_dont_fragment=None, clear_dont_fragment_variable=None, description=None, dpd_interval=None, dpd_interval_variable=None, dpd_retries=None, dpd_retries_variable=None, feature_profile_id=None, id=None, ike_ciphersuite=None, ike_ciphersuite_variable=None, ike_group=None, ike_group_variable=None, ike_local_id=None, ike_local_id_variable=None, ike_mode=None, ike_mode_variable=None, ike_rekey_interval=None, ike_rekey_interval_variable=None, ike_remote_id=None, ike_remote_id_variable=None, ike_version=None, interface_description=None, interface_description_variable=None, interface_name=None, interface_name_variable=None, ipsec_ciphersuite=None, ipsec_ciphersuite_variable=None, ipsec_rekey_interval=None, ipsec_rekey_interval_variable=None, ipsec_replay_window=None, ipsec_replay_window_variable=None, ipv4_address=None, ipv4_address_variable=None, ipv4_mtu=None, ipv4_mtu_variable=None, ipv4_subnet_mask=None, ipv4_subnet_mask_variable=None, ipv4_tcp_mss=None, ipv4_tcp_mss_variable=None, ipv6_address=None, ipv6_address_variable=None, ipv6_mtu=None, ipv6_mtu_variable=None, ipv6_tcp_mss=None, ipv6_tcp_mss_variable=None, multiplexing=None, multiplexing_variable=None, name=None, perfect_forward_secrecy=None, perfect_forward_secrecy_variable=None, pre_shared_secret=None, pre_shared_secret_variable=None, shutdown=None, shutdown_variable=None, transport_wan_vpn_feature_id=None, tunnel_destination_ipv4_address=None, tunnel_destination_ipv4_address_variable=None, tunnel_destination_ipv6_address=None, tunnel_destination_ipv6_address_variable=None, tunnel_mode=None, tunnel_protection=None, tunnel_route_via_interface=None, tunnel_route_via_interface_variable=None, tunnel_route_via_ipv4_address=None, tunnel_route_via_ipv4_address_variable=None, tunnel_route_via_ipv6_address=None, tunnel_route_via_ipv6_address_variable=None, tunnel_route_via_loopback=None, tunnel_route_via_loopback_variable=None, tunnel_source_interface=None, tunnel_source_interface_loopback=None, tunnel_source_interface_loopback_variable=None, tunnel_source_interface_variable=None, tunnel_source_ipv4_address=None, tunnel_source_ipv4_address_variable=None, tunnel_source_ipv6_address=None, tunnel_source_ipv6_address_variable=None, version=None):
        ...
        if multiplexing and not isinstance(multiplexing, bool):
            raise TypeError("Expected argument 'multiplexing' to be a bool")
        pulumi.set(__self__, "multiplexing", multiplexing)
        if multiplexing_variable and not isinstance(multiplexing_variable, str):
            raise TypeError("Expected argument 'multiplexing_variable' to be a str")
    ...
    @_builtins.property
    @pulumi.getter
    def multiplexing(self) -> _builtins.bool:
        """
    ...
    def multiplexing_variable(self) -> _builtins.str:
        """
        Variable name
        """
...
class AwaitableGetTransportWanVpnInterfaceGreFeatureResult(GetTransportWanVpnInterfaceGreFeatureResult):
    ...
    def __await__(self):
        ...
        return GetTransportWanVpnInterfaceGreFeatureResult(
            ...
            multiplexing_variable=self.multiplexing_variable,
            name=self.name,
...
def get_transport_wan_vpn_interface_gre_feature(feature_profile_id: Optional[_builtins.str] = None,
    ...
    return AwaitableGetTransportWanVpnInterfaceGreFeatureResult(
        ...
        multiplexing=pulumi.get(__ret__, 'multiplexing'),
        multiplexing_variable=pulumi.get(__ret__, 'multiplexing_variable'),
...
def get_transport_wan_vpn_interface_gre_feature_output(feature_profile_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetTransportWanVpnInterfaceGreFeatureResult(
        ...
        multiplexing=pulumi.get(__response__, 'multiplexing'),
        multiplexing_variable=pulumi.get(__response__, 'multiplexing_variable'),
