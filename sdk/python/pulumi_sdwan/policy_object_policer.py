...
class _PolicyObjectPolicerState:
    def __init__(__self__, *,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectPolicerEntryArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectPolicerEntryArgs']]]]:
        """
        Policer Entries
        """
        return pulumi.get(self, "entries")
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectPolicerEntryArgs']]]]):
        pulumi.set(self, "entries", value)
