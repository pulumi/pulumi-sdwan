...
class _PolicyObjectAsPathListState:
    def __init__(__self__, *,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectAsPathListEntryArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="asPathListId")
    def as_path_list_id(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        As path List Number
          - Range: `1`-`500`
        """
    ...
    @as_path_list_id.setter
    def as_path_list_id(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "as_path_list_id", value)
    ...
    @_builtins.property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectAsPathListEntryArgs']]]]:
        """
        AS Path List
        """
        return pulumi.get(self, "entries")
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectAsPathListEntryArgs']]]]):
        pulumi.set(self, "entries", value)
