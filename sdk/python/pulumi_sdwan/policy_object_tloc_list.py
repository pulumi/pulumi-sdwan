...
class _PolicyObjectTlocListState:
    def __init__(__self__, *,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectTlocListEntryArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectTlocListEntryArgs']]]]:
        """
        TLOC List
        """
        return pulumi.get(self, "entries")
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PolicyObjectTlocListEntryArgs']]]]):
        pulumi.set(self, "entries", value)
