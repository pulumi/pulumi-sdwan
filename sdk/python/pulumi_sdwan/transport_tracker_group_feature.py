...
class TransportTrackerGroupFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 tracker_boolean: pulumi.Input[Optional[_builtins.str]] = None,
                 tracker_boolean_variable: pulumi.Input[Optional[_builtins.str]] = None,
                 tracker_elements: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TransportTrackerGroupFeatureTrackerElementArgs', 'TransportTrackerGroupFeatureTrackerElementArgsDict', 'outputs.TransportTrackerGroupFeatureTrackerElement']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] tracker_boolean: tracker ref list combine boolean and or
                 ...
                 - Default value: `or`
        :param pulumi.Input[_builtins.str] tracker_boolean_variable: Variable name
        :param pulumi.Input[Sequence[pulumi.Input[Union['TransportTrackerGroupFeatureTrackerElementArgs', 'TransportTrackerGroupFeatureTrackerElementArgsDict', 'outputs.TransportTrackerGroupFeatureTrackerElement']]]] tracker_elements: tracker parcel ref list
        """
        ...
    @overload
    def __init__(__self__,
