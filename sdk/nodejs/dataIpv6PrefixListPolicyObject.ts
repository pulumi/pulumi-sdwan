...
export class DataIpv6PrefixListPolicyObject extends pulumi.CustomResource {
     ...
     * List of entries
     */
    declare public readonly entries: pulumi.Output<outputs.DataIpv6PrefixListPolicyObjectEntry[]>;
    /**
...
export interface DataIpv6PrefixListPolicyObjectState {
     ...
     * List of entries
     */
    entries?: pulumi.Input<pulumi.Input<inputs.DataIpv6PrefixListPolicyObjectEntry>[] | undefined>;
    /**
     * The name of the policy object
     */
