 ...
 * ```
 */
export class EmbeddedSecurityNgfwPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EmbeddedSecurityNgfwPolicyState, opts?: pulumi.CustomResourceOptions): EmbeddedSecurityNgfwPolicy {
        return new EmbeddedSecurityNgfwPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/embeddedSecurityNgfwPolicy:EmbeddedSecurityNgfwPolicy';
     ...
     */
    public static isInstance(obj: any): obj is EmbeddedSecurityNgfwPolicy {
    ...
    declare public readonly sequences: pulumi.Output<outputs.EmbeddedSecurityNgfwPolicySequence[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EmbeddedSecurityNgfwPolicyArgs | EmbeddedSecurityNgfwPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EmbeddedSecurityNgfwPolicyState | undefined;
            ...
            const args = argsOrState as EmbeddedSecurityNgfwPolicyArgs | undefined;
