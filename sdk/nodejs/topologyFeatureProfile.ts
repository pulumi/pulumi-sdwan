 ...
 * ```
 */
export class TopologyFeatureProfile extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TopologyFeatureProfileState, opts?: pulumi.CustomResourceOptions): TopologyFeatureProfile {
        return new TopologyFeatureProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/topologyFeatureProfile:TopologyFeatureProfile';

    /**
     * Returns true if the given object is an instance of TopologyFeatureProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TopologyFeatureProfile {
    ...
    constructor(name: string, argsOrState?: TopologyFeatureProfileArgs | TopologyFeatureProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TopologyFeatureProfileState | undefined;
            resourceInputs["description"] = state?.description;
            resourceInputs["name"] = state?.name;
        } else {
            const args = argsOrState as TopologyFeatureProfileArgs | undefined;
