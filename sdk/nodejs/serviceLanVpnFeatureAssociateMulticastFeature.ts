 ...
 * ```
 */
export class ServiceLanVpnFeatureAssociateMulticastFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceLanVpnFeatureAssociateMulticastFeatureState, opts?: pulumi.CustomResourceOptions): ServiceLanVpnFeatureAssociateMulticastFeature {
        return new ServiceLanVpnFeatureAssociateMulticastFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/serviceLanVpnFeatureAssociateMulticastFeature:ServiceLanVpnFeatureAssociateMulticastFeature';
     ...
     */
    public static isInstance(obj: any): obj is ServiceLanVpnFeatureAssociateMulticastFeature {
     ...
     */
    declare public readonly serviceMulticastFeatureId: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceLanVpnFeatureAssociateMulticastFeatureArgs | ServiceLanVpnFeatureAssociateMulticastFeatureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ServiceLanVpnFeatureAssociateMulticastFeatureState | undefined;
            resourceInputs["featureProfileId"] = state?.featureProfileId;
            resourceInputs["serviceLanVpnFeatureId"] = state?.serviceLanVpnFeatureId;
            resourceInputs["serviceMulticastFeatureId"] = state?.serviceMulticastFeatureId;
            resourceInputs["version"] = state?.version;
        } else {
            const args = argsOrState as ServiceLanVpnFeatureAssociateMulticastFeatureArgs | undefined;
            ...
            if (args?.serviceMulticastFeatureId === undefined && !opts.urn) {
            ...
            resourceInputs["serviceMulticastFeatureId"] = args?.serviceMulticastFeatureId;
...
export interface ServiceLanVpnFeatureAssociateMulticastFeatureState {
     ...
     * Service Multicast Feature ID
     */
    serviceMulticastFeatureId?: pulumi.Input<string | undefined>;
    /**
     * The version of the object
     */
