 ...
 * ```
 */
export class TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureState, opts?: pulumi.CustomResourceOptions): TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature {
        return new TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/transportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature:TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature';

    /**
     * Returns true if the given object is an instance of TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs | TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureState | undefined;
            ...
            const args = argsOrState as TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs | undefined;
        ...
        super(TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureState {
    /**
     * Feature Profile ID
     */
 ...
 */
export interface TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs {
    /**
     * Feature Profile ID
     */
    featureProfileId: pulumi.Input<string>;
