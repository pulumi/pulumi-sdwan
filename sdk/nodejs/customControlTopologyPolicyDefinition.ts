 ...
 * ```
 */
export class CustomControlTopologyPolicyDefinition extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomControlTopologyPolicyDefinitionState, opts?: pulumi.CustomResourceOptions): CustomControlTopologyPolicyDefinition {
        return new CustomControlTopologyPolicyDefinition(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/customControlTopologyPolicyDefinition:CustomControlTopologyPolicyDefinition';

    /**
     * Returns true if the given object is an instance of CustomControlTopologyPolicyDefinition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CustomControlTopologyPolicyDefinition {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CustomControlTopologyPolicyDefinition.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: CustomControlTopologyPolicyDefinitionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CustomControlTopologyPolicyDefinitionArgs | CustomControlTopologyPolicyDefinitionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CustomControlTopologyPolicyDefinition.__pulumiType, name, resourceInputs, opts);
    }
}
