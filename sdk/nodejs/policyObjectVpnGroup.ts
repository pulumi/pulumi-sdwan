...
export class PolicyObjectVpnGroup extends pulumi.CustomResource {
     ...
     * VPN List
     */
    declare public readonly entries: pulumi.Output<outputs.PolicyObjectVpnGroupEntry[]>;
    /**
     * Feature Profile ID
     */
...
export interface PolicyObjectVpnGroupState {
     ...
     * VPN List
     */
    entries?: pulumi.Input<pulumi.Input<inputs.PolicyObjectVpnGroupEntry>[] | undefined>;
    /**
     * Feature Profile ID
     */
