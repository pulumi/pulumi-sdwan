 ...
 */
export interface GetApplicationPriorityQosPolicyArgs {
    /**
     * Feature Profile ID
     */
 ...
 */
export interface GetApplicationPriorityQosPolicyResult {
    /**
 ...
 * A collection of arguments for invoking getApplicationPriorityQosPolicy.
 */
export interface GetApplicationPriorityQosPolicyOutputArgs {
    /**
     * Feature Profile ID
     */
