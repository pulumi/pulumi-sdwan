 ...
 * ```
 */
export function getVpnInterfaceDslIpoeFeatureTemplate(args?: GetVpnInterfaceDslIpoeFeatureTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnInterfaceDslIpoeFeatureTemplateResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("sdwan:index/getVpnInterfaceDslIpoeFeatureTemplate:getVpnInterfaceDslIpoeFeatureTemplate", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 */
export interface GetVpnInterfaceDslIpoeFeatureTemplateArgs {
    /**
 ...
 */
export interface GetVpnInterfaceDslIpoeFeatureTemplateResult {
    /**
     * Apply ACL
     */
    readonly accessLists: outputs.GetVpnInterfaceDslIpoeFeatureTemplateAccessList[];
    /**
     ...
     */
    readonly ethernetDhcpHelpers: string[];
    /**
     * Enable DHCP
     */
    readonly ethernetEnableDhcp: boolean;
    /**
     * Variable name
     */
     ...
     */
    readonly natPortForwards: outputs.GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward[];
    /**
     ...
     * Enable policer
     */
    readonly policers: outputs.GetVpnInterfaceDslIpoeFeatureTemplatePolicer[];
    /**
     ...
     */
    readonly tunnelInterfaceEncapsulations: outputs.GetVpnInterfaceDslIpoeFeatureTemplateTunnelInterfaceEncapsulation[];
    /**
     * Variable name
     */
     ...
     * vdsl
     */
    readonly vdslConfigurations: outputs.GetVpnInterfaceDslIpoeFeatureTemplateVdslConfiguration[];
    /**
 ...
 * ```
 */
export function getVpnInterfaceDslIpoeFeatureTemplateOutput(args?: GetVpnInterfaceDslIpoeFeatureTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpnInterfaceDslIpoeFeatureTemplateResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("sdwan:index/getVpnInterfaceDslIpoeFeatureTemplate:getVpnInterfaceDslIpoeFeatureTemplate", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 * A collection of arguments for invoking getVpnInterfaceDslIpoeFeatureTemplate.
 */
export interface GetVpnInterfaceDslIpoeFeatureTemplateOutputArgs {
    /**
     * The id of the feature template
     */
