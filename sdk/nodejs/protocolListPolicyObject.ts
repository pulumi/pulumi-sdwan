...
export class ProtocolListPolicyObject extends pulumi.CustomResource {
     ...
     * List of entries
     */
    declare public readonly entries: pulumi.Output<outputs.ProtocolListPolicyObjectEntry[]>;
    /**
...
export interface ProtocolListPolicyObjectState {
     ...
     * List of entries
     */
    entries?: pulumi.Input<pulumi.Input<inputs.ProtocolListPolicyObjectEntry>[] | undefined>;
    /**
     * The name of the policy object
     */
