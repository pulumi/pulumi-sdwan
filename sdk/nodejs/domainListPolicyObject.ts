 ...
 * ```
 */
export class DomainListPolicyObject extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainListPolicyObjectState, opts?: pulumi.CustomResourceOptions): DomainListPolicyObject {
        return new DomainListPolicyObject(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/domainListPolicyObject:DomainListPolicyObject';

    /**
     * Returns true if the given object is an instance of DomainListPolicyObject.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DomainListPolicyObject {
    ...
    constructor(name: string, argsOrState?: DomainListPolicyObjectArgs | DomainListPolicyObjectState, opts?: pulumi.CustomResourceOptions) {
...
export interface DomainListPolicyObjectState {
     ...
     * List of entries
     */
    entries?: pulumi.Input<pulumi.Input<inputs.DomainListPolicyObjectEntry>[] | undefined>;
    /**
     * The name of the policy object
     */
