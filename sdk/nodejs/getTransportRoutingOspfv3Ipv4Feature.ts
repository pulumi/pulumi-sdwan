 ...
 * ```
 */
export function getTransportRoutingOspfv3Ipv4Feature(args: GetTransportRoutingOspfv3Ipv4FeatureArgs, opts?: pulumi.InvokeOptions): Promise<GetTransportRoutingOspfv3Ipv4FeatureResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("sdwan:index/getTransportRoutingOspfv3Ipv4Feature:getTransportRoutingOspfv3Ipv4Feature", {
 ...
 */
export interface GetTransportRoutingOspfv3Ipv4FeatureArgs {
    /**
     * Feature Profile ID
     */
 ...
 */
export interface GetTransportRoutingOspfv3Ipv4FeatureResult {
    /**
     * Configure OSPFv3 IPv4 area
     */
    readonly areas: outputs.GetTransportRoutingOspfv3Ipv4FeatureArea[];
    /**
     ...
     * Redistribute routes
     */
    readonly redistributes: outputs.GetTransportRoutingOspfv3Ipv4FeatureRedistribute[];
    /**
 ...
 * ```
 */
export function getTransportRoutingOspfv3Ipv4FeatureOutput(args: GetTransportRoutingOspfv3Ipv4FeatureOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTransportRoutingOspfv3Ipv4FeatureResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("sdwan:index/getTransportRoutingOspfv3Ipv4Feature:getTransportRoutingOspfv3Ipv4Feature", {
        "featureProfileId": args.featureProfileId,
        "id": args.id,
    }, opts);
}
 ...
 * A collection of arguments for invoking getTransportRoutingOspfv3Ipv4Feature.
 */
export interface GetTransportRoutingOspfv3Ipv4FeatureOutputArgs {
    /**
     * Feature Profile ID
     */
