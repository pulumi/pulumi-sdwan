...
export class TransportWanVpnInterfaceCellularFeature extends pulumi.CustomResource {
     ...
     * Variable name
     */
    declare public readonly enableIpv6Variable: pulumi.Output<string | undefined>;
    /**
     * Feature Profile ID
     */
    ...
    constructor(name: string, argsOrState?: TransportWanVpnInterfaceCellularFeatureArgs | TransportWanVpnInterfaceCellularFeatureState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["enableIpv6Variable"] = state?.enableIpv6Variable;
            ...
            resourceInputs["enableIpv6Variable"] = args?.enableIpv6Variable;
...
export interface TransportWanVpnInterfaceCellularFeatureState {
     ...
     * Configure ARP entries
     */
    arps?: pulumi.Input<pulumi.Input<inputs.TransportWanVpnInterfaceCellularFeatureArp>[] | undefined>;
    /**
     * Interface downstream bandwidth capacity, in kbps
     *   - Range: `1`-`2147483647`
     */
     ...
     * Variable name
     */
    enableIpv6Variable?: pulumi.Input<string | undefined>;
    /**
     * Feature Profile ID
     */
     ...
     * Encapsulation for TLOC
     */
    tunnelInterfaceEncapsulations?: pulumi.Input<pulumi.Input<inputs.TransportWanVpnInterfaceCellularFeatureTunnelInterfaceEncapsulation>[] | undefined>;
    /**
     * Variable name
     */
