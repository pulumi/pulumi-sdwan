...
export class SecurityAppHostingFeatureTemplate extends pulumi.CustomResource {
     ...
     */
    declare public readonly virtualApplications: pulumi.Output<outputs.SecurityAppHostingFeatureTemplateVirtualApplication[] | undefined>;
...
export interface SecurityAppHostingFeatureTemplateState {
     ...
     * Virtual application Instance
     */
    virtualApplications?: pulumi.Input<pulumi.Input<inputs.SecurityAppHostingFeatureTemplateVirtualApplication>[] | undefined>;
}
