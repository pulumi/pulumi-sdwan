 ...
 * ```
 */
export class ServiceLanVpnFeatureAssociateRoutingOspfFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceLanVpnFeatureAssociateRoutingOspfFeatureState, opts?: pulumi.CustomResourceOptions): ServiceLanVpnFeatureAssociateRoutingOspfFeature {
        return new ServiceLanVpnFeatureAssociateRoutingOspfFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/serviceLanVpnFeatureAssociateRoutingOspfFeature:ServiceLanVpnFeatureAssociateRoutingOspfFeature';
     ...
     */
    public static isInstance(obj: any): obj is ServiceLanVpnFeatureAssociateRoutingOspfFeature {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServiceLanVpnFeatureAssociateRoutingOspfFeature.__pulumiType;
    }
     ...
     */
    public readonly serviceRoutingOspfFeatureId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceLanVpnFeatureAssociateRoutingOspfFeatureArgs | ServiceLanVpnFeatureAssociateRoutingOspfFeatureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ServiceLanVpnFeatureAssociateRoutingOspfFeatureState | undefined;
            resourceInputs["featureProfileId"] = state ? state.featureProfileId : undefined;
            resourceInputs["serviceLanVpnFeatureId"] = state ? state.serviceLanVpnFeatureId : undefined;
            resourceInputs["serviceRoutingOspfFeatureId"] = state ? state.serviceRoutingOspfFeatureId : undefined;
            resourceInputs["version"] = state ? state.version : undefined;
        } else {
            const args = argsOrState as ServiceLanVpnFeatureAssociateRoutingOspfFeatureArgs | undefined;
            ...
            if ((!args || args.serviceRoutingOspfFeatureId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'serviceRoutingOspfFeatureId'");
            }
            resourceInputs["featureProfileId"] = args ? args.featureProfileId : undefined;
            resourceInputs["serviceLanVpnFeatureId"] = args ? args.serviceLanVpnFeatureId : undefined;
            resourceInputs["serviceRoutingOspfFeatureId"] = args ? args.serviceRoutingOspfFeatureId : undefined;
            resourceInputs["version"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(ServiceLanVpnFeatureAssociateRoutingOspfFeature.__pulumiType, name, resourceInputs, opts);
    }
}
