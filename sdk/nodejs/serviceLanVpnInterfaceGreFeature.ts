...
export class ServiceLanVpnInterfaceGreFeature extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceLanVpnInterfaceGreFeatureState, opts?: pulumi.CustomResourceOptions): ServiceLanVpnInterfaceGreFeature {
        return new ServiceLanVpnInterfaceGreFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/serviceLanVpnInterfaceGreFeature:ServiceLanVpnInterfaceGreFeature';
     ...
     */
    public static isInstance(obj: any): obj is ServiceLanVpnInterfaceGreFeature {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServiceLanVpnInterfaceGreFeature.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: ServiceLanVpnInterfaceGreFeatureArgs | ServiceLanVpnInterfaceGreFeatureState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceLanVpnInterfaceGreFeature.__pulumiType, name, resourceInputs, opts);
    }
}
