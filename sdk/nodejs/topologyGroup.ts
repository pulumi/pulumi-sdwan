 ...
 * ```
 */
export class TopologyGroup extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TopologyGroupState, opts?: pulumi.CustomResourceOptions): TopologyGroup {
        return new TopologyGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/topologyGroup:TopologyGroup';

    /**
     * Returns true if the given object is an instance of TopologyGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TopologyGroup {
    ...
    constructor(name: string, argsOrState?: TopologyGroupArgs | TopologyGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as TopologyGroupArgs | undefined;
