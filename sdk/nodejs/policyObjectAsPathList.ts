 ...
 * ```
 */
export class PolicyObjectAsPathList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyObjectAsPathListState, opts?: pulumi.CustomResourceOptions): PolicyObjectAsPathList {
        return new PolicyObjectAsPathList(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/policyObjectAsPathList:PolicyObjectAsPathList';

    /**
     * Returns true if the given object is an instance of PolicyObjectAsPathList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyObjectAsPathList {
    ...
    constructor(name: string, argsOrState?: PolicyObjectAsPathListArgs | PolicyObjectAsPathListState, opts?: pulumi.CustomResourceOptions) {
