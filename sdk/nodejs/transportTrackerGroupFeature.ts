 ...
 * ```
 */
export class TransportTrackerGroupFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransportTrackerGroupFeatureState, opts?: pulumi.CustomResourceOptions): TransportTrackerGroupFeature {
        return new TransportTrackerGroupFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/transportTrackerGroupFeature:TransportTrackerGroupFeature';

    /**
     * Returns true if the given object is an instance of TransportTrackerGroupFeature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransportTrackerGroupFeature {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransportTrackerGroupFeature.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: TransportTrackerGroupFeatureArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransportTrackerGroupFeatureArgs | TransportTrackerGroupFeatureState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TransportTrackerGroupFeature.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface TransportTrackerGroupFeatureState {
    /**
     * The description of the Feature
     */
     ...
     * tracker parcel ref list
     */
    trackerElements?: pulumi.Input<pulumi.Input<inputs.TransportTrackerGroupFeatureTrackerElement>[] | undefined>;
    /**
     * The version of the Feature
     */
 ...
 */
export interface TransportTrackerGroupFeatureArgs {
    /**
     * The description of the Feature
     */
    description?: pulumi.Input<string | undefined>;
