 ...
 * ```
 */
export class TopologyMeshFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TopologyMeshFeatureState, opts?: pulumi.CustomResourceOptions): TopologyMeshFeature {
        return new TopologyMeshFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/topologyMeshFeature:TopologyMeshFeature';

    /**
     * Returns true if the given object is an instance of TopologyMeshFeature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TopologyMeshFeature {
    ...
    constructor(name: string, argsOrState?: TopologyMeshFeatureArgs | TopologyMeshFeatureState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as TopologyMeshFeatureArgs | undefined;
