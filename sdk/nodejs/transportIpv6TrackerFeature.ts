 ...
 * ```
 */
export class TransportIpv6TrackerFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransportIpv6TrackerFeatureState, opts?: pulumi.CustomResourceOptions): TransportIpv6TrackerFeature {
        return new TransportIpv6TrackerFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/transportIpv6TrackerFeature:TransportIpv6TrackerFeature';

    /**
     * Returns true if the given object is an instance of TransportIpv6TrackerFeature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransportIpv6TrackerFeature {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransportIpv6TrackerFeature.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: TransportIpv6TrackerFeatureArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransportIpv6TrackerFeatureArgs | TransportIpv6TrackerFeatureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TransportIpv6TrackerFeatureState | undefined;
            ...
            const args = argsOrState as TransportIpv6TrackerFeatureArgs | undefined;
        ...
        super(TransportIpv6TrackerFeature.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface TransportIpv6TrackerFeatureState {
    /**
     * The description of the Feature
     */
 ...
 */
export interface TransportIpv6TrackerFeatureArgs {
    /**
     * The description of the Feature
     */
    description?: pulumi.Input<string>;
