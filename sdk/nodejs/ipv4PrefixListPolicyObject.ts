...
export class Ipv4PrefixListPolicyObject extends pulumi.CustomResource {
     ...
     * List of entries
     */
    declare public readonly entries: pulumi.Output<outputs.Ipv4PrefixListPolicyObjectEntry[]>;
    /**
    ...
    constructor(name: string, argsOrState?: Ipv4PrefixListPolicyObjectArgs | Ipv4PrefixListPolicyObjectState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Ipv4PrefixListPolicyObject.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface Ipv4PrefixListPolicyObjectState {
     ...
     * List of entries
     */
    entries?: pulumi.Input<pulumi.Input<inputs.Ipv4PrefixListPolicyObjectEntry>[] | undefined>;
    /**
     * The name of the policy object
     */
