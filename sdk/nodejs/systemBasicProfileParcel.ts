 ...
 * ```
 */
export class SystemBasicProfileParcel extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemBasicProfileParcelState, opts?: pulumi.CustomResourceOptions): SystemBasicProfileParcel {
        return new SystemBasicProfileParcel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/systemBasicProfileParcel:SystemBasicProfileParcel';

    /**
     * Returns true if the given object is an instance of SystemBasicProfileParcel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemBasicProfileParcel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemBasicProfileParcel.__pulumiType;
    }
     ...
     */
    public readonly affinityPerVrfs!: pulumi.Output<outputs.SystemBasicProfileParcelAffinityPerVrf[] | undefined>;
    /**
     ...
     */
    public readonly gpsSmsMobileNumbers!: pulumi.Output<outputs.SystemBasicProfileParcelGpsSmsMobileNumber[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args?: SystemBasicProfileParcelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemBasicProfileParcelArgs | SystemBasicProfileParcelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemBasicProfileParcelState | undefined;
            ...
            const args = argsOrState as SystemBasicProfileParcelArgs | undefined;
        ...
        super(SystemBasicProfileParcel.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SystemBasicProfileParcelState {
    /**
     * Collect admin-tech before reboot due to daemon failure - Default value: `true`
     */
     ...
     * Affinity Group Number for VRFs
     */
    affinityPerVrfs?: pulumi.Input<pulumi.Input<inputs.SystemBasicProfileParcelAffinityPerVrf>[]>;
    /**
     * Affinity Group Preference Auto - Default value: `false`
     */
     ...
     * Set device’s geo fencing SMS phone number
     */
    gpsSmsMobileNumbers?: pulumi.Input<pulumi.Input<inputs.SystemBasicProfileParcelGpsSmsMobileNumber>[]>;
    /**
     * Idle CLI timeout in minutes - Range: `0`-`300`
     */
 ...
 */
export interface SystemBasicProfileParcelArgs {
    /**
     * Collect admin-tech before reboot due to daemon failure - Default value: `true`
     */
    adminTechOnFailure?: pulumi.Input<boolean>;
