 ...
 * ```
 */
export function getServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureOutput(args: GetServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
