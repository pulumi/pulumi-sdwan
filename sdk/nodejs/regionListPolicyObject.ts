 ...
 * ```
 */
export class RegionListPolicyObject extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionListPolicyObjectState, opts?: pulumi.CustomResourceOptions): RegionListPolicyObject {
        return new RegionListPolicyObject(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/regionListPolicyObject:RegionListPolicyObject';

    /**
     * Returns true if the given object is an instance of RegionListPolicyObject.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RegionListPolicyObject {
     ...
     * List of entries
     */
    declare public readonly entries: pulumi.Output<outputs.RegionListPolicyObjectEntry[]>;
    /**
    ...
    constructor(name: string, argsOrState?: RegionListPolicyObjectArgs | RegionListPolicyObjectState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegionListPolicyObjectState | undefined;
            resourceInputs["entries"] = state?.entries;
            resourceInputs["name"] = state?.name;
            resourceInputs["version"] = state?.version;
        } else {
            const args = argsOrState as RegionListPolicyObjectArgs | undefined;
...
export interface RegionListPolicyObjectState {
     ...
     * List of entries
     */
    entries?: pulumi.Input<pulumi.Input<inputs.RegionListPolicyObjectEntry>[] | undefined>;
    /**
     * The name of the policy object
     */
