 ...
 * ```
 */
export class SystemPerformanceMonitoringProfileParcel extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemPerformanceMonitoringProfileParcelState, opts?: pulumi.CustomResourceOptions): SystemPerformanceMonitoringProfileParcel {
        return new SystemPerformanceMonitoringProfileParcel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/systemPerformanceMonitoringProfileParcel:SystemPerformanceMonitoringProfileParcel';

    /**
     * Returns true if the given object is an instance of SystemPerformanceMonitoringProfileParcel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemPerformanceMonitoringProfileParcel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemPerformanceMonitoringProfileParcel.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: SystemPerformanceMonitoringProfileParcelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemPerformanceMonitoringProfileParcelArgs | SystemPerformanceMonitoringProfileParcelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemPerformanceMonitoringProfileParcelState | undefined;
            ...
            const args = argsOrState as SystemPerformanceMonitoringProfileParcelArgs | undefined;
        ...
        super(SystemPerformanceMonitoringProfileParcel.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SystemPerformanceMonitoringProfileParcelState {
    /**
     * Application groups to be monitored
     */
 ...
 */
export interface SystemPerformanceMonitoringProfileParcelArgs {
    /**
     * Application groups to be monitored
     */
    appPerfMonitorAppGroups?: pulumi.Input<pulumi.Input<string>[]>;
