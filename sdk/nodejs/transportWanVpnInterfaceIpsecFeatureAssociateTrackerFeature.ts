...
export class TransportWanVpnInterfaceIpsecFeatureAssociateTrackerFeature extends pulumi.CustomResource {
     ...
     */
    declare public readonly transportWanVpnInterfaceIpsecFeatureId: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: TransportWanVpnInterfaceIpsecFeatureAssociateTrackerFeatureArgs | TransportWanVpnInterfaceIpsecFeatureAssociateTrackerFeatureState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["transportWanVpnInterfaceIpsecFeatureId"] = state?.transportWanVpnInterfaceIpsecFeatureId;
            ...
            if (args?.transportWanVpnInterfaceIpsecFeatureId === undefined && !opts.urn) {
            ...
            resourceInputs["transportWanVpnInterfaceIpsecFeatureId"] = args?.transportWanVpnInterfaceIpsecFeatureId;
...
export interface TransportWanVpnInterfaceIpsecFeatureAssociateTrackerFeatureState {
     ...
     * Transport WAN VPN Interface IPSEC Feature ID
     */
    transportWanVpnInterfaceIpsecFeatureId?: pulumi.Input<string | undefined>;
    /**
     * The version of the object
     */
