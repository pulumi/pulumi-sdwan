 ...
 * ```
 */
export class ServiceTrackerProfileParcel extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceTrackerProfileParcelState, opts?: pulumi.CustomResourceOptions): ServiceTrackerProfileParcel {
        return new ServiceTrackerProfileParcel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/serviceTrackerProfileParcel:ServiceTrackerProfileParcel';

    /**
     * Returns true if the given object is an instance of ServiceTrackerProfileParcel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServiceTrackerProfileParcel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServiceTrackerProfileParcel.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ServiceTrackerProfileParcelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ServiceTrackerProfileParcelArgs | ServiceTrackerProfileParcelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ServiceTrackerProfileParcelState | undefined;
            ...
            const args = argsOrState as ServiceTrackerProfileParcelArgs | undefined;
        ...
        super(ServiceTrackerProfileParcel.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ServiceTrackerProfileParcelState {
    /**
     * The description of the profile parcel
     */
 ...
 */
export interface ServiceTrackerProfileParcelArgs {
    /**
     * The description of the profile parcel
     */
    description?: pulumi.Input<string>;
