 ...
 * ```
 */
export class TopologyHubSpokeFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TopologyHubSpokeFeatureState, opts?: pulumi.CustomResourceOptions): TopologyHubSpokeFeature {
        return new TopologyHubSpokeFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/topologyHubSpokeFeature:TopologyHubSpokeFeature';

    /**
     * Returns true if the given object is an instance of TopologyHubSpokeFeature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TopologyHubSpokeFeature {
    ...
    constructor(name: string, argsOrState?: TopologyHubSpokeFeatureArgs | TopologyHubSpokeFeatureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TopologyHubSpokeFeatureState | undefined;
