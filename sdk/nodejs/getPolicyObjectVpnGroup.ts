 ...
 * ```
 */
export function getPolicyObjectVpnGroup(args: GetPolicyObjectVpnGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyObjectVpnGroupResult> {
 ...
 */
export interface GetPolicyObjectVpnGroupArgs {
    /**
     * Feature Profile ID
     */
 ...
 */
export interface GetPolicyObjectVpnGroupResult {
    /**
     ...
     * VPN List
     */
    readonly entries: outputs.GetPolicyObjectVpnGroupEntry[];
    /**
     * Feature Profile ID
     */
 ...
 * A collection of arguments for invoking getPolicyObjectVpnGroup.
 */
export interface GetPolicyObjectVpnGroupOutputArgs {
    /**
     * Feature Profile ID
     */
