 ...
 */
export interface GetTransportRoutingOspfFeatureArgs {
    /**
     * Feature Profile ID
     */
 ...
 */
export interface GetTransportRoutingOspfFeatureResult {
    /**
     * Configure OSPF area
     */
    readonly areas: outputs.GetTransportRoutingOspfFeatureArea[];
    /**
     ...
     * Redistribute routes
     */
    readonly redistributes: outputs.GetTransportRoutingOspfFeatureRedistribute[];
    /**
     ...
     */
    readonly routerLsas: outputs.GetTransportRoutingOspfFeatureRouterLsa[];
    /**
 ...
 * A collection of arguments for invoking getTransportRoutingOspfFeature.
 */
export interface GetTransportRoutingOspfFeatureOutputArgs {
    /**
     * Feature Profile ID
     */
