 ...
 * ```
 */
export class SystemBannerFeature extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemBannerFeatureState, opts?: pulumi.CustomResourceOptions): SystemBannerFeature {
        return new SystemBannerFeature(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/systemBannerFeature:SystemBannerFeature';

    /**
     * Returns true if the given object is an instance of SystemBannerFeature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemBannerFeature {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemBannerFeature.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: SystemBannerFeatureArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemBannerFeatureArgs | SystemBannerFeatureState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemBannerFeature.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SystemBannerFeatureState {
    /**
     * The description of the Feature
     */
 ...
 */
export interface SystemBannerFeatureArgs {
    /**
     * The description of the Feature
     */
    description?: pulumi.Input<string>;
