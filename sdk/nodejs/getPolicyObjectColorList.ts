 ...
 */
export interface GetPolicyObjectColorListArgs {
    /**
     * Feature Profile ID
     */
 ...
 */
export interface GetPolicyObjectColorListResult {
    /**
     ...
     * Color List
     */
    readonly entries: outputs.GetPolicyObjectColorListEntry[];
    /**
     * Feature Profile ID
     */
 ...
 * ```
 */
export function getPolicyObjectColorListOutput(args: GetPolicyObjectColorListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPolicyObjectColorListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
 ...
 * A collection of arguments for invoking getPolicyObjectColorList.
 */
export interface GetPolicyObjectColorListOutputArgs {
    /**
     * Feature Profile ID
     */
