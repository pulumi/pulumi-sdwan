 ...
 * ```
 */
export function getVpnInterfaceDslPppoeFeatureTemplate(args?: GetVpnInterfaceDslPppoeFeatureTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnInterfaceDslPppoeFeatureTemplateResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("sdwan:index/getVpnInterfaceDslPppoeFeatureTemplate:getVpnInterfaceDslPppoeFeatureTemplate", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 */
export interface GetVpnInterfaceDslPppoeFeatureTemplateArgs {
    /**
 ...
 */
export interface GetVpnInterfaceDslPppoeFeatureTemplateResult {
    /**
     * Apply ACL
     */
    readonly accessLists: outputs.GetVpnInterfaceDslPppoeFeatureTemplateAccessList[];
    /**
     ...
     */
    readonly ethernetDialerAddressNegotiated: boolean;
    /**
     * Dialer pool number
     */
     ...
     */
    readonly natPortForwards: outputs.GetVpnInterfaceDslPppoeFeatureTemplateNatPortForward[];
    /**
     ...
     * Enable policer
     */
    readonly policers: outputs.GetVpnInterfaceDslPppoeFeatureTemplatePolicer[];
    /**
     ...
     */
    readonly tunnelInterfaceEncapsulations: outputs.GetVpnInterfaceDslPppoeFeatureTemplateTunnelInterfaceEncapsulation[];
    /**
     * Variable name
     */
     ...
     * vdsl
     */
    readonly vdslConfigurations: outputs.GetVpnInterfaceDslPppoeFeatureTemplateVdslConfiguration[];
    /**
 ...
 * ```
 */
export function getVpnInterfaceDslPppoeFeatureTemplateOutput(args?: GetVpnInterfaceDslPppoeFeatureTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpnInterfaceDslPppoeFeatureTemplateResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("sdwan:index/getVpnInterfaceDslPppoeFeatureTemplate:getVpnInterfaceDslPppoeFeatureTemplate", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 * A collection of arguments for invoking getVpnInterfaceDslPppoeFeatureTemplate.
 */
export interface GetVpnInterfaceDslPppoeFeatureTemplateOutputArgs {
    /**
     * The id of the feature template
     */
