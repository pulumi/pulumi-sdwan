...
@CustomType
public final class SystemAaaProfileParcelRadiusGroupServer {
    /**
    ...
    private SystemAaaProfileParcelRadiusGroupServer() {}
    /**
     * @return Set Accounting port to use to connect to Radius server
     *   - Range: `1`-`65534`
     *   - Default value: `1813`
    ...
    public static Builder builder(SystemAaaProfileParcelRadiusGroupServer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeoutVariable;
        public Builder() {}
        public Builder(SystemAaaProfileParcelRadiusGroupServer defaults) {
        ...
        public SystemAaaProfileParcelRadiusGroupServer build() {
            final var _resultValue = new SystemAaaProfileParcelRadiusGroupServer();
