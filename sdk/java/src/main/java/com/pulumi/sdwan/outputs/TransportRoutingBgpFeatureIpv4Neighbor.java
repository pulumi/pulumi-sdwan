...
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv4NeighborAddressFamily;
...
@CustomType
public final class TransportRoutingBgpFeatureIpv4Neighbor {
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingBgpFeatureIpv4NeighborAddressFamily> addressFamilies;
    /**
    ...
    private TransportRoutingBgpFeatureIpv4Neighbor() {}
    /**
     * @return Set neighbor address
     * 
     */
     ...
     * 
     */
    public List<TransportRoutingBgpFeatureIpv4NeighborAddressFamily> addressFamilies() {
    ...
    public static Builder builder(TransportRoutingBgpFeatureIpv4Neighbor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updateSourceInterfaceVariable;
        public Builder() {}
        public Builder(TransportRoutingBgpFeatureIpv4Neighbor defaults) {
        ...
        @CustomType.Setter
        public Builder addressFamilies(@Nullable List<TransportRoutingBgpFeatureIpv4NeighborAddressFamily> addressFamilies) {

            this.addressFamilies = addressFamilies;
            return this;
        }
        public Builder addressFamilies(TransportRoutingBgpFeatureIpv4NeighborAddressFamily... addressFamilies) {
        ...
        public TransportRoutingBgpFeatureIpv4Neighbor build() {
            final var _resultValue = new TransportRoutingBgpFeatureIpv4Neighbor();
