...
@CustomType
public final class GetTransportRoutingBgpProfileParcelIpv4AggregateAddress {
    /**
    ...
    private GetTransportRoutingBgpProfileParcelIpv4AggregateAddress() {}
    /**
     * @return Set AS set path information
     * 
     */
    ...
    public static Builder builder(GetTransportRoutingBgpProfileParcelIpv4AggregateAddress defaults) {
    ...
    public static final class Builder {
        ...
        private String summaryOnlyVariable;
        public Builder() {}
        public Builder(GetTransportRoutingBgpProfileParcelIpv4AggregateAddress defaults) {
        ...
        public Builder asSetPath(Boolean asSetPath) {
            if (asSetPath == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "asSetPath");
            }
        ...
        public Builder asSetPathVariable(String asSetPathVariable) {
            if (asSetPathVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "asSetPathVariable");
            }
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "networkAddressVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "subnetMaskVariable");
            }
        ...
        public Builder summaryOnly(Boolean summaryOnly) {
            if (summaryOnly == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "summaryOnly");
            }
        ...
        public Builder summaryOnlyVariable(String summaryOnlyVariable) {
            if (summaryOnlyVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4AggregateAddress", "summaryOnlyVariable");
            }
            this.summaryOnlyVariable = summaryOnlyVariable;
            return this;
        }
        public GetTransportRoutingBgpProfileParcelIpv4AggregateAddress build() {
            final var _resultValue = new GetTransportRoutingBgpProfileParcelIpv4AggregateAddress();
