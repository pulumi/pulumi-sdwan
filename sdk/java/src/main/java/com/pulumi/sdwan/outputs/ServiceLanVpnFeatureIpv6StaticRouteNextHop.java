...
@CustomType
public final class ServiceLanVpnFeatureIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private ServiceLanVpnFeatureIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(ServiceLanVpnFeatureIpv6StaticRouteNextHop defaults) {
        ...
        public ServiceLanVpnFeatureIpv6StaticRouteNextHop build() {
            final var _resultValue = new ServiceLanVpnFeatureIpv6StaticRouteNextHop();
