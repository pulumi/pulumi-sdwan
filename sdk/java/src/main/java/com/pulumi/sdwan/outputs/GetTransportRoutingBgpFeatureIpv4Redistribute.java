...
@CustomType
public final class GetTransportRoutingBgpFeatureIpv4Redistribute {
    /**
    ...
    private GetTransportRoutingBgpFeatureIpv4Redistribute() {}
    /**
     * @return Metric value, the metric value helps determine the preference of routes when multiple paths are available. A lower metric is typically more preferred
     * 
     */
    ...
    public static Builder builder(GetTransportRoutingBgpFeatureIpv4Redistribute defaults) {
    ...
    public static final class Builder {
        ...
        private String routePolicyId;
        public Builder() {}
        public Builder(GetTransportRoutingBgpFeatureIpv4Redistribute defaults) {
        ...
        public Builder metric(Integer metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4Redistribute", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public Builder metricVariable(String metricVariable) {
            if (metricVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4Redistribute", "metricVariable");
            }
        ...
        public Builder ospfMatchRouteVariable(String ospfMatchRouteVariable) {
            if (ospfMatchRouteVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4Redistribute", "ospfMatchRouteVariable");
            }
        ...
        public Builder ospfMatchRoutes(List<String> ospfMatchRoutes) {
            if (ospfMatchRoutes == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4Redistribute", "ospfMatchRoutes");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4Redistribute", "protocol");
            }
        ...
        public Builder protocolVariable(String protocolVariable) {
            if (protocolVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4Redistribute", "protocolVariable");
            }
        ...
        public Builder routePolicyId(String routePolicyId) {
            if (routePolicyId == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4Redistribute", "routePolicyId");
            }
            this.routePolicyId = routePolicyId;
            return this;
        }
        public GetTransportRoutingBgpFeatureIpv4Redistribute build() {
            final var _resultValue = new GetTransportRoutingBgpFeatureIpv4Redistribute();
