...
@CustomType
public final class TransportWanVpnProfileParcelIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(TransportWanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(TransportWanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
        ...
        public TransportWanVpnProfileParcelIpv6StaticRouteNextHop build() {
            final var _resultValue = new TransportWanVpnProfileParcelIpv6StaticRouteNextHop();
