...
public final class ServiceRoutingOspfv3Ipv6FeatureArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceRoutingOspfv3Ipv6FeatureArgs Empty = new ServiceRoutingOspfv3Ipv6FeatureArgs();
     ...
     */
    @Import(name="areas")
    private @Nullable Output<List<ServiceRoutingOspfv3Ipv6FeatureAreaArgs>> areas;

    /**
     * @return Configure OSPFv3 IPv6 area
     * 
     */
    public Optional<Output<List<ServiceRoutingOspfv3Ipv6FeatureAreaArgs>>> areas() {
    ...
    private @Nullable Output<List<ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs>> redistributes;

    /**
     * @return Redistribute routes
     * 
     */
    public Optional<Output<List<ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs>>> redistributes() {
    ...
    private ServiceRoutingOspfv3Ipv6FeatureArgs() {}

    private ServiceRoutingOspfv3Ipv6FeatureArgs(ServiceRoutingOspfv3Ipv6FeatureArgs $) {
        this.areas = $.areas;
    ...
    public static Builder builder(ServiceRoutingOspfv3Ipv6FeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceRoutingOspfv3Ipv6FeatureArgs();
        }

        public Builder(ServiceRoutingOspfv3Ipv6FeatureArgs defaults) {
            $ = new ServiceRoutingOspfv3Ipv6FeatureArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder areas(@Nullable Output<List<ServiceRoutingOspfv3Ipv6FeatureAreaArgs>> areas) {
            $.areas = areas;
            return this;
        }
         ...
         * 
         */
        public Builder areas(List<ServiceRoutingOspfv3Ipv6FeatureAreaArgs> areas) {
         ...
         * 
         */
        public Builder areas(ServiceRoutingOspfv3Ipv6FeatureAreaArgs... areas) {
         ...
         * 
         */
        public Builder redistributes(@Nullable Output<List<ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs>> redistributes) {
         ...
         * 
         */
        public Builder redistributes(List<ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs> redistributes) {
         ...
         * 
         */
        public Builder redistributes(ServiceRoutingOspfv3Ipv6FeatureRedistributeArgs... redistributes) {
        ...
        public ServiceRoutingOspfv3Ipv6FeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("ServiceRoutingOspfv3Ipv6FeatureArgs", "featureProfileId");
            }
            return $;
        }
    }
