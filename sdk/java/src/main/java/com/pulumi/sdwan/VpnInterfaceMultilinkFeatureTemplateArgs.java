...
public final class VpnInterfaceMultilinkFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final VpnInterfaceMultilinkFeatureTemplateArgs Empty = new VpnInterfaceMultilinkFeatureTemplateArgs();
    ...
    private @Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateAccessListArgs>> accessLists;

    /**
     * @return Apply ACL
     * 
     */
    public Optional<Output<List<VpnInterfaceMultilinkFeatureTemplateAccessListArgs>>> accessLists() {
    ...
    public Optional<Output<Boolean>> disableFragmentation() {
        return Optional.ofNullable(this.disableFragmentation);
    }
    ...
    public Optional<Output<Integer>> fragmentMaxDelay() {
        return Optional.ofNullable(this.fragmentMaxDelay);
    }
     ...
     * 
     */
    @Import(name="fragmentMaxDelayVariable")
    private @Nullable Output<String> fragmentMaxDelayVariable;

    /**
     * @return Variable name
     * 
     */
    public Optional<Output<String>> fragmentMaxDelayVariable() {
        return Optional.ofNullable(this.fragmentMaxDelayVariable);
    }
    ...
    public Optional<Output<Boolean>> interleavingFragment() {
        return Optional.ofNullable(this.interleavingFragment);
    }
    ...
    private @Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateIpv6AccessListArgs>> ipv6AccessLists;

    /**
     * @return Apply IPv6 access list
     * 
     */
    public Optional<Output<List<VpnInterfaceMultilinkFeatureTemplateIpv6AccessListArgs>>> ipv6AccessLists() {
    ...
    public Optional<Output<Integer>> multilinkGroupNumber() {
        return Optional.ofNullable(this.multilinkGroupNumber);
    }
     ...
     * 
     */
    @Import(name="multilinkGroupNumberVariable")
    private @Nullable Output<String> multilinkGroupNumberVariable;

    /**
     * @return Variable name
     * 
     */
    public Optional<Output<String>> multilinkGroupNumberVariable() {
        return Optional.ofNullable(this.multilinkGroupNumberVariable);
    }
     ...
     * 
     */
    @Import(name="multilinkInterfaces")
    private @Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateMultilinkInterfaceArgs>> multilinkInterfaces;

    /**
     * @return Controller tx-ex List
     * 
     */
    public Optional<Output<List<VpnInterfaceMultilinkFeatureTemplateMultilinkInterfaceArgs>>> multilinkInterfaces() {
        return Optional.ofNullable(this.multilinkInterfaces);
    }
     ...
     * 
     */
    @Import(name="nimInterfaceLists")
    private @Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateNimInterfaceListArgs>> nimInterfaceLists;

    /**
     * @return Nim Interface List
     * 
     */
    public Optional<Output<List<VpnInterfaceMultilinkFeatureTemplateNimInterfaceListArgs>>> nimInterfaceLists() {
        return Optional.ofNullable(this.nimInterfaceLists);
    }
    ...
    private @Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateTunnelInterfaceEncapsulationArgs>> tunnelInterfaceEncapsulations;

    /**
     * @return Encapsulation for TLOC
     * 
     */
    public Optional<Output<List<VpnInterfaceMultilinkFeatureTemplateTunnelInterfaceEncapsulationArgs>>> tunnelInterfaceEncapsulations() {
    ...
    private VpnInterfaceMultilinkFeatureTemplateArgs() {}

    private VpnInterfaceMultilinkFeatureTemplateArgs(VpnInterfaceMultilinkFeatureTemplateArgs $) {
    ...
    public static Builder builder(VpnInterfaceMultilinkFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpnInterfaceMultilinkFeatureTemplateArgs();
        }

        public Builder(VpnInterfaceMultilinkFeatureTemplateArgs defaults) {
            $ = new VpnInterfaceMultilinkFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder accessLists(@Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateAccessListArgs>> accessLists) {
         ...
         * 
         */
        public Builder accessLists(List<VpnInterfaceMultilinkFeatureTemplateAccessListArgs> accessLists) {
         ...
         * 
         */
        public Builder accessLists(VpnInterfaceMultilinkFeatureTemplateAccessListArgs... accessLists) {
        ...
        /**
         * @param chapPppAuthPassword Specify ppp authentication Password
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder disableFragmentation(@Nullable Output<Boolean> disableFragmentation) {
        ...
        public Builder disableFragmentation(Boolean disableFragmentation) {
            return disableFragmentation(Output.of(disableFragmentation));
        }
         ...
         * 
         */
        public Builder fragmentMaxDelay(@Nullable Output<Integer> fragmentMaxDelay) {
        ...
        public Builder fragmentMaxDelay(Integer fragmentMaxDelay) {
            return fragmentMaxDelay(Output.of(fragmentMaxDelay));
        }

        /**
         * @param fragmentMaxDelayVariable Variable name
         * 
         * @return builder
         * 
         */
        public Builder fragmentMaxDelayVariable(@Nullable Output<String> fragmentMaxDelayVariable) {
        ...
        public Builder fragmentMaxDelayVariable(String fragmentMaxDelayVariable) {
            return fragmentMaxDelayVariable(Output.of(fragmentMaxDelayVariable));
        }
         ...
         * 
         */
        public Builder interleavingFragment(@Nullable Output<Boolean> interleavingFragment) {
        ...
        public Builder interleavingFragment(Boolean interleavingFragment) {
            return interleavingFragment(Output.of(interleavingFragment));
        }
         ...
         * 
         */
        public Builder ipv6AccessLists(@Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateIpv6AccessListArgs>> ipv6AccessLists) {
         ...
         * 
         */
        public Builder ipv6AccessLists(List<VpnInterfaceMultilinkFeatureTemplateIpv6AccessListArgs> ipv6AccessLists) {
         ...
         * 
         */
        public Builder ipv6AccessLists(VpnInterfaceMultilinkFeatureTemplateIpv6AccessListArgs... ipv6AccessLists) {
         ...
         * 
         */
        public Builder multilinkGroupNumber(@Nullable Output<Integer> multilinkGroupNumber) {
        ...
        public Builder multilinkGroupNumber(Integer multilinkGroupNumber) {
            return multilinkGroupNumber(Output.of(multilinkGroupNumber));
        }

        /**
         * @param multilinkGroupNumberVariable Variable name
         * 
         * @return builder
         * 
         */
        public Builder multilinkGroupNumberVariable(@Nullable Output<String> multilinkGroupNumberVariable) {
        ...
        public Builder multilinkGroupNumberVariable(String multilinkGroupNumberVariable) {
            return multilinkGroupNumberVariable(Output.of(multilinkGroupNumberVariable));
        }

        /**
         * @param multilinkInterfaces Controller tx-ex List
         * 
         * @return builder
         * 
         */
        public Builder multilinkInterfaces(@Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateMultilinkInterfaceArgs>> multilinkInterfaces) {
         ...
         * 
         */
        public Builder multilinkInterfaces(List<VpnInterfaceMultilinkFeatureTemplateMultilinkInterfaceArgs> multilinkInterfaces) {
            return multilinkInterfaces(Output.of(multilinkInterfaces));
        }
         ...
         * 
         */
        public Builder multilinkInterfaces(VpnInterfaceMultilinkFeatureTemplateMultilinkInterfaceArgs... multilinkInterfaces) {
        ...
        /**
         * @param nimInterfaceLists Nim Interface List
         * 
         * @return builder
         * 
         */
        public Builder nimInterfaceLists(@Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateNimInterfaceListArgs>> nimInterfaceLists) {
         ...
         * 
         */
        public Builder nimInterfaceLists(List<VpnInterfaceMultilinkFeatureTemplateNimInterfaceListArgs> nimInterfaceLists) {
            return nimInterfaceLists(Output.of(nimInterfaceLists));
        }
         ...
         * 
         */
        public Builder nimInterfaceLists(VpnInterfaceMultilinkFeatureTemplateNimInterfaceListArgs... nimInterfaceLists) {
        ...
        /**
         * @param papPppAuthPassword Specify ppp authentication Password
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder tunnelInterfaceEncapsulations(@Nullable Output<List<VpnInterfaceMultilinkFeatureTemplateTunnelInterfaceEncapsulationArgs>> tunnelInterfaceEncapsulations) {
         ...
         * 
         */
        public Builder tunnelInterfaceEncapsulations(List<VpnInterfaceMultilinkFeatureTemplateTunnelInterfaceEncapsulationArgs> tunnelInterfaceEncapsulations) {
         ...
         * 
         */
        public Builder tunnelInterfaceEncapsulations(VpnInterfaceMultilinkFeatureTemplateTunnelInterfaceEncapsulationArgs... tunnelInterfaceEncapsulations) {
        ...
        public VpnInterfaceMultilinkFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("VpnInterfaceMultilinkFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("VpnInterfaceMultilinkFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
