...
import com.pulumi.sdwan.inputs.ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistributionArgs;
...
public final class ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs Empty = new ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs();
    ...
    private @Nullable Output<List<ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistributionArgs>> redistributions;

    /**
     * @return Redistribute Routes to specific Protocol on Global VPN
     * 
     */
    public Optional<Output<List<ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistributionArgs>>> redistributions() {
    ...
    private ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs() {}

    private ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs(ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs $) {
    ...
    public static Builder builder(ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs();
        }

        public Builder(ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs defaults) {
            $ = new ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder redistributions(@Nullable Output<List<ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistributionArgs>> redistributions) {
         ...
         * 
         */
        public Builder redistributions(List<ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistributionArgs> redistributions) {
         ...
         * 
         */
        public Builder redistributions(ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistributionArgs... redistributions) {
        ...
        public ServiceLanVpnProfileParcelRouteLeakToGlobalVpnArgs build() {
            return $;
        }
    }
