...
public final class ServiceLanVpnInterfaceEthernetFeatureState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Interface MTU, Attribute conditional on `portChannelMemberInterface` not equal to `true` and `interfaceName` not containing `.`
     *   - Range: `1500`-`9216`
     *   - Default value: `1500`
     * 
     */
    ...
    /**
     * @return DHCPv6 Helper, Attribute conditional on `ipv6AddressType` equal to `static` or `ipv6AddressTypeVariable` being set
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param interfaceMtu Interface MTU, Attribute conditional on `portChannelMemberInterface` not equal to `true` and `interfaceName` not containing `.`
         *   - Range: `1500`-`9216`
         *   - Default value: `1500`
         * 
         * @return builder
        ...
        /**
         * @param ipv6DhcpHelpers DHCPv6 Helper, Attribute conditional on `ipv6AddressType` equal to `static` or `ipv6AddressTypeVariable` being set
         * 
         * @return builder
         * 
         */
