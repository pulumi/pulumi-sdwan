...
import com.pulumi.sdwan.outputs.GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop;
...
@CustomType
public final class GetTransportWanVpnProfileParcelIpv4StaticRoute {
    /**
     ...
     * 
     */
    private List<GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop> nextHops;
    /**
     * @return Subnet Mask
     * 
     */
    ...
    private GetTransportWanVpnProfileParcelIpv4StaticRoute() {}
    /**
     * @return Administrative distance
     * 
     */
     ...
     * 
     */
    public List<GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop> nextHops() {
    ...
    public static Builder builder(GetTransportWanVpnProfileParcelIpv4StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetMaskVariable;
        public Builder() {}
        public Builder(GetTransportWanVpnProfileParcelIpv4StaticRoute defaults) {
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "administrativeDistanceVariable");
            }
        ...
        public Builder gateway(String gateway) {
            if (gateway == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "gateway");
            }
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "networkAddressVariable");
            }
            this.networkAddressVariable = networkAddressVariable;
            return this;
        }
        @CustomType.Setter
        public Builder nextHops(List<GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop> nextHops) {
            if (nextHops == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "nextHops");
            }
            this.nextHops = nextHops;
            return this;
        }
        public Builder nextHops(GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop... nextHops) {
            return nextHops(List.of(nextHops));
        }
        @CustomType.Setter
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRoute", "subnetMaskVariable");
            }
            this.subnetMaskVariable = subnetMaskVariable;
            return this;
        }
        public GetTransportWanVpnProfileParcelIpv4StaticRoute build() {
            final var _resultValue = new GetTransportWanVpnProfileParcelIpv4StaticRoute();
