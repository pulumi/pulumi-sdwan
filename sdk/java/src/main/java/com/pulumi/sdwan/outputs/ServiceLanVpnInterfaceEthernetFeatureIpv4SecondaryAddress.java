...
@CustomType
public final class ServiceLanVpnInterfaceEthernetFeatureIpv4SecondaryAddress {
    /**
     * @return IpV4 Address
     * 
     */
    ...
    private ServiceLanVpnInterfaceEthernetFeatureIpv4SecondaryAddress() {}
    /**
     * @return IpV4 Address
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnInterfaceEthernetFeatureIpv4SecondaryAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(ServiceLanVpnInterfaceEthernetFeatureIpv4SecondaryAddress defaults) {
        ...
        public ServiceLanVpnInterfaceEthernetFeatureIpv4SecondaryAddress build() {
            final var _resultValue = new ServiceLanVpnInterfaceEthernetFeatureIpv4SecondaryAddress();
