...
public final class SystemBannerFeatureState extends com.pulumi.resources.ResourceArgs {

    public static final SystemBannerFeatureState Empty = new SystemBannerFeatureState();
    ...
    private SystemBannerFeatureState() {}

    private SystemBannerFeatureState(SystemBannerFeatureState $) {
    ...
    public static Builder builder(SystemBannerFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemBannerFeatureState();
        }

        public Builder(SystemBannerFeatureState defaults) {
            $ = new SystemBannerFeatureState(Objects.requireNonNull(defaults));
        }
        ...
        public SystemBannerFeatureState build() {
            return $;
        }
    }
