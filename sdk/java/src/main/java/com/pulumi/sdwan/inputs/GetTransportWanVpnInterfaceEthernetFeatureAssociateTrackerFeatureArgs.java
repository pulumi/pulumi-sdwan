...
public final class GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs Empty = new GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs();
    ...
    private GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs() {}

    private GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs(GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs $) {
    ...
    public static Builder builder(GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs();
        }

        public Builder(GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs defaults) {
            $ = new GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "featureProfileId");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "id");
            }
            if ($.transportWanVpnFeatureId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "transportWanVpnFeatureId");
            }
            if ($.transportWanVpnInterfaceEthernetFeatureId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "transportWanVpnInterfaceEthernetFeatureId");
            }
            return $;
        }
    }
