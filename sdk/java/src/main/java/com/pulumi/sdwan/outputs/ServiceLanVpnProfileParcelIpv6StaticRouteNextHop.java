...
@CustomType
public final class ServiceLanVpnProfileParcelIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private ServiceLanVpnProfileParcelIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
        ...
        public ServiceLanVpnProfileParcelIpv6StaticRouteNextHop build() {
            final var _resultValue = new ServiceLanVpnProfileParcelIpv6StaticRouteNextHop();
