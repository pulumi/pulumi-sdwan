...
public class SystemPerformanceMonitoringProfileParcel extends com.pulumi.resources.CustomResource {
     ...
     */
    public SystemPerformanceMonitoringProfileParcel(java.lang.String name) {
     ...
     */
    public SystemPerformanceMonitoringProfileParcel(java.lang.String name, @Nullable SystemPerformanceMonitoringProfileParcelArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SystemPerformanceMonitoringProfileParcel(java.lang.String name, @Nullable SystemPerformanceMonitoringProfileParcelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemPerformanceMonitoringProfileParcel:SystemPerformanceMonitoringProfileParcel", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SystemPerformanceMonitoringProfileParcel(java.lang.String name, Output<java.lang.String> id, @Nullable SystemPerformanceMonitoringProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemPerformanceMonitoringProfileParcel:SystemPerformanceMonitoringProfileParcel", name, state, makeResourceOptions(options, id), false);
    }

    private static SystemPerformanceMonitoringProfileParcelArgs makeArgs(@Nullable SystemPerformanceMonitoringProfileParcelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SystemPerformanceMonitoringProfileParcelArgs.Empty : args;
    }
     ...
     */
    public static SystemPerformanceMonitoringProfileParcel get(java.lang.String name, Output<java.lang.String> id, @Nullable SystemPerformanceMonitoringProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
