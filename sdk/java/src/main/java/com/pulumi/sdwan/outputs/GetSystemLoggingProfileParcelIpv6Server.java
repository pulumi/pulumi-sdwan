...
@CustomType
public final class GetSystemLoggingProfileParcelIpv6Server {
    /**
    ...
    private GetSystemLoggingProfileParcelIpv6Server() {}
    /**
     * @return Set IPv6 hostname or IPv6 address of server
     * 
     */
    ...
    public static Builder builder(GetSystemLoggingProfileParcelIpv6Server defaults) {
    ...
    public static final class Builder {
        ...
        private String vpnVariable;
        public Builder() {}
        public Builder(GetSystemLoggingProfileParcelIpv6Server defaults) {
        ...
        public Builder hostnameIp(String hostnameIp) {
            if (hostnameIp == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "hostnameIp");
            }
        ...
        public Builder hostnameIpVariable(String hostnameIpVariable) {
            if (hostnameIpVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "hostnameIpVariable");
            }
        ...
        public Builder priority(String priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "priority");
            }
        ...
        public Builder priorityVariable(String priorityVariable) {
            if (priorityVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "priorityVariable");
            }
        ...
        public Builder sourceInterface(String sourceInterface) {
            if (sourceInterface == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "sourceInterface");
            }
        ...
        public Builder sourceInterfaceVariable(String sourceInterfaceVariable) {
            if (sourceInterfaceVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "sourceInterfaceVariable");
            }
        ...
        public Builder tlsEnable(Boolean tlsEnable) {
            if (tlsEnable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "tlsEnable");
            }
        ...
        public Builder tlsEnableVariable(String tlsEnableVariable) {
            if (tlsEnableVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "tlsEnableVariable");
            }
        ...
        public Builder tlsPropertiesCustomProfile(Boolean tlsPropertiesCustomProfile) {
            if (tlsPropertiesCustomProfile == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "tlsPropertiesCustomProfile");
            }
        ...
        public Builder tlsPropertiesCustomProfileVariable(String tlsPropertiesCustomProfileVariable) {
            if (tlsPropertiesCustomProfileVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "tlsPropertiesCustomProfileVariable");
            }
        ...
        public Builder tlsPropertiesProfile(String tlsPropertiesProfile) {
            if (tlsPropertiesProfile == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "tlsPropertiesProfile");
            }
        ...
        public Builder tlsPropertiesProfileVariable(String tlsPropertiesProfileVariable) {
            if (tlsPropertiesProfileVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "tlsPropertiesProfileVariable");
            }
        ...
        public Builder vpn(Integer vpn) {
            if (vpn == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "vpn");
            }
            this.vpn = vpn;
            return this;
        }
        ...
        public Builder vpnVariable(String vpnVariable) {
            if (vpnVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingProfileParcelIpv6Server", "vpnVariable");
            }
            this.vpnVariable = vpnVariable;
            return this;
        }
        public GetSystemLoggingProfileParcelIpv6Server build() {
            final var _resultValue = new GetSystemLoggingProfileParcelIpv6Server();
