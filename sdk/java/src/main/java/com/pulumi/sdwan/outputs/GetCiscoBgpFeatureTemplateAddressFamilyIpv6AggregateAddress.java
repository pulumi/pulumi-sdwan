...
@CustomType
public final class GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress {
    /**
    ...
    private GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress() {}
    /**
     * @return Set AS set path information
     * 
     */
    ...
    public static Builder builder(GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress defaults) {
    ...
    public static final class Builder {
        ...
        private String summaryOnlyVariable;
        public Builder() {}
        public Builder(GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress defaults) {
        ...
        public Builder asSetPath(Boolean asSetPath) {
            if (asSetPath == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress", "asSetPath");
            }
        ...
        public Builder asSetPathVariable(String asSetPathVariable) {
            if (asSetPathVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress", "asSetPathVariable");
            }
        ...
        public Builder optional(Boolean optional) {
            if (optional == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress", "optional");
            }
        ...
        public Builder prefix(String prefix) {
            if (prefix == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress", "prefix");
            }
            this.prefix = prefix;
            return this;
        }
        ...
        public Builder prefixVariable(String prefixVariable) {
            if (prefixVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress", "prefixVariable");
            }
        ...
        public Builder summaryOnly(Boolean summaryOnly) {
            if (summaryOnly == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress", "summaryOnly");
            }
        ...
        public Builder summaryOnlyVariable(String summaryOnlyVariable) {
            if (summaryOnlyVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress", "summaryOnlyVariable");
            }
            this.summaryOnlyVariable = summaryOnlyVariable;
            return this;
        }
        public GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress build() {
            final var _resultValue = new GetCiscoBgpFeatureTemplateAddressFamilyIpv6AggregateAddress();
