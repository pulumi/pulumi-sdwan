...
@CustomType
public final class GetServiceLanVpnFeatureNatPortForward {
    /**
    ...
    private GetServiceLanVpnFeatureNatPortForward() {}
    /**
     * @return NAT Pool Name
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnFeatureNatPortForward defaults) {
    ...
    public static final class Builder {
        ...
        private String translatedSourceIpVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnFeatureNatPortForward defaults) {
        ...
        public Builder natPoolName(Integer natPoolName) {
            if (natPoolName == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "natPoolName");
            }
        ...
        public Builder natPoolNameVariable(String natPoolNameVariable) {
            if (natPoolNameVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "natPoolNameVariable");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "protocol");
            }
        ...
        public Builder protocolVariable(String protocolVariable) {
            if (protocolVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "protocolVariable");
            }
        ...
        public Builder sourceIp(String sourceIp) {
            if (sourceIp == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "sourceIp");
            }
        ...
        public Builder sourceIpVariable(String sourceIpVariable) {
            if (sourceIpVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "sourceIpVariable");
            }
        ...
        public Builder sourcePort(Integer sourcePort) {
            if (sourcePort == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "sourcePort");
            }
        ...
        public Builder sourcePortVariable(String sourcePortVariable) {
            if (sourcePortVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "sourcePortVariable");
            }
        ...
        public Builder translatePort(Integer translatePort) {
            if (translatePort == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "translatePort");
            }
        ...
        public Builder translatePortVariable(String translatePortVariable) {
            if (translatePortVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "translatePortVariable");
            }
        ...
        public Builder translatedSourceIp(String translatedSourceIp) {
            if (translatedSourceIp == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "translatedSourceIp");
            }
        ...
        public Builder translatedSourceIpVariable(String translatedSourceIpVariable) {
            if (translatedSourceIpVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNatPortForward", "translatedSourceIpVariable");
            }
            this.translatedSourceIpVariable = translatedSourceIpVariable;
            return this;
        }
        public GetServiceLanVpnFeatureNatPortForward build() {
            final var _resultValue = new GetServiceLanVpnFeatureNatPortForward();
