...
public final class TransportIpv6TrackerProfileParcelState extends com.pulumi.resources.ResourceArgs {

    public static final TransportIpv6TrackerProfileParcelState Empty = new TransportIpv6TrackerProfileParcelState();
    ...
    private TransportIpv6TrackerProfileParcelState() {}

    private TransportIpv6TrackerProfileParcelState(TransportIpv6TrackerProfileParcelState $) {
    ...
    public static Builder builder(TransportIpv6TrackerProfileParcelState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportIpv6TrackerProfileParcelState();
        }

        public Builder(TransportIpv6TrackerProfileParcelState defaults) {
            $ = new TransportIpv6TrackerProfileParcelState(Objects.requireNonNull(defaults));
        }
        ...
        public TransportIpv6TrackerProfileParcelState build() {
            return $;
        }
    }
