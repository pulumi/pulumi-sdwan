...
@CustomType
public final class GetSystemSnmpProfileParcelCommunity {
    /**
    ...
    private GetSystemSnmpProfileParcelCommunity() {}
    /**
     * @return Configure access permissions
     * 
     */
    ...
    public static Builder builder(GetSystemSnmpProfileParcelCommunity defaults) {
    ...
    public static final class Builder {
        ...
        private String viewVariable;
        public Builder() {}
        public Builder(GetSystemSnmpProfileParcelCommunity defaults) {
        ...
        public Builder authorization(String authorization) {
            if (authorization == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelCommunity", "authorization");
            }
        ...
        public Builder authorizationVariable(String authorizationVariable) {
            if (authorizationVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelCommunity", "authorizationVariable");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelCommunity", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder userLabel(String userLabel) {
            if (userLabel == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelCommunity", "userLabel");
            }
        ...
        public Builder view(String view) {
            if (view == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelCommunity", "view");
            }
            this.view = view;
            return this;
        }
        ...
        public Builder viewVariable(String viewVariable) {
            if (viewVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelCommunity", "viewVariable");
            }
            this.viewVariable = viewVariable;
            return this;
        }
        public GetSystemSnmpProfileParcelCommunity build() {
            final var _resultValue = new GetSystemSnmpProfileParcelCommunity();
