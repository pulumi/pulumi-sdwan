...
public final class Ipv4AclPolicyDefinitionState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<Ipv4AclPolicyDefinitionSequenceArgs>> sequences;

    /**
     * @return List of ACL sequences
     * 
     */
    public Optional<Output<List<Ipv4AclPolicyDefinitionSequenceArgs>>> sequences() {
    ...
    private Ipv4AclPolicyDefinitionState() {}

    private Ipv4AclPolicyDefinitionState(Ipv4AclPolicyDefinitionState $) {
    ...
    public static Builder builder(Ipv4AclPolicyDefinitionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new Ipv4AclPolicyDefinitionState();
        }

        public Builder(Ipv4AclPolicyDefinitionState defaults) {
            $ = new Ipv4AclPolicyDefinitionState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sequences(@Nullable Output<List<Ipv4AclPolicyDefinitionSequenceArgs>> sequences) {
            $.sequences = sequences;
            return this;
        }
        ...
        public Ipv4AclPolicyDefinitionState build() {
            return $;
        }
    }
