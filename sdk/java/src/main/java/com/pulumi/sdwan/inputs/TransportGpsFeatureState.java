...
public final class TransportGpsFeatureState extends com.pulumi.resources.ResourceArgs {

    public static final TransportGpsFeatureState Empty = new TransportGpsFeatureState();
    ...
    private TransportGpsFeatureState() {}

    private TransportGpsFeatureState(TransportGpsFeatureState $) {
    ...
    public static Builder builder(TransportGpsFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportGpsFeatureState();
        }

        public Builder(TransportGpsFeatureState defaults) {
            $ = new TransportGpsFeatureState(Objects.requireNonNull(defaults));
        }
        ...
        public TransportGpsFeatureState build() {
            return $;
        }
    }
