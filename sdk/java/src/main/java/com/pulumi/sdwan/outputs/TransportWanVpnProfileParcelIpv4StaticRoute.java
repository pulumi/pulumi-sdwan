...
import com.pulumi.sdwan.outputs.TransportWanVpnProfileParcelIpv4StaticRouteNextHop;
...
@CustomType
public final class TransportWanVpnProfileParcelIpv4StaticRoute {
    /**
     ...
     * 
     */
    private @Nullable List<TransportWanVpnProfileParcelIpv4StaticRouteNextHop> nextHops;
    /**
     * @return Subnet Mask
    ...
    private TransportWanVpnProfileParcelIpv4StaticRoute() {}
    /**
     * @return Administrative distance
     *   - Range: `1`-`255`
     *   - Default value: `1`
     ...
     * 
     */
    public List<TransportWanVpnProfileParcelIpv4StaticRouteNextHop> nextHops() {
    ...
    public static Builder builder(TransportWanVpnProfileParcelIpv4StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportWanVpnProfileParcelIpv4StaticRoute defaults) {
        ...
        @CustomType.Setter
        public Builder nextHops(@Nullable List<TransportWanVpnProfileParcelIpv4StaticRouteNextHop> nextHops) {

            this.nextHops = nextHops;
            return this;
        }
        public Builder nextHops(TransportWanVpnProfileParcelIpv4StaticRouteNextHop... nextHops) {
        ...
        public TransportWanVpnProfileParcelIpv4StaticRoute build() {
            final var _resultValue = new TransportWanVpnProfileParcelIpv4StaticRoute();
