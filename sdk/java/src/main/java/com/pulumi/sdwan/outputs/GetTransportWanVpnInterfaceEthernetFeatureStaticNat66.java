...
public final class GetTransportWanVpnInterfaceEthernetFeatureStaticNat66 {
    ...
    public static Builder builder(GetTransportWanVpnInterfaceEthernetFeatureStaticNat66 defaults) {
    ...
    public static final class Builder {
        ...
        public Builder sourcePrefix(String sourcePrefix) {
            if (sourcePrefix == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureStaticNat66", "sourcePrefix");
            }
        ...
        public Builder sourcePrefixVariable(String sourcePrefixVariable) {
            if (sourcePrefixVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureStaticNat66", "sourcePrefixVariable");
            }
        ...
        public Builder sourceVpnId(Integer sourceVpnId) {
            if (sourceVpnId == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureStaticNat66", "sourceVpnId");
            }
        ...
        public Builder sourceVpnIdVariable(String sourceVpnIdVariable) {
            if (sourceVpnIdVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureStaticNat66", "sourceVpnIdVariable");
            }
        ...
        public Builder translatedSourcePrefix(String translatedSourcePrefix) {
            if (translatedSourcePrefix == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureStaticNat66", "translatedSourcePrefix");
            }
        ...
        public Builder translatedSourcePrefixVariable(String translatedSourcePrefixVariable) {
            if (translatedSourcePrefixVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureStaticNat66", "translatedSourcePrefixVariable");
            }
