...
@CustomType
public final class GetSystemSnmpProfileParcelTrapTargetServer {
    /**
    ...
    private GetSystemSnmpProfileParcelTrapTargetServer() {}
    /**
     * @return Set IPv4/IPv6 address of SNMP server
     * 
     */
    ...
    public static Builder builder(GetSystemSnmpProfileParcelTrapTargetServer defaults) {
    ...
    public static final class Builder {
        ...
        private String vpnIdVariable;
        public Builder() {}
        public Builder(GetSystemSnmpProfileParcelTrapTargetServer defaults) {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "ip");
            }
            this.ip = ip;
            return this;
        }
        ...
        public Builder ipVariable(String ipVariable) {
            if (ipVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "ipVariable");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder portVariable(String portVariable) {
            if (portVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "portVariable");
            }
        ...
        public Builder sourceInterface(String sourceInterface) {
            if (sourceInterface == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "sourceInterface");
            }
        ...
        public Builder sourceInterfaceVariable(String sourceInterfaceVariable) {
            if (sourceInterfaceVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "sourceInterfaceVariable");
            }
        ...
        public Builder user(String user) {
            if (user == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "user");
            }
            this.user = user;
            return this;
        }
        ...
        public Builder userLabel(String userLabel) {
            if (userLabel == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "userLabel");
            }
        ...
        public Builder userVariable(String userVariable) {
            if (userVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "userVariable");
            }
        ...
        public Builder vpnId(Integer vpnId) {
            if (vpnId == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "vpnId");
            }
            this.vpnId = vpnId;
            return this;
        }
        ...
        public Builder vpnIdVariable(String vpnIdVariable) {
            if (vpnIdVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelTrapTargetServer", "vpnIdVariable");
            }
            this.vpnIdVariable = vpnIdVariable;
            return this;
        }
        public GetSystemSnmpProfileParcelTrapTargetServer build() {
            final var _resultValue = new GetSystemSnmpProfileParcelTrapTargetServer();
            _resultValue.ip = ip;
