...
import com.pulumi.sdwan.inputs.DataFqdnPrefixListPolicyObjectState;
import com.pulumi.sdwan.outputs.DataFqdnPrefixListPolicyObjectEntry;
 ...
 * 
 */
@ResourceType(type="sdwan:index/dataFqdnPrefixListPolicyObject:DataFqdnPrefixListPolicyObject")
public class DataFqdnPrefixListPolicyObject extends com.pulumi.resources.CustomResource {
    /**
     * List of entries
     * 
     */
    @Export(name="entries", refs={List.class,DataFqdnPrefixListPolicyObjectEntry.class}, tree="[0,1]")
    private Output<List<DataFqdnPrefixListPolicyObjectEntry>> entries;

    /**
     * @return List of entries
     * 
     */
    public Output<List<DataFqdnPrefixListPolicyObjectEntry>> entries() {
        return this.entries;
    }
    /**
