...
@CustomType
public final class GetServiceLanVpnProfileParcelNatPool {
    /**
    ...
    private GetServiceLanVpnProfileParcelNatPool() {}
    /**
     * @return NAT Direction
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelNatPool defaults) {
    ...
    public static final class Builder {
        ...
        private String trackerObjectId;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelNatPool defaults) {
        ...
        public Builder direction(String direction) {
            if (direction == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "direction");
            }
        ...
        public Builder directionVariable(String directionVariable) {
            if (directionVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "directionVariable");
            }
        ...
        public Builder natPoolName(Integer natPoolName) {
            if (natPoolName == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "natPoolName");
            }
        ...
        public Builder natPoolNameVariable(String natPoolNameVariable) {
            if (natPoolNameVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "natPoolNameVariable");
            }
        ...
        public Builder overload(Boolean overload) {
            if (overload == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "overload");
            }
        ...
        public Builder overloadVariable(String overloadVariable) {
            if (overloadVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "overloadVariable");
            }
        ...
        public Builder prefixLength(Integer prefixLength) {
            if (prefixLength == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "prefixLength");
            }
        ...
        public Builder prefixLengthVariable(String prefixLengthVariable) {
            if (prefixLengthVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "prefixLengthVariable");
            }
        ...
        public Builder rangeEnd(String rangeEnd) {
            if (rangeEnd == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "rangeEnd");
            }
        ...
        public Builder rangeEndVariable(String rangeEndVariable) {
            if (rangeEndVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "rangeEndVariable");
            }
        ...
        public Builder rangeStart(String rangeStart) {
            if (rangeStart == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "rangeStart");
            }
        ...
        public Builder rangeStartVariable(String rangeStartVariable) {
            if (rangeStartVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "rangeStartVariable");
            }
        ...
        public Builder trackerObjectId(String trackerObjectId) {
            if (trackerObjectId == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelNatPool", "trackerObjectId");
            }
            this.trackerObjectId = trackerObjectId;
            return this;
        }
        public GetServiceLanVpnProfileParcelNatPool build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelNatPool();
