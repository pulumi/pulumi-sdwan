...
public final class TrafficDataPolicyDefinitionSequenceMatchEntry {
    ...
    public static Builder builder(TrafficDataPolicyDefinitionSequenceMatchEntry defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(TrafficDataPolicyDefinitionSequenceMatchEntry defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("TrafficDataPolicyDefinitionSequenceMatchEntry", "type");
            }
            this.type = type;
            return this;
        }
        public TrafficDataPolicyDefinitionSequenceMatchEntry build() {
            final var _resultValue = new TrafficDataPolicyDefinitionSequenceMatchEntry();
