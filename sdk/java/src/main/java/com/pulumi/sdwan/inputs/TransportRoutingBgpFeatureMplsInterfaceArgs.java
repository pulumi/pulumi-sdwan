...
public final class TransportRoutingBgpFeatureMplsInterfaceArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportRoutingBgpFeatureMplsInterfaceArgs Empty = new TransportRoutingBgpFeatureMplsInterfaceArgs();
    ...
    private TransportRoutingBgpFeatureMplsInterfaceArgs() {}

    private TransportRoutingBgpFeatureMplsInterfaceArgs(TransportRoutingBgpFeatureMplsInterfaceArgs $) {
    ...
    public static Builder builder(TransportRoutingBgpFeatureMplsInterfaceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportRoutingBgpFeatureMplsInterfaceArgs();
        }

        public Builder(TransportRoutingBgpFeatureMplsInterfaceArgs defaults) {
            $ = new TransportRoutingBgpFeatureMplsInterfaceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransportRoutingBgpFeatureMplsInterfaceArgs build() {
            return $;
        }
    }
