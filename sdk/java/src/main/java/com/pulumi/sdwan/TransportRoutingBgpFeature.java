...
import com.pulumi.sdwan.inputs.TransportRoutingBgpFeatureState;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv4AggregateAddress;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv4Neighbor;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv4Network;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv4Redistribute;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv6AggregateAddress;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv6Neighbor;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv6Network;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureIpv6Redistribute;
import com.pulumi.sdwan.outputs.TransportRoutingBgpFeatureMplsInterface;
 ...
 *                     Map.entry("policyType", "restart"),
 *                     Map.entry("restartMaxNumberOfPrefixes", 2000),
 *                     Map.entry("restartThreshold", 75),
 *                     Map.entry("restartInterval", 30)
 *                 )))
 *                 .build())
 ...
 *                     Map.entry("maxNumberOfPrefixes", 2000),
 *                     Map.entry("threshold", 75),
 *                     Map.entry("policyType", "restart"),
 *                     Map.entry("restartInterval", 30)
 *                 )))
 *                 .build())
 ...
 * 
 */
@ResourceType(type="sdwan:index/transportRoutingBgpFeature:TransportRoutingBgpFeature")
public class TransportRoutingBgpFeature extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="ipv4AggregateAddresses", refs={List.class,TransportRoutingBgpFeatureIpv4AggregateAddress.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv4AggregateAddress>> ipv4AggregateAddresses;

    /**
     * @return Aggregate prefixes in specific range
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv4AggregateAddress>>> ipv4AggregateAddresses() {
     ...
     * 
     */
    @Export(name="ipv4Neighbors", refs={List.class,TransportRoutingBgpFeatureIpv4Neighbor.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv4Neighbor>> ipv4Neighbors;

    /**
     * @return Set BGP IPv4 neighbors
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv4Neighbor>>> ipv4Neighbors() {
     ...
     * 
     */
    @Export(name="ipv4Networks", refs={List.class,TransportRoutingBgpFeatureIpv4Network.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv4Network>> ipv4Networks;

    /**
     * @return Configure the networks for BGP to advertise
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv4Network>>> ipv4Networks() {
     ...
     * 
     */
    @Export(name="ipv4Redistributes", refs={List.class,TransportRoutingBgpFeatureIpv4Redistribute.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv4Redistribute>> ipv4Redistributes;

    /**
     * @return Redistribute routes into BGP
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv4Redistribute>>> ipv4Redistributes() {
     ...
     * 
     */
    @Export(name="ipv6AggregateAddresses", refs={List.class,TransportRoutingBgpFeatureIpv6AggregateAddress.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv6AggregateAddress>> ipv6AggregateAddresses;

    /**
     * @return IPv6 Aggregate prefixes in specific range
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv6AggregateAddress>>> ipv6AggregateAddresses() {
     ...
     * 
     */
    @Export(name="ipv6Neighbors", refs={List.class,TransportRoutingBgpFeatureIpv6Neighbor.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv6Neighbor>> ipv6Neighbors;

    /**
     * @return Set BGP IPv6 neighbors
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv6Neighbor>>> ipv6Neighbors() {
     ...
     * 
     */
    @Export(name="ipv6Networks", refs={List.class,TransportRoutingBgpFeatureIpv6Network.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv6Network>> ipv6Networks;

    /**
     * @return Configure the networks for BGP to advertise
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv6Network>>> ipv6Networks() {
     ...
     * 
     */
    @Export(name="ipv6Redistributes", refs={List.class,TransportRoutingBgpFeatureIpv6Redistribute.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureIpv6Redistribute>> ipv6Redistributes;

    /**
     * @return Redistribute routes into BGP
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureIpv6Redistribute>>> ipv6Redistributes() {
     ...
     * 
     */
    @Export(name="mplsInterfaces", refs={List.class,TransportRoutingBgpFeatureMplsInterface.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingBgpFeatureMplsInterface>> mplsInterfaces;

    /**
     * @return MPLS BGP Interface
     * 
     */
    public Output<Optional<List<TransportRoutingBgpFeatureMplsInterface>>> mplsInterfaces() {
     ...
     */
    public TransportRoutingBgpFeature(java.lang.String name) {
        this(name, TransportRoutingBgpFeatureArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
    ...
    private TransportRoutingBgpFeature(java.lang.String name, Output<java.lang.String> id, @Nullable TransportRoutingBgpFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static TransportRoutingBgpFeatureArgs makeArgs(TransportRoutingBgpFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        ...
        return args == null ? TransportRoutingBgpFeatureArgs.Empty : args;
    }
     ...
     */
    public static TransportRoutingBgpFeature get(java.lang.String name, Output<java.lang.String> id, @Nullable TransportRoutingBgpFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
