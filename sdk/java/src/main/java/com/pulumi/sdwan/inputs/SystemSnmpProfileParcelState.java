...
public final class SystemSnmpProfileParcelState extends com.pulumi.resources.ResourceArgs {

    public static final SystemSnmpProfileParcelState Empty = new SystemSnmpProfileParcelState();
    ...
    private @Nullable Output<List<SystemSnmpProfileParcelCommunityArgs>> communities;

    /**
     * @return Configure SNMP community
     * 
     */
    public Optional<Output<List<SystemSnmpProfileParcelCommunityArgs>>> communities() {
     ...
     */
    @Import(name="groups")
    private @Nullable Output<List<SystemSnmpProfileParcelGroupArgs>> groups;

    /**
     * @return Configure an SNMP group
     * 
     */
    public Optional<Output<List<SystemSnmpProfileParcelGroupArgs>>> groups() {
    ...
    private @Nullable Output<List<SystemSnmpProfileParcelTrapTargetServerArgs>> trapTargetServers;

    /**
     * @return Configure SNMP server to receive SNMP traps
     * 
     */
    public Optional<Output<List<SystemSnmpProfileParcelTrapTargetServerArgs>>> trapTargetServers() {
     ...
     */
    @Import(name="users")
    private @Nullable Output<List<SystemSnmpProfileParcelUserArgs>> users;

    /**
     * @return Configure an SNMP user
     * 
     */
    public Optional<Output<List<SystemSnmpProfileParcelUserArgs>>> users() {
     ...
     */
    @Import(name="views")
    private @Nullable Output<List<SystemSnmpProfileParcelViewArgs>> views;

    /**
     * @return Configure a view record
     * 
     */
    public Optional<Output<List<SystemSnmpProfileParcelViewArgs>>> views() {
        return Optional.ofNullable(this.views);
    }

    private SystemSnmpProfileParcelState() {}

    private SystemSnmpProfileParcelState(SystemSnmpProfileParcelState $) {
    ...
    public static Builder builder(SystemSnmpProfileParcelState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemSnmpProfileParcelState();
        }

        public Builder(SystemSnmpProfileParcelState defaults) {
            $ = new SystemSnmpProfileParcelState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder communities(@Nullable Output<List<SystemSnmpProfileParcelCommunityArgs>> communities) {
         ...
         * 
         */
        public Builder communities(List<SystemSnmpProfileParcelCommunityArgs> communities) {
         ...
         * 
         */
        public Builder communities(SystemSnmpProfileParcelCommunityArgs... communities) {
         ...
         * 
         */
        public Builder groups(@Nullable Output<List<SystemSnmpProfileParcelGroupArgs>> groups) {
            $.groups = groups;
            return this;
        }
         ...
         * 
         */
        public Builder groups(List<SystemSnmpProfileParcelGroupArgs> groups) {
         ...
         * 
         */
        public Builder groups(SystemSnmpProfileParcelGroupArgs... groups) {
         ...
         * 
         */
        public Builder trapTargetServers(@Nullable Output<List<SystemSnmpProfileParcelTrapTargetServerArgs>> trapTargetServers) {
         ...
         * 
         */
        public Builder trapTargetServers(List<SystemSnmpProfileParcelTrapTargetServerArgs> trapTargetServers) {
         ...
         * 
         */
        public Builder trapTargetServers(SystemSnmpProfileParcelTrapTargetServerArgs... trapTargetServers) {
         ...
         * 
         */
        public Builder users(@Nullable Output<List<SystemSnmpProfileParcelUserArgs>> users) {
            $.users = users;
            return this;
        }
         ...
         * 
         */
        public Builder users(List<SystemSnmpProfileParcelUserArgs> users) {
         ...
         * 
         */
        public Builder users(SystemSnmpProfileParcelUserArgs... users) {
         ...
         * 
         */
        public Builder views(@Nullable Output<List<SystemSnmpProfileParcelViewArgs>> views) {
            $.views = views;
            return this;
        }
         ...
         * 
         */
        public Builder views(List<SystemSnmpProfileParcelViewArgs> views) {
         ...
         * 
         */
        public Builder views(SystemSnmpProfileParcelViewArgs... views) {
            return views(List.of(views));
        }

        public SystemSnmpProfileParcelState build() {
            return $;
        }
    }
