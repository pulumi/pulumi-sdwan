...
@CustomType
public final class GetServiceLanVpnProfileParcelIpsecRoute {
    /**
    ...
    private GetServiceLanVpnProfileParcelIpsecRoute() {}
    /**
     * @return Variable name
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelIpsecRoute defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetMaskVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelIpsecRoute defaults) {
        ...
        public Builder interfaceVariable(String interfaceVariable) {
            if (interfaceVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpsecRoute", "interfaceVariable");
            }
        ...
        public Builder interfaces(List<String> interfaces) {
            if (interfaces == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpsecRoute", "interfaces");
            }
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpsecRoute", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpsecRoute", "networkAddressVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpsecRoute", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpsecRoute", "subnetMaskVariable");
            }
            this.subnetMaskVariable = subnetMaskVariable;
            return this;
        }
        public GetServiceLanVpnProfileParcelIpsecRoute build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelIpsecRoute();
