...
@CustomType
public final class GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo {
    /**
     * @return Address
     * 
     */
    ...
    private GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo build() {
            final var _resultValue = new GetTransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo();
