...
@CustomType
public final class GetSystemBfdProfileParcelColor {
    /**
    ...
    private GetSystemBfdProfileParcelColor() {}
    /**
     * @return Color that identifies the WAN transport tunnel
     * 
     */
    ...
    public static Builder builder(GetSystemBfdProfileParcelColor defaults) {
    ...
    public static final class Builder {
        ...
        private String pmtuDiscoveryVariable;
        public Builder() {}
        public Builder(GetSystemBfdProfileParcelColor defaults) {
        ...
        public Builder color(String color) {
            if (color == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "color");
            }
            this.color = color;
            return this;
        }
        ...
        public Builder colorVariable(String colorVariable) {
            if (colorVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "colorVariable");
            }
        ...
        public Builder dscp(Integer dscp) {
            if (dscp == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "dscp");
            }
            this.dscp = dscp;
            return this;
        }
        ...
        public Builder dscpVariable(String dscpVariable) {
            if (dscpVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "dscpVariable");
            }
        ...
        public Builder helloInterval(Integer helloInterval) {
            if (helloInterval == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "helloInterval");
            }
        ...
        public Builder helloIntervalVariable(String helloIntervalVariable) {
            if (helloIntervalVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "helloIntervalVariable");
            }
        ...
        public Builder multiplier(Integer multiplier) {
            if (multiplier == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "multiplier");
            }
        ...
        public Builder multiplierVariable(String multiplierVariable) {
            if (multiplierVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "multiplierVariable");
            }
        ...
        public Builder pmtuDiscovery(Boolean pmtuDiscovery) {
            if (pmtuDiscovery == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "pmtuDiscovery");
            }
        ...
        public Builder pmtuDiscoveryVariable(String pmtuDiscoveryVariable) {
            if (pmtuDiscoveryVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelColor", "pmtuDiscoveryVariable");
            }
            this.pmtuDiscoveryVariable = pmtuDiscoveryVariable;
            return this;
        }
        public GetSystemBfdProfileParcelColor build() {
            final var _resultValue = new GetSystemBfdProfileParcelColor();
