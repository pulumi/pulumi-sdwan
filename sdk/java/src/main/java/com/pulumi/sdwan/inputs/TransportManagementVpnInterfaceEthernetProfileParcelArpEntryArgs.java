...
public final class TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs Empty = new TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs();
    ...
    private TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs() {}

    private TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs(TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs $) {
    ...
    public static Builder builder(TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs();
        }

        public Builder(TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs defaults) {
            $ = new TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransportManagementVpnInterfaceEthernetProfileParcelArpEntryArgs build() {
            return $;
        }
    }
