...
@CustomType
public final class ServiceLanVpnFeatureIpv4ExportRouteTarget {
    /**
     * @return Route target
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv4ExportRouteTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeTargetVariable;
        public Builder() {}
        public Builder(ServiceLanVpnFeatureIpv4ExportRouteTarget defaults) {
        ...
        public ServiceLanVpnFeatureIpv4ExportRouteTarget build() {
            final var _resultValue = new ServiceLanVpnFeatureIpv4ExportRouteTarget();
