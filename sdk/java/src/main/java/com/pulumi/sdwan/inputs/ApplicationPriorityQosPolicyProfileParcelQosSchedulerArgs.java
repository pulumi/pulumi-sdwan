...
public final class ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs Empty = new ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs();
    ...
    private ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs() {}

    private ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs(ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs $) {
    ...
    public static Builder builder(ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs();
        }

        public Builder(ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs defaults) {
            $ = new ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationPriorityQosPolicyProfileParcelQosSchedulerArgs build() {
            return $;
        }
    }
