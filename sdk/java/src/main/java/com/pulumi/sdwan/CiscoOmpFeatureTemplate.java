...
public class CiscoOmpFeatureTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public CiscoOmpFeatureTemplate(java.lang.String name) {
     ...
     */
    public CiscoOmpFeatureTemplate(java.lang.String name, CiscoOmpFeatureTemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CiscoOmpFeatureTemplate(java.lang.String name, CiscoOmpFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/ciscoOmpFeatureTemplate:CiscoOmpFeatureTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CiscoOmpFeatureTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable CiscoOmpFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/ciscoOmpFeatureTemplate:CiscoOmpFeatureTemplate", name, state, makeResourceOptions(options, id), false);
    }

    private static CiscoOmpFeatureTemplateArgs makeArgs(CiscoOmpFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CiscoOmpFeatureTemplateArgs.Empty : args;
    }
     ...
     */
    public static CiscoOmpFeatureTemplate get(java.lang.String name, Output<java.lang.String> id, @Nullable CiscoOmpFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
