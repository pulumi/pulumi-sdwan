...
@CustomType
public final class TransportRoutingBgpFeatureIpv4Redistribute {
    /**
    ...
    public static Builder builder(TransportRoutingBgpFeatureIpv4Redistribute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routePolicyId;
        public Builder() {}
        public Builder(TransportRoutingBgpFeatureIpv4Redistribute defaults) {
        ...
        public TransportRoutingBgpFeatureIpv4Redistribute build() {
            final var _resultValue = new TransportRoutingBgpFeatureIpv4Redistribute();
