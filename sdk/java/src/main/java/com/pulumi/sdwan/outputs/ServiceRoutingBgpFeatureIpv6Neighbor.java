...
import com.pulumi.sdwan.outputs.ServiceRoutingBgpFeatureIpv6NeighborAddressFamily;
...
@CustomType
public final class ServiceRoutingBgpFeatureIpv6Neighbor {
    /**
     ...
     * 
     */
    private @Nullable List<ServiceRoutingBgpFeatureIpv6NeighborAddressFamily> addressFamilies;
    /**
    ...
    private ServiceRoutingBgpFeatureIpv6Neighbor() {}
    /**
     * @return Set IPv6 neighbor address
     * 
     */
     ...
     * 
     */
    public List<ServiceRoutingBgpFeatureIpv6NeighborAddressFamily> addressFamilies() {
    ...
    public static Builder builder(ServiceRoutingBgpFeatureIpv6Neighbor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updateSourceInterfaceVariable;
        public Builder() {}
        public Builder(ServiceRoutingBgpFeatureIpv6Neighbor defaults) {
        ...
        @CustomType.Setter
        public Builder addressFamilies(@Nullable List<ServiceRoutingBgpFeatureIpv6NeighborAddressFamily> addressFamilies) {

            this.addressFamilies = addressFamilies;
            return this;
        }
        public Builder addressFamilies(ServiceRoutingBgpFeatureIpv6NeighborAddressFamily... addressFamilies) {
        ...
        public ServiceRoutingBgpFeatureIpv6Neighbor build() {
            final var _resultValue = new ServiceRoutingBgpFeatureIpv6Neighbor();
