...
import com.pulumi.sdwan.outputs.GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily;
...
@CustomType
public final class GetTransportRoutingBgpProfileParcelIpv4Neighbor {
    /**
     ...
     * 
     */
    private List<GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily> addressFamilies;
    /**
     ...
     * 
     */
    private String explicitNullVariable;
    /**
    ...
    private GetTransportRoutingBgpProfileParcelIpv4Neighbor() {}
    /**
     * @return Set neighbor address
     * 
     */
     ...
     * 
     */
    public List<GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily> addressFamilies() {
     ...
     * 
     */
    public String explicitNullVariable() {
        return this.explicitNullVariable;
    }
    /**
     * @return Set how long to wait since receiving a keepalive message to consider BGP peer unavailable
     * 
    ...
    public static Builder builder(GetTransportRoutingBgpProfileParcelIpv4Neighbor defaults) {
    ...
    public static final class Builder {
        ...
        private String updateSourceInterfaceVariable;
        public Builder() {}
        public Builder(GetTransportRoutingBgpProfileParcelIpv4Neighbor defaults) {
    	      ...
    	      this.explicitNull = defaults.explicitNull;
    	      this.explicitNullVariable = defaults.explicitNullVariable;
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "address");
            }
            this.address = address;
            return this;
        }
        @CustomType.Setter
        public Builder addressFamilies(List<GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily> addressFamilies) {
            if (addressFamilies == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "addressFamilies");
            }
            this.addressFamilies = addressFamilies;
            return this;
        }
        public Builder addressFamilies(GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily... addressFamilies) {
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "addressVariable");
            }
        ...
        public Builder allowasInNumber(Integer allowasInNumber) {
            if (allowasInNumber == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "allowasInNumber");
            }
        ...
        public Builder allowasInNumberVariable(String allowasInNumberVariable) {
            if (allowasInNumberVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "allowasInNumberVariable");
            }
        ...
        public Builder asOverride(Boolean asOverride) {
            if (asOverride == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "asOverride");
            }
        ...
        public Builder asOverrideVariable(String asOverrideVariable) {
            if (asOverrideVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "asOverrideVariable");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "description");
            }
        ...
        public Builder descriptionVariable(String descriptionVariable) {
            if (descriptionVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "descriptionVariable");
            }
        ...
        public Builder ebgpMultihop(Integer ebgpMultihop) {
            if (ebgpMultihop == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "ebgpMultihop");
            }
        ...
        public Builder ebgpMultihopVariable(String ebgpMultihopVariable) {
            if (ebgpMultihopVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "ebgpMultihopVariable");
            }
        ...
        public Builder explicitNull(Boolean explicitNull) {
            if (explicitNull == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "explicitNull");
            }
        ...
        public Builder explicitNullVariable(String explicitNullVariable) {
            if (explicitNullVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "explicitNullVariable");
            }
        ...
        public Builder holdTime(Integer holdTime) {
            if (holdTime == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "holdTime");
            }
        ...
        public Builder holdTimeVariable(String holdTimeVariable) {
            if (holdTimeVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "holdTimeVariable");
            }
        ...
        public Builder keepaliveTime(Integer keepaliveTime) {
            if (keepaliveTime == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "keepaliveTime");
            }
        ...
        public Builder keepaliveTimeVariable(String keepaliveTimeVariable) {
            if (keepaliveTimeVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "keepaliveTimeVariable");
            }
        ...
        public Builder localAs(Integer localAs) {
            if (localAs == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "localAs");
            }
        ...
        public Builder localAsVariable(String localAsVariable) {
            if (localAsVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "localAsVariable");
            }
        ...
        public Builder nextHopSelf(Boolean nextHopSelf) {
            if (nextHopSelf == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "nextHopSelf");
            }
        ...
        public Builder nextHopSelfVariable(String nextHopSelfVariable) {
            if (nextHopSelfVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "nextHopSelfVariable");
            }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "password");
            }
        ...
        public Builder passwordVariable(String passwordVariable) {
            if (passwordVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "passwordVariable");
            }
        ...
        public Builder remoteAs(Integer remoteAs) {
            if (remoteAs == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "remoteAs");
            }
        ...
        public Builder remoteAsVariable(String remoteAsVariable) {
            if (remoteAsVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "remoteAsVariable");
            }
        ...
        public Builder sendCommunity(Boolean sendCommunity) {
            if (sendCommunity == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "sendCommunity");
            }
        ...
        public Builder sendCommunityVariable(String sendCommunityVariable) {
            if (sendCommunityVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "sendCommunityVariable");
            }
        ...
        public Builder sendExtendedCommunity(Boolean sendExtendedCommunity) {
            if (sendExtendedCommunity == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "sendExtendedCommunity");
            }
        ...
        public Builder sendExtendedCommunityVariable(String sendExtendedCommunityVariable) {
            if (sendExtendedCommunityVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "sendExtendedCommunityVariable");
            }
        ...
        public Builder sendLabel(Boolean sendLabel) {
            if (sendLabel == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "sendLabel");
            }
        ...
        public Builder shutdown(Boolean shutdown) {
            if (shutdown == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "shutdown");
            }
        ...
        public Builder shutdownVariable(String shutdownVariable) {
            if (shutdownVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "shutdownVariable");
            }
        ...
        public Builder updateSourceInterface(String updateSourceInterface) {
            if (updateSourceInterface == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "updateSourceInterface");
            }
        ...
        public Builder updateSourceInterfaceVariable(String updateSourceInterfaceVariable) {
            if (updateSourceInterfaceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Neighbor", "updateSourceInterfaceVariable");
            }
            this.updateSourceInterfaceVariable = updateSourceInterfaceVariable;
            return this;
        }
        public GetTransportRoutingBgpProfileParcelIpv4Neighbor build() {
            final var _resultValue = new GetTransportRoutingBgpProfileParcelIpv4Neighbor();
            ...
            _resultValue.explicitNull = explicitNull;
            _resultValue.explicitNullVariable = explicitNullVariable;
