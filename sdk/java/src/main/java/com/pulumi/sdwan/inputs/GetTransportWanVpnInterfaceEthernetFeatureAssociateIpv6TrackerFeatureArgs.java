...
public final class GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs Empty = new GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs();
    ...
    private GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs() {}

    private GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs(GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs $) {
    ...
    public static Builder builder(GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs();
        }

        public Builder(GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs defaults) {
            $ = new GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs", "featureProfileId");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs", "id");
            }
            if ($.transportWanVpnFeatureId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs", "transportWanVpnFeatureId");
            }
            if ($.transportWanVpnInterfaceEthernetFeatureId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerFeatureArgs", "transportWanVpnInterfaceEthernetFeatureId");
            }
            return $;
        }
    }
