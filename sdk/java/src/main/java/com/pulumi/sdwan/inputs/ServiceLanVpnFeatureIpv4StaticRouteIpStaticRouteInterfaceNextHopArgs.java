...
public final class ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs Empty = new ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs();
    ...
    private ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs() {}

    private ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs(ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs $) {
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs();
        }

        public Builder(ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs defaults) {
            $ = new ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceLanVpnFeatureIpv4StaticRouteIpStaticRouteInterfaceNextHopArgs build() {
            return $;
        }
    }
