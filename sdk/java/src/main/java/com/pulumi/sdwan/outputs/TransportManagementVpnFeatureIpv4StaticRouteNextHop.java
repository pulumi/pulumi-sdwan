...
@CustomType
public final class TransportManagementVpnFeatureIpv4StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private TransportManagementVpnFeatureIpv4StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(TransportManagementVpnFeatureIpv4StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(TransportManagementVpnFeatureIpv4StaticRouteNextHop defaults) {
        ...
        public TransportManagementVpnFeatureIpv4StaticRouteNextHop build() {
            final var _resultValue = new TransportManagementVpnFeatureIpv4StaticRouteNextHop();
