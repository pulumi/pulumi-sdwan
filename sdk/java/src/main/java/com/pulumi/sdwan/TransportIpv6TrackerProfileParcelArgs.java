...
public final class TransportIpv6TrackerProfileParcelArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportIpv6TrackerProfileParcelArgs Empty = new TransportIpv6TrackerProfileParcelArgs();
    ...
    private TransportIpv6TrackerProfileParcelArgs() {}

    private TransportIpv6TrackerProfileParcelArgs(TransportIpv6TrackerProfileParcelArgs $) {
    ...
    public static Builder builder(TransportIpv6TrackerProfileParcelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportIpv6TrackerProfileParcelArgs();
        }

        public Builder(TransportIpv6TrackerProfileParcelArgs defaults) {
            $ = new TransportIpv6TrackerProfileParcelArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param endpointTrackerType Endpoint Tracker Type - Choices: `ipv6-interface` - Default value: `ipv6-interface`
         * 
         * @return builder
         * 
         */
        ...
        public TransportIpv6TrackerProfileParcelArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("TransportIpv6TrackerProfileParcelArgs", "featureProfileId");
            }
            if ($.trackerName == null) {
                throw new MissingRequiredPropertyException("TransportIpv6TrackerProfileParcelArgs", "trackerName");
            }
            return $;
        }
    }
