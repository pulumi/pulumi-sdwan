...
public final class SystemAaaProfileParcelState extends com.pulumi.resources.ResourceArgs {

    public static final SystemAaaProfileParcelState Empty = new SystemAaaProfileParcelState();
    ...
    private @Nullable Output<List<SystemAaaProfileParcelAccountingRuleArgs>> accountingRules;

    /**
     * @return Configure the accounting rules
     * 
     */
    public Optional<Output<List<SystemAaaProfileParcelAccountingRuleArgs>>> accountingRules() {
    ...
    private @Nullable Output<List<SystemAaaProfileParcelAuthorizationRuleArgs>> authorizationRules;

    /**
     * @return Configure the Authorization Rules
     * 
     */
    public Optional<Output<List<SystemAaaProfileParcelAuthorizationRuleArgs>>> authorizationRules() {
    ...
    private @Nullable Output<List<SystemAaaProfileParcelRadiusGroupArgs>> radiusGroups;

    /**
     * @return Configure the Radius serverGroup
     * 
     */
    public Optional<Output<List<SystemAaaProfileParcelRadiusGroupArgs>>> radiusGroups() {
     ...
     * 
     */
    @Import(name="serverAuthOrders")
    private @Nullable Output<List<String>> serverAuthOrders;

    /**
     * @return ServerGroups priority order
     * 
     */
    public Optional<Output<List<String>>> serverAuthOrders() {
        return Optional.ofNullable(this.serverAuthOrders);
    }
    ...
    private @Nullable Output<List<SystemAaaProfileParcelTacacsGroupArgs>> tacacsGroups;

    /**
     * @return Configure the TACACS serverGroup
     * 
     */
    public Optional<Output<List<SystemAaaProfileParcelTacacsGroupArgs>>> tacacsGroups() {
     ...
     */
    @Import(name="users")
    private @Nullable Output<List<SystemAaaProfileParcelUserArgs>> users;

    /**
     * @return Create local login account
     * 
     */
    public Optional<Output<List<SystemAaaProfileParcelUserArgs>>> users() {
    ...
    private SystemAaaProfileParcelState() {}

    private SystemAaaProfileParcelState(SystemAaaProfileParcelState $) {
    ...
    public static Builder builder(SystemAaaProfileParcelState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemAaaProfileParcelState();
        }

        public Builder(SystemAaaProfileParcelState defaults) {
            $ = new SystemAaaProfileParcelState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder accountingRules(@Nullable Output<List<SystemAaaProfileParcelAccountingRuleArgs>> accountingRules) {
         ...
         * 
         */
        public Builder accountingRules(List<SystemAaaProfileParcelAccountingRuleArgs> accountingRules) {
         ...
         * 
         */
        public Builder accountingRules(SystemAaaProfileParcelAccountingRuleArgs... accountingRules) {
         ...
         * 
         */
        public Builder authorizationRules(@Nullable Output<List<SystemAaaProfileParcelAuthorizationRuleArgs>> authorizationRules) {
         ...
         * 
         */
        public Builder authorizationRules(List<SystemAaaProfileParcelAuthorizationRuleArgs> authorizationRules) {
         ...
         * 
         */
        public Builder authorizationRules(SystemAaaProfileParcelAuthorizationRuleArgs... authorizationRules) {
         ...
         * 
         */
        public Builder radiusGroups(@Nullable Output<List<SystemAaaProfileParcelRadiusGroupArgs>> radiusGroups) {
         ...
         * 
         */
        public Builder radiusGroups(List<SystemAaaProfileParcelRadiusGroupArgs> radiusGroups) {
         ...
         * 
         */
        public Builder radiusGroups(SystemAaaProfileParcelRadiusGroupArgs... radiusGroups) {
         ...
         * 
         */
        public Builder serverAuthOrders(@Nullable Output<List<String>> serverAuthOrders) {
         ...
         * 
         */
        public Builder tacacsGroups(@Nullable Output<List<SystemAaaProfileParcelTacacsGroupArgs>> tacacsGroups) {
         ...
         * 
         */
        public Builder tacacsGroups(List<SystemAaaProfileParcelTacacsGroupArgs> tacacsGroups) {
         ...
         * 
         */
        public Builder tacacsGroups(SystemAaaProfileParcelTacacsGroupArgs... tacacsGroups) {
         ...
         * 
         */
        public Builder users(@Nullable Output<List<SystemAaaProfileParcelUserArgs>> users) {
            $.users = users;
            return this;
        }
         ...
         * 
         */
        public Builder users(List<SystemAaaProfileParcelUserArgs> users) {
         ...
         * 
         */
        public Builder users(SystemAaaProfileParcelUserArgs... users) {
        ...
        public SystemAaaProfileParcelState build() {
            return $;
        }
    }
