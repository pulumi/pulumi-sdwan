...
@CustomType
public final class SystemLoggingProfileParcelIpv4Server {
    /**
    ...
    private SystemLoggingProfileParcelIpv4Server() {}
    /**
     * @return Set hostname or IPv4 address of server
     * 
     */
    ...
    public static Builder builder(SystemLoggingProfileParcelIpv4Server defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vpnVariable;
        public Builder() {}
        public Builder(SystemLoggingProfileParcelIpv4Server defaults) {
        ...
        public SystemLoggingProfileParcelIpv4Server build() {
            final var _resultValue = new SystemLoggingProfileParcelIpv4Server();
