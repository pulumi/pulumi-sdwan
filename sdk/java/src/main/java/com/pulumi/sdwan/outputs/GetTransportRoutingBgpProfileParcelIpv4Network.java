...
@CustomType
public final class GetTransportRoutingBgpProfileParcelIpv4Network {
    ...
    private GetTransportRoutingBgpProfileParcelIpv4Network() {}
    ...
    public static Builder builder(GetTransportRoutingBgpProfileParcelIpv4Network defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetMaskVariable;
        public Builder() {}
        public Builder(GetTransportRoutingBgpProfileParcelIpv4Network defaults) {
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Network", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Network", "networkAddressVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Network", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4Network", "subnetMaskVariable");
            }
            this.subnetMaskVariable = subnetMaskVariable;
            return this;
        }
        public GetTransportRoutingBgpProfileParcelIpv4Network build() {
            final var _resultValue = new GetTransportRoutingBgpProfileParcelIpv4Network();
