...
import com.pulumi.sdwan.outputs.ConfigurationGroupDeviceVariable;
...
@CustomType
public final class ConfigurationGroupDevice {
    /**
     ...
     * 
     */
    public List<ConfigurationGroupDeviceVariable> variables() {
    ...
    public static Builder builder(ConfigurationGroupDevice defaults) {
    ...
    public static final class Builder {
        ...
        public Builder variables(ConfigurationGroupDeviceVariable... variables) {
            return variables(List.of(variables));
        }
        public ConfigurationGroupDevice build() {
