...
@CustomType
public final class ServiceRoutingOspfv3Ipv4FeatureAreaInterface {
    /**
    ...
    private ServiceRoutingOspfv3Ipv4FeatureAreaInterface() {}
    /**
     * @return Set OSPF interface authentication IPSEC key
     * 
     */
    ...
    public static Builder builder(ServiceRoutingOspfv3Ipv4FeatureAreaInterface defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String passiveInterfaceVariable;
        public Builder() {}
        public Builder(ServiceRoutingOspfv3Ipv4FeatureAreaInterface defaults) {
        ...
        public ServiceRoutingOspfv3Ipv4FeatureAreaInterface build() {
            final var _resultValue = new ServiceRoutingOspfv3Ipv4FeatureAreaInterface();
