...
import com.pulumi.sdwan.outputs.CiscoBgpFeatureTemplateIpv4NeighborAddressFamily;
...
@CustomType
public final class CiscoBgpFeatureTemplateIpv4Neighbor {
    /**
     ...
     * 
     */
    private @Nullable List<CiscoBgpFeatureTemplateIpv4NeighborAddressFamily> addressFamilies;
    /**
    ...
    private CiscoBgpFeatureTemplateIpv4Neighbor() {}
    /**
     * @return Set neighbor address
     * 
     */
     ...
     * 
     */
    public List<CiscoBgpFeatureTemplateIpv4NeighborAddressFamily> addressFamilies() {
    ...
    public static Builder builder(CiscoBgpFeatureTemplateIpv4Neighbor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceInterfaceVariable;
        public Builder() {}
        public Builder(CiscoBgpFeatureTemplateIpv4Neighbor defaults) {
        ...
        @CustomType.Setter
        public Builder addressFamilies(@Nullable List<CiscoBgpFeatureTemplateIpv4NeighborAddressFamily> addressFamilies) {

            this.addressFamilies = addressFamilies;
            return this;
        }
        public Builder addressFamilies(CiscoBgpFeatureTemplateIpv4NeighborAddressFamily... addressFamilies) {
        ...
        public CiscoBgpFeatureTemplateIpv4Neighbor build() {
            final var _resultValue = new CiscoBgpFeatureTemplateIpv4Neighbor();
