...
@CustomType
public final class ServiceLanVpnInterfaceEthernetFeatureIpv4VrrpSecondaryAddress {
    /**
     * @return Ip Address
     * 
     */
    ...
    private ServiceLanVpnInterfaceEthernetFeatureIpv4VrrpSecondaryAddress() {}
    /**
     * @return Ip Address
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnInterfaceEthernetFeatureIpv4VrrpSecondaryAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(ServiceLanVpnInterfaceEthernetFeatureIpv4VrrpSecondaryAddress defaults) {
        ...
        public ServiceLanVpnInterfaceEthernetFeatureIpv4VrrpSecondaryAddress build() {
            final var _resultValue = new ServiceLanVpnInterfaceEthernetFeatureIpv4VrrpSecondaryAddress();
