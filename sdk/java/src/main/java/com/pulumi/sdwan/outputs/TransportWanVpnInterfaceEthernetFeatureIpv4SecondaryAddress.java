...
@CustomType
public final class TransportWanVpnInterfaceEthernetFeatureIpv4SecondaryAddress {
    /**
     * @return IpV4 Address
     * 
     */
    ...
    private TransportWanVpnInterfaceEthernetFeatureIpv4SecondaryAddress() {}
    /**
     * @return IpV4 Address
     * 
     */
    ...
    public static Builder builder(TransportWanVpnInterfaceEthernetFeatureIpv4SecondaryAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportWanVpnInterfaceEthernetFeatureIpv4SecondaryAddress defaults) {
        ...
        public TransportWanVpnInterfaceEthernetFeatureIpv4SecondaryAddress build() {
            final var _resultValue = new TransportWanVpnInterfaceEthernetFeatureIpv4SecondaryAddress();
