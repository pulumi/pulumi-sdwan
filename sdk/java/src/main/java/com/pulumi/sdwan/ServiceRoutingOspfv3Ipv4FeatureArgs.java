...
public final class ServiceRoutingOspfv3Ipv4FeatureArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceRoutingOspfv3Ipv4FeatureArgs Empty = new ServiceRoutingOspfv3Ipv4FeatureArgs();
     ...
     */
    @Import(name="areas")
    private @Nullable Output<List<ServiceRoutingOspfv3Ipv4FeatureAreaArgs>> areas;

    /**
     * @return Configure OSPFv3 IPv4 area
     * 
     */
    public Optional<Output<List<ServiceRoutingOspfv3Ipv4FeatureAreaArgs>>> areas() {
    ...
    private @Nullable Output<List<ServiceRoutingOspfv3Ipv4FeatureRedistributeArgs>> redistributes;

    /**
     * @return Redistribute routes
     * 
     */
    public Optional<Output<List<ServiceRoutingOspfv3Ipv4FeatureRedistributeArgs>>> redistributes() {
    ...
    private ServiceRoutingOspfv3Ipv4FeatureArgs() {}

    private ServiceRoutingOspfv3Ipv4FeatureArgs(ServiceRoutingOspfv3Ipv4FeatureArgs $) {
        this.areas = $.areas;
    ...
    public static Builder builder(ServiceRoutingOspfv3Ipv4FeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceRoutingOspfv3Ipv4FeatureArgs();
        }

        public Builder(ServiceRoutingOspfv3Ipv4FeatureArgs defaults) {
            $ = new ServiceRoutingOspfv3Ipv4FeatureArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder areas(@Nullable Output<List<ServiceRoutingOspfv3Ipv4FeatureAreaArgs>> areas) {
            $.areas = areas;
            return this;
        }
         ...
         * 
         */
        public Builder areas(List<ServiceRoutingOspfv3Ipv4FeatureAreaArgs> areas) {
         ...
         * 
         */
        public Builder areas(ServiceRoutingOspfv3Ipv4FeatureAreaArgs... areas) {
         ...
         * 
         */
        public Builder redistributes(@Nullable Output<List<ServiceRoutingOspfv3Ipv4FeatureRedistributeArgs>> redistributes) {
         ...
         * 
         */
        public Builder redistributes(List<ServiceRoutingOspfv3Ipv4FeatureRedistributeArgs> redistributes) {
         ...
         * 
         */
        public Builder redistributes(ServiceRoutingOspfv3Ipv4FeatureRedistributeArgs... redistributes) {
        ...
        public ServiceRoutingOspfv3Ipv4FeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("ServiceRoutingOspfv3Ipv4FeatureArgs", "featureProfileId");
            }
            return $;
        }
    }
