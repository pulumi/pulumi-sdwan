...
import com.pulumi.sdwan.outputs.GetServiceIpv6AclFeatureSequenceMatchEntryDestinationPort;
import com.pulumi.sdwan.outputs.GetServiceIpv6AclFeatureSequenceMatchEntrySourcePort;
...
@CustomType
public final class GetServiceIpv6AclFeatureSequenceMatchEntry {
    /**
    ...
    private GetServiceIpv6AclFeatureSequenceMatchEntry() {}
    /**
     * @return Destination Data IP Prefix
     * 
     */
     ...
     * 
     */
    public List<GetServiceIpv6AclFeatureSequenceMatchEntryDestinationPort> destinationPorts() {
     ...
     * 
     */
    public List<GetServiceIpv6AclFeatureSequenceMatchEntrySourcePort> sourcePorts() {
    ...
    public static Builder builder(GetServiceIpv6AclFeatureSequenceMatchEntry defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> trafficClasses;
        public Builder() {}
        public Builder(GetServiceIpv6AclFeatureSequenceMatchEntry defaults) {
        ...
        public Builder destinationDataPrefix(String destinationDataPrefix) {
            if (destinationDataPrefix == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "destinationDataPrefix");
            }
        ...
        public Builder destinationDataPrefixListId(String destinationDataPrefixListId) {
            if (destinationDataPrefixListId == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "destinationDataPrefixListId");
            }
            this.destinationDataPrefixListId = destinationDataPrefixListId;
            return this;
        }
        @CustomType.Setter
        public Builder destinationPorts(List<GetServiceIpv6AclFeatureSequenceMatchEntryDestinationPort> destinationPorts) {
            if (destinationPorts == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "destinationPorts");
            }
            this.destinationPorts = destinationPorts;
            return this;
        }
        public Builder destinationPorts(GetServiceIpv6AclFeatureSequenceMatchEntryDestinationPort... destinationPorts) {
            return destinationPorts(List.of(destinationPorts));
        }
        @CustomType.Setter
        public Builder icmpMessages(List<String> icmpMessages) {
            if (icmpMessages == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "icmpMessages");
            }
        ...
        public Builder nextHeader(Integer nextHeader) {
            if (nextHeader == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "nextHeader");
            }
        ...
        public Builder sourceDataPrefix(String sourceDataPrefix) {
            if (sourceDataPrefix == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "sourceDataPrefix");
            }
        ...
        public Builder sourceDataPrefixListId(String sourceDataPrefixListId) {
            if (sourceDataPrefixListId == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "sourceDataPrefixListId");
            }
            this.sourceDataPrefixListId = sourceDataPrefixListId;
            return this;
        }
        @CustomType.Setter
        public Builder sourcePorts(List<GetServiceIpv6AclFeatureSequenceMatchEntrySourcePort> sourcePorts) {
            if (sourcePorts == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "sourcePorts");
            }
            this.sourcePorts = sourcePorts;
            return this;
        }
        public Builder sourcePorts(GetServiceIpv6AclFeatureSequenceMatchEntrySourcePort... sourcePorts) {
            return sourcePorts(List.of(sourcePorts));
        }
        @CustomType.Setter
        public Builder tcpState(String tcpState) {
            if (tcpState == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "tcpState");
            }
        ...
        public Builder trafficClasses(List<Integer> trafficClasses) {
            if (trafficClasses == null) {
              throw new MissingRequiredPropertyException("GetServiceIpv6AclFeatureSequenceMatchEntry", "trafficClasses");
            }
        ...
        public GetServiceIpv6AclFeatureSequenceMatchEntry build() {
            final var _resultValue = new GetServiceIpv6AclFeatureSequenceMatchEntry();
