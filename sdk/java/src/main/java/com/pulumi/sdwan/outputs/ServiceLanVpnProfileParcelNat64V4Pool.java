...
@CustomType
public final class ServiceLanVpnProfileParcelNat64V4Pool {
    /**
    ...
    public static Builder builder(ServiceLanVpnProfileParcelNat64V4Pool defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rangeStartVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelNat64V4Pool defaults) {
        ...
        public ServiceLanVpnProfileParcelNat64V4Pool build() {
            final var _resultValue = new ServiceLanVpnProfileParcelNat64V4Pool();
