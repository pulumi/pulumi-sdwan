...
@CustomType
public final class GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration {
    /**
    ...
    private GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration() {}
    /**
     * @return Set module slot/subslot/port number
     * 
     */
    ...
    public static Builder builder(GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private String vdslModemConfigurationVariable;
        public Builder() {}
        public Builder(GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration defaults) {
        ...
        public Builder controllerVdslSlot(String controllerVdslSlot) {
            if (controllerVdslSlot == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "controllerVdslSlot");
            }
        ...
        public Builder controllerVdslSlotVariable(String controllerVdslSlotVariable) {
            if (controllerVdslSlotVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "controllerVdslSlotVariable");
            }
        ...
        public Builder modeAdsl1(Boolean modeAdsl1) {
            if (modeAdsl1 == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "modeAdsl1");
            }
        ...
        public Builder modeAdsl2(Boolean modeAdsl2) {
            if (modeAdsl2 == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "modeAdsl2");
            }
        ...
        public Builder modeAdsl2plus(Boolean modeAdsl2plus) {
            if (modeAdsl2plus == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "modeAdsl2plus");
            }
        ...
        public Builder modeAnsi(Boolean modeAnsi) {
            if (modeAnsi == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "modeAnsi");
            }
        ...
        public Builder modeVdsl2(Boolean modeVdsl2) {
            if (modeVdsl2 == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "modeVdsl2");
            }
        ...
        public Builder optional(Boolean optional) {
            if (optional == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "optional");
            }
        ...
        public Builder sra(Boolean sra) {
            if (sra == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "sra");
            }
            this.sra = sra;
            return this;
        }
        ...
        public Builder vdslModemConfiguration(String vdslModemConfiguration) {
            if (vdslModemConfiguration == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "vdslModemConfiguration");
            }
        ...
        public Builder vdslModemConfigurationVariable(String vdslModemConfigurationVariable) {
            if (vdslModemConfigurationVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration", "vdslModemConfigurationVariable");
            }
            this.vdslModemConfigurationVariable = vdslModemConfigurationVariable;
            return this;
        }
        public GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration build() {
            final var _resultValue = new GetVpnInterfaceDslPppoaFeatureTemplateVdslConfiguration();
