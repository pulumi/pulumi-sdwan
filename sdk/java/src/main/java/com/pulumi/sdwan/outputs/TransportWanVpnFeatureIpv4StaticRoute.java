...
import com.pulumi.sdwan.outputs.TransportWanVpnFeatureIpv4StaticRouteNextHop;
...
@CustomType
public final class TransportWanVpnFeatureIpv4StaticRoute {
    /**
     ...
     * 
     */
    private @Nullable List<TransportWanVpnFeatureIpv4StaticRouteNextHop> nextHops;
    /**
     * @return Subnet Mask
     ...
     * 
     */
    public List<TransportWanVpnFeatureIpv4StaticRouteNextHop> nextHops() {
    ...
    public static Builder builder(TransportWanVpnFeatureIpv4StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportWanVpnFeatureIpv4StaticRoute defaults) {
        ...
        @CustomType.Setter
        public Builder nextHops(@Nullable List<TransportWanVpnFeatureIpv4StaticRouteNextHop> nextHops) {

            this.nextHops = nextHops;
            return this;
        }
        public Builder nextHops(TransportWanVpnFeatureIpv4StaticRouteNextHop... nextHops) {
        ...
        public TransportWanVpnFeatureIpv4StaticRoute build() {
            final var _resultValue = new TransportWanVpnFeatureIpv4StaticRoute();
