 ...
 *                 .ipv4_secondary_addresses(List.of(Map.of("ipv4Address", "8.8.8.8")))
 ...
 *                     Map.entry("linkLocalAddress", "FE80::1/64"),
 *                     Map.entry("prefix", "2001:db8:85a3::8a2e:370:7335")
 *                 )))
 *                 .ipv6_secondary_addresses(List.of(Map.of("prefix", "2001:db8:85a3::8a2e:370:7336")))
 *                 .build())
 *             .build());
 * 
 *     }
