...
@CustomType
public final class TransportRoutingBgpProfileParcelIpv4Network {
    ...
    private TransportRoutingBgpProfileParcelIpv4Network() {}
    ...
    public static Builder builder(TransportRoutingBgpProfileParcelIpv4Network defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportRoutingBgpProfileParcelIpv4Network defaults) {
        ...
        public TransportRoutingBgpProfileParcelIpv4Network build() {
            final var _resultValue = new TransportRoutingBgpProfileParcelIpv4Network();
