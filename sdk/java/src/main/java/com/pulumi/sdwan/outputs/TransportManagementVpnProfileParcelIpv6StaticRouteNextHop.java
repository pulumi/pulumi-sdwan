...
@CustomType
public final class TransportManagementVpnProfileParcelIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private TransportManagementVpnProfileParcelIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(TransportManagementVpnProfileParcelIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(TransportManagementVpnProfileParcelIpv6StaticRouteNextHop defaults) {
        ...
        public TransportManagementVpnProfileParcelIpv6StaticRouteNextHop build() {
            final var _resultValue = new TransportManagementVpnProfileParcelIpv6StaticRouteNextHop();
