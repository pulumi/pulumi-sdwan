...
@CustomType
public final class TransportWanVpnProfileParcelIpv4StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private TransportWanVpnProfileParcelIpv4StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(TransportWanVpnProfileParcelIpv4StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(TransportWanVpnProfileParcelIpv4StaticRouteNextHop defaults) {
        ...
        public TransportWanVpnProfileParcelIpv4StaticRouteNextHop build() {
            final var _resultValue = new TransportWanVpnProfileParcelIpv4StaticRouteNextHop();
