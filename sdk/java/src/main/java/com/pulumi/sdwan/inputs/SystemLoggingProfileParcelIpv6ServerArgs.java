...
public final class SystemLoggingProfileParcelIpv6ServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final SystemLoggingProfileParcelIpv6ServerArgs Empty = new SystemLoggingProfileParcelIpv6ServerArgs();
    ...
    private SystemLoggingProfileParcelIpv6ServerArgs() {}

    private SystemLoggingProfileParcelIpv6ServerArgs(SystemLoggingProfileParcelIpv6ServerArgs $) {
    ...
    public static Builder builder(SystemLoggingProfileParcelIpv6ServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemLoggingProfileParcelIpv6ServerArgs();
        }

        public Builder(SystemLoggingProfileParcelIpv6ServerArgs defaults) {
            $ = new SystemLoggingProfileParcelIpv6ServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SystemLoggingProfileParcelIpv6ServerArgs build() {
            return $;
        }
    }
