...
@CustomType
public final class ServiceLanVpnFeatureAdvertiseOmpIpv4Prefix {
    /**
    ...
    public static Builder builder(ServiceLanVpnFeatureAdvertiseOmpIpv4Prefix defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(ServiceLanVpnFeatureAdvertiseOmpIpv4Prefix defaults) {
        ...
        public ServiceLanVpnFeatureAdvertiseOmpIpv4Prefix build() {
            final var _resultValue = new ServiceLanVpnFeatureAdvertiseOmpIpv4Prefix();
