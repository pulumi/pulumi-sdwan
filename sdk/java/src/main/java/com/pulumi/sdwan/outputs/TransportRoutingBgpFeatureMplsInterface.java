...
@CustomType
public final class TransportRoutingBgpFeatureMplsInterface {
    /**
    ...
    public static Builder builder(TransportRoutingBgpFeatureMplsInterface defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String interfaceNameVariable;
        public Builder() {}
        public Builder(TransportRoutingBgpFeatureMplsInterface defaults) {
        ...
        public TransportRoutingBgpFeatureMplsInterface build() {
            final var _resultValue = new TransportRoutingBgpFeatureMplsInterface();
