...
public final class VpnInterfaceCellularFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final VpnInterfaceCellularFeatureTemplateArgs Empty = new VpnInterfaceCellularFeatureTemplateArgs();
     ...
     * 
     */
    @Import(name="cellularInterfaceName")
    private @Nullable Output<String> cellularInterfaceName;

    /**
     * @return Cellular Interface Name &lt;0-1&gt;
     * 
     */
    public Optional<Output<String>> cellularInterfaceName() {
        return Optional.ofNullable(this.cellularInterfaceName);
    }
     ...
     * 
     */
    @Import(name="cellularInterfaceNameVariable")
    private @Nullable Output<String> cellularInterfaceNameVariable;

    /**
     * @return Variable name
     * 
     */
    public Optional<Output<String>> cellularInterfaceNameVariable() {
        return Optional.ofNullable(this.cellularInterfaceNameVariable);
    }
    ...
    private @Nullable Output<List<VpnInterfaceCellularFeatureTemplateIpv4AccessListArgs>> ipv4AccessLists;

    /**
     * @return Apply ACL
     * 
     */
    public Optional<Output<List<VpnInterfaceCellularFeatureTemplateIpv4AccessListArgs>>> ipv4AccessLists() {
    ...
    private @Nullable Output<List<VpnInterfaceCellularFeatureTemplateIpv6AccessListArgs>> ipv6AccessLists;

    /**
     * @return Apply IPv6 access list
     * 
     */
    public Optional<Output<List<VpnInterfaceCellularFeatureTemplateIpv6AccessListArgs>>> ipv6AccessLists() {
    ...
    private @Nullable Output<List<VpnInterfaceCellularFeatureTemplateNatPortForwardArgs>> natPortForwards;

    /**
     * @return Set port-forwarding rules for NAT on this interface
     * 
     */
    public Optional<Output<List<VpnInterfaceCellularFeatureTemplateNatPortForwardArgs>>> natPortForwards() {
    ...
    private @Nullable Output<List<VpnInterfaceCellularFeatureTemplatePolicerArgs>> policers;

    /**
     * @return Enable policer
     * 
     */
    public Optional<Output<List<VpnInterfaceCellularFeatureTemplatePolicerArgs>>> policers() {
    ...
    private @Nullable Output<List<VpnInterfaceCellularFeatureTemplateStaticArpArgs>> staticArps;

    /**
     * @return Configure static ARP entries
     * 
     */
    public Optional<Output<List<VpnInterfaceCellularFeatureTemplateStaticArpArgs>>> staticArps() {
    ...
    private @Nullable Output<List<VpnInterfaceCellularFeatureTemplateTunnelInterfaceEncapsulationArgs>> tunnelInterfaceEncapsulations;

    /**
     * @return Encapsulation for TLOC
     * 
     */
    public Optional<Output<List<VpnInterfaceCellularFeatureTemplateTunnelInterfaceEncapsulationArgs>>> tunnelInterfaceEncapsulations() {
    ...
    private VpnInterfaceCellularFeatureTemplateArgs() {}

    private VpnInterfaceCellularFeatureTemplateArgs(VpnInterfaceCellularFeatureTemplateArgs $) {
    ...
    public static Builder builder(VpnInterfaceCellularFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpnInterfaceCellularFeatureTemplateArgs();
        }

        public Builder(VpnInterfaceCellularFeatureTemplateArgs defaults) {
            $ = new VpnInterfaceCellularFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param cellularInterfaceName Cellular Interface Name &lt;0-1&gt;
         * 
         * @return builder
         * 
         */
        public Builder cellularInterfaceName(@Nullable Output<String> cellularInterfaceName) {
        ...
        public Builder cellularInterfaceName(String cellularInterfaceName) {
            return cellularInterfaceName(Output.of(cellularInterfaceName));
        }

        /**
         * @param cellularInterfaceNameVariable Variable name
         * 
         * @return builder
         * 
         */
        public Builder cellularInterfaceNameVariable(@Nullable Output<String> cellularInterfaceNameVariable) {
        ...
        public Builder cellularInterfaceNameVariable(String cellularInterfaceNameVariable) {
            return cellularInterfaceNameVariable(Output.of(cellularInterfaceNameVariable));
        }
        ...
        /**
         * @param ipMtu Interface MTU &lt;68...1500&gt;, in bytes - Range: `68`-`1500` - Default value: `1428`
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder ipv4AccessLists(@Nullable Output<List<VpnInterfaceCellularFeatureTemplateIpv4AccessListArgs>> ipv4AccessLists) {
         ...
         * 
         */
        public Builder ipv4AccessLists(List<VpnInterfaceCellularFeatureTemplateIpv4AccessListArgs> ipv4AccessLists) {
         ...
         * 
         */
        public Builder ipv4AccessLists(VpnInterfaceCellularFeatureTemplateIpv4AccessListArgs... ipv4AccessLists) {
        ...
        /**
         * @param ipv4DhcpHelpers List of DHCP server addresses
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder ipv6AccessLists(@Nullable Output<List<VpnInterfaceCellularFeatureTemplateIpv6AccessListArgs>> ipv6AccessLists) {
         ...
         * 
         */
        public Builder ipv6AccessLists(List<VpnInterfaceCellularFeatureTemplateIpv6AccessListArgs> ipv6AccessLists) {
         ...
         * 
         */
        public Builder ipv6AccessLists(VpnInterfaceCellularFeatureTemplateIpv6AccessListArgs... ipv6AccessLists) {
         ...
         * 
         */
        public Builder natPortForwards(@Nullable Output<List<VpnInterfaceCellularFeatureTemplateNatPortForwardArgs>> natPortForwards) {
         ...
         * 
         */
        public Builder natPortForwards(List<VpnInterfaceCellularFeatureTemplateNatPortForwardArgs> natPortForwards) {
         ...
         * 
         */
        public Builder natPortForwards(VpnInterfaceCellularFeatureTemplateNatPortForwardArgs... natPortForwards) {
         ...
         * 
         */
        public Builder policers(@Nullable Output<List<VpnInterfaceCellularFeatureTemplatePolicerArgs>> policers) {
            $.policers = policers;
            return this;
        }
         ...
         * 
         */
        public Builder policers(List<VpnInterfaceCellularFeatureTemplatePolicerArgs> policers) {
         ...
         * 
         */
        public Builder policers(VpnInterfaceCellularFeatureTemplatePolicerArgs... policers) {
         ...
         * 
         */
        public Builder staticArps(@Nullable Output<List<VpnInterfaceCellularFeatureTemplateStaticArpArgs>> staticArps) {
         ...
         * 
         */
        public Builder staticArps(List<VpnInterfaceCellularFeatureTemplateStaticArpArgs> staticArps) {
         ...
         * 
         */
        public Builder staticArps(VpnInterfaceCellularFeatureTemplateStaticArpArgs... staticArps) {
         ...
         * 
         */
        public Builder tunnelInterfaceEncapsulations(@Nullable Output<List<VpnInterfaceCellularFeatureTemplateTunnelInterfaceEncapsulationArgs>> tunnelInterfaceEncapsulations) {
         ...
         * 
         */
        public Builder tunnelInterfaceEncapsulations(List<VpnInterfaceCellularFeatureTemplateTunnelInterfaceEncapsulationArgs> tunnelInterfaceEncapsulations) {
         ...
         * 
         */
        public Builder tunnelInterfaceEncapsulations(VpnInterfaceCellularFeatureTemplateTunnelInterfaceEncapsulationArgs... tunnelInterfaceEncapsulations) {
        ...
        public VpnInterfaceCellularFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("VpnInterfaceCellularFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("VpnInterfaceCellularFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
