...
@CustomType
public final class TransportManagementVpnInterfaceEthernetProfileParcelArpEntry {
    /**
     * @return IPV4 Address
     * 
     */
    ...
    private TransportManagementVpnInterfaceEthernetProfileParcelArpEntry() {}
    /**
     * @return IPV4 Address
     * 
     */
    ...
    public static Builder builder(TransportManagementVpnInterfaceEthernetProfileParcelArpEntry defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String macAddressVariable;
        public Builder() {}
        public Builder(TransportManagementVpnInterfaceEthernetProfileParcelArpEntry defaults) {
        ...
        public TransportManagementVpnInterfaceEthernetProfileParcelArpEntry build() {
            final var _resultValue = new TransportManagementVpnInterfaceEthernetProfileParcelArpEntry();
