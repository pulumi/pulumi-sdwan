...
import com.pulumi.sdwan.inputs.TransportManagementVpnProfileParcelIpv6StaticRouteNextHopArgs;
...
public final class TransportManagementVpnProfileParcelIpv6StaticRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportManagementVpnProfileParcelIpv6StaticRouteArgs Empty = new TransportManagementVpnProfileParcelIpv6StaticRouteArgs();
    ...
    private @Nullable Output<List<TransportManagementVpnProfileParcelIpv6StaticRouteNextHopArgs>> nextHops;

    /**
     * @return IPv6 Route Gateway Next Hop
     * 
     */
    public Optional<Output<List<TransportManagementVpnProfileParcelIpv6StaticRouteNextHopArgs>>> nextHops() {
    ...
    private TransportManagementVpnProfileParcelIpv6StaticRouteArgs() {}

    private TransportManagementVpnProfileParcelIpv6StaticRouteArgs(TransportManagementVpnProfileParcelIpv6StaticRouteArgs $) {
        this.nat = $.nat;
    ...
    public static Builder builder(TransportManagementVpnProfileParcelIpv6StaticRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportManagementVpnProfileParcelIpv6StaticRouteArgs();
        }

        public Builder(TransportManagementVpnProfileParcelIpv6StaticRouteArgs defaults) {
            $ = new TransportManagementVpnProfileParcelIpv6StaticRouteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder nextHops(@Nullable Output<List<TransportManagementVpnProfileParcelIpv6StaticRouteNextHopArgs>> nextHops) {
            $.nextHops = nextHops;
            return this;
        }
         ...
         * 
         */
        public Builder nextHops(List<TransportManagementVpnProfileParcelIpv6StaticRouteNextHopArgs> nextHops) {
         ...
         * 
         */
        public Builder nextHops(TransportManagementVpnProfileParcelIpv6StaticRouteNextHopArgs... nextHops) {
        ...
        public TransportManagementVpnProfileParcelIpv6StaticRouteArgs build() {
            return $;
        }
    }
