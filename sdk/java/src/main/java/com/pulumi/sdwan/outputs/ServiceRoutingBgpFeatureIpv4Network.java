...
@CustomType
public final class ServiceRoutingBgpFeatureIpv4Network {
    ...
    private ServiceRoutingBgpFeatureIpv4Network() {}
    ...
    public static Builder builder(ServiceRoutingBgpFeatureIpv4Network defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(ServiceRoutingBgpFeatureIpv4Network defaults) {
        ...
        public ServiceRoutingBgpFeatureIpv4Network build() {
            final var _resultValue = new ServiceRoutingBgpFeatureIpv4Network();
