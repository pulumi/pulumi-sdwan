...
public final class ServiceRoutePolicyFeatureSequenceAction {
    ...
    public static Builder builder(ServiceRoutePolicyFeatureSequenceAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer weight;
        public Builder() {}
        public Builder(ServiceRoutePolicyFeatureSequenceAction defaults) {
        ...
        public ServiceRoutePolicyFeatureSequenceAction build() {
            final var _resultValue = new ServiceRoutePolicyFeatureSequenceAction();
