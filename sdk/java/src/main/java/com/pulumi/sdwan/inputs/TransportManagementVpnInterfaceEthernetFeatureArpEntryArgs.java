...
public final class TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs Empty = new TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs();
    ...
    private TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs() {}

    private TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs(TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs $) {
    ...
    public static Builder builder(TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs();
        }

        public Builder(TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs defaults) {
            $ = new TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransportManagementVpnInterfaceEthernetFeatureArpEntryArgs build() {
            return $;
        }
    }
