...
public final class SystemLoggingProfileParcelIpv4ServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final SystemLoggingProfileParcelIpv4ServerArgs Empty = new SystemLoggingProfileParcelIpv4ServerArgs();
    ...
    private SystemLoggingProfileParcelIpv4ServerArgs() {}

    private SystemLoggingProfileParcelIpv4ServerArgs(SystemLoggingProfileParcelIpv4ServerArgs $) {
    ...
    public static Builder builder(SystemLoggingProfileParcelIpv4ServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemLoggingProfileParcelIpv4ServerArgs();
        }

        public Builder(SystemLoggingProfileParcelIpv4ServerArgs defaults) {
            $ = new SystemLoggingProfileParcelIpv4ServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SystemLoggingProfileParcelIpv4ServerArgs build() {
            return $;
        }
    }
