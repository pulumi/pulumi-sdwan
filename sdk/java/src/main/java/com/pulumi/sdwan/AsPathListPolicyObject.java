...
import com.pulumi.sdwan.inputs.AsPathListPolicyObjectState;
import com.pulumi.sdwan.outputs.AsPathListPolicyObjectEntry;
 ...
 * 
 */
@ResourceType(type="sdwan:index/asPathListPolicyObject:AsPathListPolicyObject")
public class AsPathListPolicyObject extends com.pulumi.resources.CustomResource {
    /**
     * List of entries
     * 
     */
    @Export(name="entries", refs={List.class,AsPathListPolicyObjectEntry.class}, tree="[0,1]")
    private Output<List<AsPathListPolicyObjectEntry>> entries;

    /**
     * @return List of entries
     * 
     */
    public Output<List<AsPathListPolicyObjectEntry>> entries() {
        return this.entries;
    }
    /**
