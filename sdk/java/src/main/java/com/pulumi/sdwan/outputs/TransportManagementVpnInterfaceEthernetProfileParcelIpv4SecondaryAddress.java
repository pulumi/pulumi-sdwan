...
@CustomType
public final class TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddress {
    /**
     * @return IpV4 Address
     * 
     */
    ...
    private TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddress() {}
    /**
     * @return IpV4 Address
     * 
     */
    ...
    public static Builder builder(TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddress defaults) {
        ...
        public TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddress build() {
            final var _resultValue = new TransportManagementVpnInterfaceEthernetProfileParcelIpv4SecondaryAddress();
