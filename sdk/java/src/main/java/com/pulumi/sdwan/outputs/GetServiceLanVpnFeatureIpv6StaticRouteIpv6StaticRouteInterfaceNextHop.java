...
@CustomType
public final class GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop {
    /**
     * @return IPv6 Address
     * 
     */
    ...
    private GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop() {}
    /**
     * @return IPv6 Address
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop build() {
            final var _resultValue = new GetServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop();
