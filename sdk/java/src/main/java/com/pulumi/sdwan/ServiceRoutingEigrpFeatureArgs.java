...
public final class ServiceRoutingEigrpFeatureArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<List<ServiceRoutingEigrpFeatureNetworkArgs>> networks;

    /**
     * @return Configure the networks for EIGRP to advertise
     * 
     */
    public Output<List<ServiceRoutingEigrpFeatureNetworkArgs>> networks() {
    ...
    private ServiceRoutingEigrpFeatureArgs() {}

    private ServiceRoutingEigrpFeatureArgs(ServiceRoutingEigrpFeatureArgs $) {
    ...
    public static Builder builder(ServiceRoutingEigrpFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceRoutingEigrpFeatureArgs();
        }

        public Builder(ServiceRoutingEigrpFeatureArgs defaults) {
            $ = new ServiceRoutingEigrpFeatureArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param hmacAuthenticationKey Set hmac-sha-256 authentication key, Attribute conditional on `authentication_type` being equal to `hmac-sha-256`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param md5Keys Set keychain details, Attribute conditional on `authentication_type` being equal to `md5`
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder networks(Output<List<ServiceRoutingEigrpFeatureNetworkArgs>> networks) {
            $.networks = networks;
            return this;
        }
        ...
        public ServiceRoutingEigrpFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("ServiceRoutingEigrpFeatureArgs", "featureProfileId");
            }
            if ($.networks == null) {
                throw new MissingRequiredPropertyException("ServiceRoutingEigrpFeatureArgs", "networks");
            }
            return $;
        }
    }
