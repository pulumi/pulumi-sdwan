...
@CustomType
public final class ServiceLanVpnProfileParcelIpv6ImportRouteTarget {
    /**
     * @return Route target
     * 
     */
    ...
    private ServiceLanVpnProfileParcelIpv6ImportRouteTarget() {}
    /**
     * @return Route target
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnProfileParcelIpv6ImportRouteTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeTargetVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelIpv6ImportRouteTarget defaults) {
        ...
        public ServiceLanVpnProfileParcelIpv6ImportRouteTarget build() {
            final var _resultValue = new ServiceLanVpnProfileParcelIpv6ImportRouteTarget();
