...
public final class GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs Empty = new GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs();
    ...
    private GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs() {}

    private GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs(GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs $) {
    ...
    public static Builder builder(GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs();
        }

        public Builder(GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs defaults) {
            $ = new GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs", "featureProfileId");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs", "id");
            }
            if ($.serviceLanVpnFeatureId == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs", "serviceLanVpnFeatureId");
            }
            if ($.serviceLanVpnInterfaceEthernetFeatureId == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureArgs", "serviceLanVpnInterfaceEthernetFeatureId");
            }
            return $;
        }
    }
