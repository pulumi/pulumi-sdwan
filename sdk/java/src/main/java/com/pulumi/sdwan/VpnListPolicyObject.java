...
import com.pulumi.sdwan.inputs.VpnListPolicyObjectState;
import com.pulumi.sdwan.outputs.VpnListPolicyObjectEntry;
 ...
 * 
 */
@ResourceType(type="sdwan:index/vpnListPolicyObject:VpnListPolicyObject")
public class VpnListPolicyObject extends com.pulumi.resources.CustomResource {
    /**
     * List of entries
     * 
     */
    @Export(name="entries", refs={List.class,VpnListPolicyObjectEntry.class}, tree="[0,1]")
    private Output<List<VpnListPolicyObjectEntry>> entries;

    /**
     * @return List of entries
     * 
     */
    public Output<List<VpnListPolicyObjectEntry>> entries() {
        return this.entries;
    }
    /**
