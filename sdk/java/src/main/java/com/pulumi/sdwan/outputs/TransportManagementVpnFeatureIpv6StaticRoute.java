...
import com.pulumi.sdwan.outputs.TransportManagementVpnFeatureIpv6StaticRouteNextHop;
...
public final class TransportManagementVpnFeatureIpv6StaticRoute {
    ...
    public static Builder builder(TransportManagementVpnFeatureIpv6StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String prefixVariable;
        public Builder() {}
        public Builder(TransportManagementVpnFeatureIpv6StaticRoute defaults) {
        ...
        @CustomType.Setter
        public Builder nextHops(@Nullable List<TransportManagementVpnFeatureIpv6StaticRouteNextHop> nextHops) {

            this.nextHops = nextHops;
            return this;
        }
        public Builder nextHops(TransportManagementVpnFeatureIpv6StaticRouteNextHop... nextHops) {
        ...
        public TransportManagementVpnFeatureIpv6StaticRoute build() {
            final var _resultValue = new TransportManagementVpnFeatureIpv6StaticRoute();
