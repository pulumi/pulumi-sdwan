...
@CustomType
public final class TransportRoutingBgpProfileParcelIpv4NeighborAddressFamily {
    /**
    ...
    private TransportRoutingBgpProfileParcelIpv4NeighborAddressFamily() {}
    /**
     * @return Set IPv4 unicast address family
     *   - Choices: `ipv4-unicast`, `vpnv4-unicast`, `vpnv6-unicast`
     * 
    ...
    public static Builder builder(TransportRoutingBgpProfileParcelIpv4NeighborAddressFamily defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String thresholdVariable;
        public Builder() {}
        public Builder(TransportRoutingBgpProfileParcelIpv4NeighborAddressFamily defaults) {
        ...
        public TransportRoutingBgpProfileParcelIpv4NeighborAddressFamily build() {
            final var _resultValue = new TransportRoutingBgpProfileParcelIpv4NeighborAddressFamily();
