...
public final class OtherUcseFeatureState extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<Integer>> bay() {
        return Optional.ofNullable(this.bay);
    }
    ...
    private OtherUcseFeatureState() {}

    private OtherUcseFeatureState(OtherUcseFeatureState $) {
    ...
    public static Builder builder(OtherUcseFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OtherUcseFeatureState();
        }

        public Builder(OtherUcseFeatureState defaults) {
            $ = new OtherUcseFeatureState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param accessPortSharedFailoverType , Attribute conditional on `accessPortDedicated` being equal to `false`
         *   - Choices: `ge2`, `te2`
         * 
         * @return builder
         * 
        ...
        /**
         * @param accessPortSharedType , Attribute conditional on `accessPortDedicated` being equal to `false`
         *   - Choices: `ge1`, `ge2`, `ge3`, `te2`, `te3`, `console`, `failover`
         * 
         * @return builder
         * 
         ...
         * 
         */
        public Builder bay(@Nullable Output<Integer> bay) {
            $.bay = bay;
            return this;
        }
        ...
        public OtherUcseFeatureState build() {
            return $;
        }
    }
