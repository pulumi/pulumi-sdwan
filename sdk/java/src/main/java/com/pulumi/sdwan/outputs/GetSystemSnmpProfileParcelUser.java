...
@CustomType
public final class GetSystemSnmpProfileParcelUser {
    /**
    ...
    private GetSystemSnmpProfileParcelUser() {}
    /**
     * @return Specify authentication protocol password
     * 
     */
    ...
    public static Builder builder(GetSystemSnmpProfileParcelUser defaults) {
    ...
    public static final class Builder {
        ...
        private String privacyProtocolVariable;
        public Builder() {}
        public Builder(GetSystemSnmpProfileParcelUser defaults) {
        ...
        public Builder authenticationPassword(String authenticationPassword) {
            if (authenticationPassword == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "authenticationPassword");
            }
        ...
        public Builder authenticationPasswordVariable(String authenticationPasswordVariable) {
            if (authenticationPasswordVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "authenticationPasswordVariable");
            }
        ...
        public Builder authenticationProtocol(String authenticationProtocol) {
            if (authenticationProtocol == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "authenticationProtocol");
            }
        ...
        public Builder authenticationProtocolVariable(String authenticationProtocolVariable) {
            if (authenticationProtocolVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "authenticationProtocolVariable");
            }
        ...
        public Builder group(String group) {
            if (group == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "group");
            }
            this.group = group;
            return this;
        }
        ...
        public Builder groupVariable(String groupVariable) {
            if (groupVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "groupVariable");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder privacyPassword(String privacyPassword) {
            if (privacyPassword == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "privacyPassword");
            }
        ...
        public Builder privacyPasswordVariable(String privacyPasswordVariable) {
            if (privacyPasswordVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "privacyPasswordVariable");
            }
        ...
        public Builder privacyProtocol(String privacyProtocol) {
            if (privacyProtocol == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "privacyProtocol");
            }
        ...
        public Builder privacyProtocolVariable(String privacyProtocolVariable) {
            if (privacyProtocolVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpProfileParcelUser", "privacyProtocolVariable");
            }
            this.privacyProtocolVariable = privacyProtocolVariable;
            return this;
        }
        public GetSystemSnmpProfileParcelUser build() {
            final var _resultValue = new GetSystemSnmpProfileParcelUser();
