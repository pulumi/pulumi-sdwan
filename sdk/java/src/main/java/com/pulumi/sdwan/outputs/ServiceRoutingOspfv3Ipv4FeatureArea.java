...
import com.pulumi.sdwan.outputs.ServiceRoutingOspfv3Ipv4FeatureAreaInterface;
import com.pulumi.sdwan.outputs.ServiceRoutingOspfv3Ipv4FeatureAreaRange;
...
@CustomType
public final class ServiceRoutingOspfv3Ipv4FeatureArea {
    /**
     ...
     * 
     */
    private @Nullable List<ServiceRoutingOspfv3Ipv4FeatureAreaInterface> interfaces;
    /**
     ...
     * 
     */
    private @Nullable List<ServiceRoutingOspfv3Ipv4FeatureAreaRange> ranges;
     ...
     * 
     */
    public List<ServiceRoutingOspfv3Ipv4FeatureAreaInterface> interfaces() {
     ...
     * 
     */
    public List<ServiceRoutingOspfv3Ipv4FeatureAreaRange> ranges() {
    ...
    public static Builder builder(ServiceRoutingOspfv3Ipv4FeatureArea defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<ServiceRoutingOspfv3Ipv4FeatureAreaRange> ranges;
        public Builder() {}
        public Builder(ServiceRoutingOspfv3Ipv4FeatureArea defaults) {
        ...
        @CustomType.Setter
        public Builder interfaces(@Nullable List<ServiceRoutingOspfv3Ipv4FeatureAreaInterface> interfaces) {

            this.interfaces = interfaces;
            return this;
        }
        public Builder interfaces(ServiceRoutingOspfv3Ipv4FeatureAreaInterface... interfaces) {
        ...
        @CustomType.Setter
        public Builder ranges(@Nullable List<ServiceRoutingOspfv3Ipv4FeatureAreaRange> ranges) {

            this.ranges = ranges;
            return this;
        }
        public Builder ranges(ServiceRoutingOspfv3Ipv4FeatureAreaRange... ranges) {
            return ranges(List.of(ranges));
        }
        public ServiceRoutingOspfv3Ipv4FeatureArea build() {
            final var _resultValue = new ServiceRoutingOspfv3Ipv4FeatureArea();
