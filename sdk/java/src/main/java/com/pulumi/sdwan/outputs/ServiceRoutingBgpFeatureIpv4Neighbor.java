...
import com.pulumi.sdwan.outputs.ServiceRoutingBgpFeatureIpv4NeighborAddressFamily;
...
@CustomType
public final class ServiceRoutingBgpFeatureIpv4Neighbor {
    /**
     ...
     * 
     */
    private @Nullable List<ServiceRoutingBgpFeatureIpv4NeighborAddressFamily> addressFamilies;
    /**
    ...
    private ServiceRoutingBgpFeatureIpv4Neighbor() {}
    /**
     * @return Set neighbor address
     * 
     */
     ...
     * 
     */
    public List<ServiceRoutingBgpFeatureIpv4NeighborAddressFamily> addressFamilies() {
    ...
    public static Builder builder(ServiceRoutingBgpFeatureIpv4Neighbor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updateSourceInterfaceVariable;
        public Builder() {}
        public Builder(ServiceRoutingBgpFeatureIpv4Neighbor defaults) {
        ...
        @CustomType.Setter
        public Builder addressFamilies(@Nullable List<ServiceRoutingBgpFeatureIpv4NeighborAddressFamily> addressFamilies) {

            this.addressFamilies = addressFamilies;
            return this;
        }
        public Builder addressFamilies(ServiceRoutingBgpFeatureIpv4NeighborAddressFamily... addressFamilies) {
        ...
        public ServiceRoutingBgpFeatureIpv4Neighbor build() {
            final var _resultValue = new ServiceRoutingBgpFeatureIpv4Neighbor();
