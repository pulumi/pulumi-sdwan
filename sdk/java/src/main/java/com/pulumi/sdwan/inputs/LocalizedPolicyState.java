...
public final class LocalizedPolicyState extends com.pulumi.resources.ResourceArgs {
    ...
    private LocalizedPolicyState() {}

    private LocalizedPolicyState(LocalizedPolicyState $) {
    ...
    public static Builder builder(LocalizedPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalizedPolicyState();
        }

        public Builder(LocalizedPolicyState defaults) {
            $ = new LocalizedPolicyState(Objects.requireNonNull(defaults));
        }
        ...
        public LocalizedPolicyState build() {
            return $;
        }
    }
