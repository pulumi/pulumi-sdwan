...
@CustomType
public final class SystemSnmpFeatureGroup {
    /**
    ...
    public static Builder builder(SystemSnmpFeatureGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String viewVariable;
        public Builder() {}
        public Builder(SystemSnmpFeatureGroup defaults) {
        ...
        public SystemSnmpFeatureGroup build() {
            final var _resultValue = new SystemSnmpFeatureGroup();
