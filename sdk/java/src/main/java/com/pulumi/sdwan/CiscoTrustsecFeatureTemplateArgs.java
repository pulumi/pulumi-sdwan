...
public final class CiscoTrustsecFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final CiscoTrustsecFeatureTemplateArgs Empty = new CiscoTrustsecFeatureTemplateArgs();
    ...
    private CiscoTrustsecFeatureTemplateArgs() {}

    private CiscoTrustsecFeatureTemplateArgs(CiscoTrustsecFeatureTemplateArgs $) {
    ...
    public static Builder builder(CiscoTrustsecFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoTrustsecFeatureTemplateArgs();
        }

        public Builder(CiscoTrustsecFeatureTemplateArgs defaults) {
            $ = new CiscoTrustsecFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CiscoTrustsecFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("CiscoTrustsecFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("CiscoTrustsecFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
