...
@CustomType
public final class GetTransportManagementVpnFeatureIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private GetTransportManagementVpnFeatureIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetTransportManagementVpnFeatureIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetTransportManagementVpnFeatureIpv6StaticRouteNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv6StaticRouteNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv6StaticRouteNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv6StaticRouteNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv6StaticRouteNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetTransportManagementVpnFeatureIpv6StaticRouteNextHop build() {
            final var _resultValue = new GetTransportManagementVpnFeatureIpv6StaticRouteNextHop();
