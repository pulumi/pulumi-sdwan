...
import com.pulumi.sdwan.outputs.GetSystemBfdProfileParcelColor;
...
@CustomType
public final class GetSystemBfdProfileParcelResult {
    /**
     * @return Set color that identifies the WAN transport tunnel
     * 
     */
    private List<GetSystemBfdProfileParcelColor> colors;
     ...
     * 
     */
    public List<GetSystemBfdProfileParcelColor> colors() {
        return this.colors;
    }
    ...
    public static Builder builder(GetSystemBfdProfileParcelResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetSystemBfdProfileParcelResult defaults) {
        ...
        @CustomType.Setter
        public Builder colors(List<GetSystemBfdProfileParcelColor> colors) {
            if (colors == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "colors");
            }
            this.colors = colors;
            return this;
        }
        public Builder colors(GetSystemBfdProfileParcelColor... colors) {
            return colors(List.of(colors));
        }
        @CustomType.Setter
        public Builder defaultDscp(Integer defaultDscp) {
            if (defaultDscp == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "defaultDscp");
            }
        ...
        public Builder defaultDscpVariable(String defaultDscpVariable) {
            if (defaultDscpVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "defaultDscpVariable");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "description");
            }
        ...
        public Builder featureProfileId(String featureProfileId) {
            if (featureProfileId == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "featureProfileId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder multiplier(Integer multiplier) {
            if (multiplier == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "multiplier");
            }
        ...
        public Builder multiplierVariable(String multiplierVariable) {
            if (multiplierVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "multiplierVariable");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder pollInterval(Integer pollInterval) {
            if (pollInterval == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "pollInterval");
            }
        ...
        public Builder pollIntervalVariable(String pollIntervalVariable) {
            if (pollIntervalVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "pollIntervalVariable");
            }
        ...
        public Builder version(Integer version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetSystemBfdProfileParcelResult", "version");
            }
            this.version = version;
            return this;
        }
        public GetSystemBfdProfileParcelResult build() {
            final var _resultValue = new GetSystemBfdProfileParcelResult();
