...
@CustomType
public final class SystemSnmpFeatureUser {
    /**
    ...
    public static Builder builder(SystemSnmpFeatureUser defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String privacyProtocolVariable;
        public Builder() {}
        public Builder(SystemSnmpFeatureUser defaults) {
        ...
        public SystemSnmpFeatureUser build() {
            final var _resultValue = new SystemSnmpFeatureUser();
