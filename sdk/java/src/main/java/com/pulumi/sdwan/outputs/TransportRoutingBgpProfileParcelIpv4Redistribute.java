...
@CustomType
public final class TransportRoutingBgpProfileParcelIpv4Redistribute {
    /**
    ...
    private TransportRoutingBgpProfileParcelIpv4Redistribute() {}
    /**
     * @return Set the protocol to redistribute routes from
     *   - Choices: `static`, `connected`, `ospf`, `ospfv3`, `nat`
     * 
    ...
    public static Builder builder(TransportRoutingBgpProfileParcelIpv4Redistribute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routePolicyId;
        public Builder() {}
        public Builder(TransportRoutingBgpProfileParcelIpv4Redistribute defaults) {
        ...
        public TransportRoutingBgpProfileParcelIpv4Redistribute build() {
            final var _resultValue = new TransportRoutingBgpProfileParcelIpv4Redistribute();
