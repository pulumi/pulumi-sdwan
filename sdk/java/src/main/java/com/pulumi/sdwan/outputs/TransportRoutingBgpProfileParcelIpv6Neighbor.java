...
import com.pulumi.sdwan.outputs.TransportRoutingBgpProfileParcelIpv6NeighborAddressFamily;
...
@CustomType
public final class TransportRoutingBgpProfileParcelIpv6Neighbor {
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingBgpProfileParcelIpv6NeighborAddressFamily> addressFamilies;
    /**
    ...
    private TransportRoutingBgpProfileParcelIpv6Neighbor() {}
    /**
     * @return Set IPv6 neighbor address
     * 
     */
     ...
     * 
     */
    public List<TransportRoutingBgpProfileParcelIpv6NeighborAddressFamily> addressFamilies() {
    ...
    public static Builder builder(TransportRoutingBgpProfileParcelIpv6Neighbor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updateSourceInterfaceVariable;
        public Builder() {}
        public Builder(TransportRoutingBgpProfileParcelIpv6Neighbor defaults) {
        ...
        @CustomType.Setter
        public Builder addressFamilies(@Nullable List<TransportRoutingBgpProfileParcelIpv6NeighborAddressFamily> addressFamilies) {

            this.addressFamilies = addressFamilies;
            return this;
        }
        public Builder addressFamilies(TransportRoutingBgpProfileParcelIpv6NeighborAddressFamily... addressFamilies) {
        ...
        public TransportRoutingBgpProfileParcelIpv6Neighbor build() {
            final var _resultValue = new TransportRoutingBgpProfileParcelIpv6Neighbor();
