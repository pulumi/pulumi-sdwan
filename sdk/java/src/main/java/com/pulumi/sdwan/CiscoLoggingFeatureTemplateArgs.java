...
public final class CiscoLoggingFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final CiscoLoggingFeatureTemplateArgs Empty = new CiscoLoggingFeatureTemplateArgs();
    ...
    private CiscoLoggingFeatureTemplateArgs() {}

    private CiscoLoggingFeatureTemplateArgs(CiscoLoggingFeatureTemplateArgs $) {
    ...
    public static Builder builder(CiscoLoggingFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoLoggingFeatureTemplateArgs();
        }

        public Builder(CiscoLoggingFeatureTemplateArgs defaults) {
            $ = new CiscoLoggingFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param diskLogging Enable logging to local disk
         *   - Default value: `true`
         * 
         * @return builder
         * 
        ...
        /**
         * @param logRotations Set number of syslog files to create before discarding oldest files
         *   - Range: `1`-`10`
         *   - Default value: `10`
         * 
         * @return builder
        ...
        /**
         * @param maxSize Set maximum size of file before it is rotated
         *   - Range: `1`-`20`
         *   - Default value: `10`
         * 
         * @return builder
        ...
        public CiscoLoggingFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("CiscoLoggingFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("CiscoLoggingFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
