...
import com.pulumi.sdwan.outputs.TransportRoutingOspfFeatureAreaInterface;
import com.pulumi.sdwan.outputs.TransportRoutingOspfFeatureAreaRange;
...
@CustomType
public final class TransportRoutingOspfFeatureArea {
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingOspfFeatureAreaInterface> interfaces;
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingOspfFeatureAreaRange> ranges;
     ...
     * 
     */
    public List<TransportRoutingOspfFeatureAreaInterface> interfaces() {
     ...
     * 
     */
    public List<TransportRoutingOspfFeatureAreaRange> ranges() {
    ...
    public static Builder builder(TransportRoutingOspfFeatureArea defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<TransportRoutingOspfFeatureAreaRange> ranges;
        public Builder() {}
        public Builder(TransportRoutingOspfFeatureArea defaults) {
        ...
        @CustomType.Setter
        public Builder interfaces(@Nullable List<TransportRoutingOspfFeatureAreaInterface> interfaces) {

            this.interfaces = interfaces;
            return this;
        }
        public Builder interfaces(TransportRoutingOspfFeatureAreaInterface... interfaces) {
        ...
        @CustomType.Setter
        public Builder ranges(@Nullable List<TransportRoutingOspfFeatureAreaRange> ranges) {

            this.ranges = ranges;
            return this;
        }
        public Builder ranges(TransportRoutingOspfFeatureAreaRange... ranges) {
            return ranges(List.of(ranges));
        }
        public TransportRoutingOspfFeatureArea build() {
            final var _resultValue = new TransportRoutingOspfFeatureArea();
