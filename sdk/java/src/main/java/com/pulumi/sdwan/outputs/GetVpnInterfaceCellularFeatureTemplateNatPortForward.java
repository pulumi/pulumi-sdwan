...
@CustomType
public final class GetVpnInterfaceCellularFeatureTemplateNatPortForward {
    /**
    ...
    private GetVpnInterfaceCellularFeatureTemplateNatPortForward() {}
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    ...
    public static Builder builder(GetVpnInterfaceCellularFeatureTemplateNatPortForward defaults) {
    ...
    public static final class Builder {
        ...
        private String protocol;
        public Builder() {}
        public Builder(GetVpnInterfaceCellularFeatureTemplateNatPortForward defaults) {
        ...
        public Builder optional(Boolean optional) {
            if (optional == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "optional");
            }
        ...
        public Builder portEndRange(Integer portEndRange) {
            if (portEndRange == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "portEndRange");
            }
        ...
        public Builder portStartRange(Integer portStartRange) {
            if (portStartRange == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "portStartRange");
            }
        ...
        public Builder privateIpAddress(String privateIpAddress) {
            if (privateIpAddress == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "privateIpAddress");
            }
        ...
        public Builder privateIpAddressVariable(String privateIpAddressVariable) {
            if (privateIpAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "privateIpAddressVariable");
            }
        ...
        public Builder privateVpn(Integer privateVpn) {
            if (privateVpn == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "privateVpn");
            }
        ...
        public Builder privateVpnVariable(String privateVpnVariable) {
            if (privateVpnVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "privateVpnVariable");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceCellularFeatureTemplateNatPortForward", "protocol");
            }
            this.protocol = protocol;
            return this;
        }
        public GetVpnInterfaceCellularFeatureTemplateNatPortForward build() {
            final var _resultValue = new GetVpnInterfaceCellularFeatureTemplateNatPortForward();
