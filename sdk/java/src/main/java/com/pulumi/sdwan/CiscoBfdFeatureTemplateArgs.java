...
public final class CiscoBfdFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final CiscoBfdFeatureTemplateArgs Empty = new CiscoBfdFeatureTemplateArgs();
    ...
    private CiscoBfdFeatureTemplateArgs() {}

    private CiscoBfdFeatureTemplateArgs(CiscoBfdFeatureTemplateArgs $) {
        this.colors = $.colors;
    ...
    public static Builder builder(CiscoBfdFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoBfdFeatureTemplateArgs();
        }

        public Builder(CiscoBfdFeatureTemplateArgs defaults) {
            $ = new CiscoBfdFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CiscoBfdFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("CiscoBfdFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("CiscoBfdFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
