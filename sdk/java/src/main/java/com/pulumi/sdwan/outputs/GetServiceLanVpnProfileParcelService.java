...
@CustomType
public final class GetServiceLanVpnProfileParcelService {
    /**
    ...
    private GetServiceLanVpnProfileParcelService() {}
    /**
     * @return IPv4 Addresses (Maximum: 4)
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelService defaults) {
    ...
    public static final class Builder {
        ...
        private String trackingVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelService defaults) {
        ...
        public Builder ipv4Addresses(List<String> ipv4Addresses) {
            if (ipv4Addresses == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelService", "ipv4Addresses");
            }
        ...
        public Builder ipv4AddressesVariable(String ipv4AddressesVariable) {
            if (ipv4AddressesVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelService", "ipv4AddressesVariable");
            }
        ...
        public Builder serviceType(String serviceType) {
            if (serviceType == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelService", "serviceType");
            }
        ...
        public Builder serviceTypeVariable(String serviceTypeVariable) {
            if (serviceTypeVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelService", "serviceTypeVariable");
            }
        ...
        public Builder tracking(Boolean tracking) {
            if (tracking == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelService", "tracking");
            }
        ...
        public Builder trackingVariable(String trackingVariable) {
            if (trackingVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelService", "trackingVariable");
            }
            this.trackingVariable = trackingVariable;
            return this;
        }
        public GetServiceLanVpnProfileParcelService build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelService();
