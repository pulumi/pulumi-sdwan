...
@CustomType
public final class ServiceLanVpnInterfaceEthernetProfileParcelIpv6VrrpAddress {
    /**
    ...
    public static Builder builder(ServiceLanVpnInterfaceEthernetProfileParcelIpv6VrrpAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String linkLocalAddressVariable;
        public Builder() {}
        public Builder(ServiceLanVpnInterfaceEthernetProfileParcelIpv6VrrpAddress defaults) {
        ...
        public ServiceLanVpnInterfaceEthernetProfileParcelIpv6VrrpAddress build() {
            final var _resultValue = new ServiceLanVpnInterfaceEthernetProfileParcelIpv6VrrpAddress();
