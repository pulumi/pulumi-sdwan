...
import com.pulumi.sdwan.outputs.CiscoOspfv3FeatureTemplateIpv4AreaInterface;
import com.pulumi.sdwan.outputs.CiscoOspfv3FeatureTemplateIpv4AreaRange;
...
@CustomType
public final class CiscoOspfv3FeatureTemplateIpv4Area {
    /**
     ...
     * 
     */
    private @Nullable List<CiscoOspfv3FeatureTemplateIpv4AreaInterface> interfaces;
    /**
     ...
     * 
     */
    private @Nullable List<CiscoOspfv3FeatureTemplateIpv4AreaRange> ranges;
    /**
     * @return Stub area
     * 
     */
    ...
    private CiscoOspfv3FeatureTemplateIpv4Area() {}
    /**
     * @return Set OSPF area number
     *   - Range: `0`-`4294967295`
     * 
     ...
     * 
     */
    public List<CiscoOspfv3FeatureTemplateIpv4AreaInterface> interfaces() {
     ...
     * 
     */
    public List<CiscoOspfv3FeatureTemplateIpv4AreaRange> ranges() {
    ...
    public static Builder builder(CiscoOspfv3FeatureTemplateIpv4Area defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String translateVariable;
        public Builder() {}
        public Builder(CiscoOspfv3FeatureTemplateIpv4Area defaults) {
        ...
        @CustomType.Setter
        public Builder interfaces(@Nullable List<CiscoOspfv3FeatureTemplateIpv4AreaInterface> interfaces) {

            this.interfaces = interfaces;
            return this;
        }
        public Builder interfaces(CiscoOspfv3FeatureTemplateIpv4AreaInterface... interfaces) {
        ...
        @CustomType.Setter
        public Builder ranges(@Nullable List<CiscoOspfv3FeatureTemplateIpv4AreaRange> ranges) {

            this.ranges = ranges;
            return this;
        }
        public Builder ranges(CiscoOspfv3FeatureTemplateIpv4AreaRange... ranges) {
        ...
        public CiscoOspfv3FeatureTemplateIpv4Area build() {
            final var _resultValue = new CiscoOspfv3FeatureTemplateIpv4Area();
