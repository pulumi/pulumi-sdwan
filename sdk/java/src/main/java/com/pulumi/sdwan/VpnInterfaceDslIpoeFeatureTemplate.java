...
public class VpnInterfaceDslIpoeFeatureTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public VpnInterfaceDslIpoeFeatureTemplate(java.lang.String name) {
     ...
     */
    public VpnInterfaceDslIpoeFeatureTemplate(java.lang.String name, VpnInterfaceDslIpoeFeatureTemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VpnInterfaceDslIpoeFeatureTemplate(java.lang.String name, VpnInterfaceDslIpoeFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/vpnInterfaceDslIpoeFeatureTemplate:VpnInterfaceDslIpoeFeatureTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VpnInterfaceDslIpoeFeatureTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable VpnInterfaceDslIpoeFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/vpnInterfaceDslIpoeFeatureTemplate:VpnInterfaceDslIpoeFeatureTemplate", name, state, makeResourceOptions(options, id), false);
    }

    private static VpnInterfaceDslIpoeFeatureTemplateArgs makeArgs(VpnInterfaceDslIpoeFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VpnInterfaceDslIpoeFeatureTemplateArgs.Empty : args;
    }
     ...
     */
    public static VpnInterfaceDslIpoeFeatureTemplate get(java.lang.String name, Output<java.lang.String> id, @Nullable VpnInterfaceDslIpoeFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
