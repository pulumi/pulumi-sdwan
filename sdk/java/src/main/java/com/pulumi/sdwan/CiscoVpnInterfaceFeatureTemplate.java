 ...
 *                 .ip_address("2.2.2.2")
 *                 .ipv4_secondary_addresses(List.of(Map.of("ipAddress", "2.2.2.3")))
 *                 .tloc_preference_change(false)
 *                 .tloc_preference_change_value(10)
 *                 .tracking_objects(List.of(Map.ofEntries(
 *                     Map.entry("trackerId", 10),
 *                     Map.entry("trackAction", "decrement"),
 ...
 *                     Map.entry("ipv6LinkLocal", "fe80::260:8ff:fe52:f9d8"),
 *                     Map.entry("prefix", "2001:9::/48")
 *                 )))
 *                 .build())
 *             .propagateSgt(false)
 *             .staticSgt(1003)
