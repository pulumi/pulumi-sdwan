...
public class CiscoVpnInterfaceFeatureTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public CiscoVpnInterfaceFeatureTemplate(String name) {
     ...
     */
    public CiscoVpnInterfaceFeatureTemplate(String name, CiscoVpnInterfaceFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/ciscoVpnInterfaceFeatureTemplate:CiscoVpnInterfaceFeatureTemplate", name, args == null ? CiscoVpnInterfaceFeatureTemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private CiscoVpnInterfaceFeatureTemplate(String name, Output<String> id, @Nullable CiscoVpnInterfaceFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/ciscoVpnInterfaceFeatureTemplate:CiscoVpnInterfaceFeatureTemplate", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static CiscoVpnInterfaceFeatureTemplate get(String name, Output<String> id, @Nullable CiscoVpnInterfaceFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
