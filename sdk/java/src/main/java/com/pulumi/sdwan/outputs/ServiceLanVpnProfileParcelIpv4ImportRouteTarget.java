...
@CustomType
public final class ServiceLanVpnProfileParcelIpv4ImportRouteTarget {
    /**
     * @return Route target
     * 
     */
    ...
    private ServiceLanVpnProfileParcelIpv4ImportRouteTarget() {}
    /**
     * @return Route target
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnProfileParcelIpv4ImportRouteTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeTargetVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelIpv4ImportRouteTarget defaults) {
        ...
        public ServiceLanVpnProfileParcelIpv4ImportRouteTarget build() {
            final var _resultValue = new ServiceLanVpnProfileParcelIpv4ImportRouteTarget();
