...
@CustomType
public final class GetServiceLanVpnFeatureIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private GetServiceLanVpnFeatureIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnFeatureIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnFeatureIpv6StaticRouteNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureIpv6StaticRouteNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetServiceLanVpnFeatureIpv6StaticRouteNextHop build() {
            final var _resultValue = new GetServiceLanVpnFeatureIpv6StaticRouteNextHop();
