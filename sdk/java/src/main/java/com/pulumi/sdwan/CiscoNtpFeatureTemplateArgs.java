...
public final class CiscoNtpFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final CiscoNtpFeatureTemplateArgs Empty = new CiscoNtpFeatureTemplateArgs();
    ...
    private CiscoNtpFeatureTemplateArgs() {}

    private CiscoNtpFeatureTemplateArgs(CiscoNtpFeatureTemplateArgs $) {
    ...
    public static Builder builder(CiscoNtpFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoNtpFeatureTemplateArgs();
        }

        public Builder(CiscoNtpFeatureTemplateArgs defaults) {
            $ = new CiscoNtpFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CiscoNtpFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("CiscoNtpFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("CiscoNtpFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
