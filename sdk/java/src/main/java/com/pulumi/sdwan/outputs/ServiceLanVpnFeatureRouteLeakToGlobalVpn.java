...
import com.pulumi.sdwan.outputs.ServiceLanVpnFeatureRouteLeakToGlobalVpnRedistribution;
...
@CustomType
public final class ServiceLanVpnFeatureRouteLeakToGlobalVpn {
    /**
     * @return Redistribute Routes to specific Protocol on Global VPN
     * 
     */
    private @Nullable List<ServiceLanVpnFeatureRouteLeakToGlobalVpnRedistribution> redistributions;
     ...
     * 
     */
    public List<ServiceLanVpnFeatureRouteLeakToGlobalVpnRedistribution> redistributions() {
    ...
    public static Builder builder(ServiceLanVpnFeatureRouteLeakToGlobalVpn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeProtocolVariable;
        public Builder() {}
        public Builder(ServiceLanVpnFeatureRouteLeakToGlobalVpn defaults) {
        ...
        @CustomType.Setter
        public Builder redistributions(@Nullable List<ServiceLanVpnFeatureRouteLeakToGlobalVpnRedistribution> redistributions) {

            this.redistributions = redistributions;
            return this;
        }
        public Builder redistributions(ServiceLanVpnFeatureRouteLeakToGlobalVpnRedistribution... redistributions) {
        ...
        public ServiceLanVpnFeatureRouteLeakToGlobalVpn build() {
            final var _resultValue = new ServiceLanVpnFeatureRouteLeakToGlobalVpn();
