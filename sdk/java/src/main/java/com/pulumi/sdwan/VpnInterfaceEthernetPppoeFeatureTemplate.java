...
import com.pulumi.sdwan.inputs.VpnInterfaceEthernetPppoeFeatureTemplateState;
import com.pulumi.sdwan.outputs.VpnInterfaceEthernetPppoeFeatureTemplateAccessList;
import com.pulumi.sdwan.outputs.VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward;
import com.pulumi.sdwan.outputs.VpnInterfaceEthernetPppoeFeatureTemplatePolicer;
import com.pulumi.sdwan.outputs.VpnInterfaceEthernetPppoeFeatureTemplateTunnelInterfaceEncapsulation;
 ...
 * 
 */
@ResourceType(type="sdwan:index/vpnInterfaceEthernetPppoeFeatureTemplate:VpnInterfaceEthernetPppoeFeatureTemplate")
public class VpnInterfaceEthernetPppoeFeatureTemplate extends com.pulumi.resources.CustomResource {
    /**
     * Apply ACL
     * 
     */
    @Export(name="accessLists", refs={List.class,VpnInterfaceEthernetPppoeFeatureTemplateAccessList.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceEthernetPppoeFeatureTemplateAccessList>> accessLists;

    /**
     * @return Apply ACL
     * 
     */
    public Output<Optional<List<VpnInterfaceEthernetPppoeFeatureTemplateAccessList>>> accessLists() {
     ...
     * 
     */
    @Export(name="dialerTcpMss", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> dialerTcpMss;
     ...
     * 
     */
    public Output<Optional<Integer>> dialerTcpMss() {
        return Codegen.optional(this.dialerTcpMss);
    }
    /**
     * Variable name
     * 
     */
    @Export(name="dialerTcpMssVariable", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> dialerTcpMssVariable;

    /**
     * @return Variable name
     * 
     */
    public Output<Optional<String>> dialerTcpMssVariable() {
        return Codegen.optional(this.dialerTcpMssVariable);
    }
    /**
     * Enable core region
     *   - Default value: `false`
     ...
     * 
     */
    @Export(name="ipMtuForDialerInterface", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> ipMtuForDialerInterface;
     ...
     * 
     */
    public Output<Optional<Integer>> ipMtuForDialerInterface() {
        return Codegen.optional(this.ipMtuForDialerInterface);
    }
    /**
     * Variable name
     * 
     */
    @Export(name="ipMtuForDialerInterfaceVariable", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> ipMtuForDialerInterfaceVariable;

    /**
     * @return Variable name
     * 
     */
    public Output<Optional<String>> ipMtuForDialerInterfaceVariable() {
        return Codegen.optional(this.ipMtuForDialerInterfaceVariable);
    }
    /**
     ...
     * 
     */
    @Export(name="natPortForwards", refs={List.class,VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward>> natPortForwards;

    /**
     * @return Set port-forwarding rules for NAT on this interface
     * 
     */
    public Output<Optional<List<VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward>>> natPortForwards() {
     ...
     * 
     */
    @Export(name="policers", refs={List.class,VpnInterfaceEthernetPppoeFeatureTemplatePolicer.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceEthernetPppoeFeatureTemplatePolicer>> policers;

    /**
     * @return Enable policer
     * 
     */
    public Output<Optional<List<VpnInterfaceEthernetPppoeFeatureTemplatePolicer>>> policers() {
     ...
     * 
     */
    @Export(name="tunnelInterfaceEncapsulations", refs={List.class,VpnInterfaceEthernetPppoeFeatureTemplateTunnelInterfaceEncapsulation.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceEthernetPppoeFeatureTemplateTunnelInterfaceEncapsulation>> tunnelInterfaceEncapsulations;

    /**
     * @return Encapsulation for TLOC
     * 
     */
    public Output<Optional<List<VpnInterfaceEthernetPppoeFeatureTemplateTunnelInterfaceEncapsulation>>> tunnelInterfaceEncapsulations() {
     ...
     */
    public VpnInterfaceEthernetPppoeFeatureTemplate(java.lang.String name) {
        this(name, VpnInterfaceEthernetPppoeFeatureTemplateArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VpnInterfaceEthernetPppoeFeatureTemplate(java.lang.String name, VpnInterfaceEthernetPppoeFeatureTemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VpnInterfaceEthernetPppoeFeatureTemplate(java.lang.String name, VpnInterfaceEthernetPppoeFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/vpnInterfaceEthernetPppoeFeatureTemplate:VpnInterfaceEthernetPppoeFeatureTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VpnInterfaceEthernetPppoeFeatureTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable VpnInterfaceEthernetPppoeFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/vpnInterfaceEthernetPppoeFeatureTemplate:VpnInterfaceEthernetPppoeFeatureTemplate", name, state, makeResourceOptions(options, id), false);
    }

    private static VpnInterfaceEthernetPppoeFeatureTemplateArgs makeArgs(VpnInterfaceEthernetPppoeFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VpnInterfaceEthernetPppoeFeatureTemplateArgs.Empty : args;
    }
     ...
     */
    public static VpnInterfaceEthernetPppoeFeatureTemplate get(java.lang.String name, Output<java.lang.String> id, @Nullable VpnInterfaceEthernetPppoeFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new VpnInterfaceEthernetPppoeFeatureTemplate(name, id, state, options);
    }
}
