...
@CustomType
public final class GetTransportRoutingBgpFeatureIpv4AggregateAddress {
    /**
    ...
    private GetTransportRoutingBgpFeatureIpv4AggregateAddress() {}
    /**
     * @return Set AS set path information
     * 
     */
    ...
    public static Builder builder(GetTransportRoutingBgpFeatureIpv4AggregateAddress defaults) {
    ...
    public static final class Builder {
        ...
        private String summaryOnlyVariable;
        public Builder() {}
        public Builder(GetTransportRoutingBgpFeatureIpv4AggregateAddress defaults) {
        ...
        public Builder asSetPath(Boolean asSetPath) {
            if (asSetPath == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "asSetPath");
            }
        ...
        public Builder asSetPathVariable(String asSetPathVariable) {
            if (asSetPathVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "asSetPathVariable");
            }
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "networkAddressVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "subnetMaskVariable");
            }
        ...
        public Builder summaryOnly(Boolean summaryOnly) {
            if (summaryOnly == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "summaryOnly");
            }
        ...
        public Builder summaryOnlyVariable(String summaryOnlyVariable) {
            if (summaryOnlyVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpFeatureIpv4AggregateAddress", "summaryOnlyVariable");
            }
            this.summaryOnlyVariable = summaryOnlyVariable;
            return this;
        }
        public GetTransportRoutingBgpFeatureIpv4AggregateAddress build() {
            final var _resultValue = new GetTransportRoutingBgpFeatureIpv4AggregateAddress();
