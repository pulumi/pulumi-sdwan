...
import com.pulumi.sdwan.inputs.TransportWanVpnFeatureIpv6StaticRouteNextHopArgs;
...
public final class TransportWanVpnFeatureIpv6StaticRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportWanVpnFeatureIpv6StaticRouteArgs Empty = new TransportWanVpnFeatureIpv6StaticRouteArgs();
    ...
    private @Nullable Output<List<TransportWanVpnFeatureIpv6StaticRouteNextHopArgs>> nextHops;

    /**
     * @return IPv6 Route Gateway Next Hop, Attribute conditional on `gateway` being equal to `nextHop`
     * 
     */
    public Optional<Output<List<TransportWanVpnFeatureIpv6StaticRouteNextHopArgs>>> nextHops() {
    ...
    private TransportWanVpnFeatureIpv6StaticRouteArgs() {}

    private TransportWanVpnFeatureIpv6StaticRouteArgs(TransportWanVpnFeatureIpv6StaticRouteArgs $) {
    ...
    public static Builder builder(TransportWanVpnFeatureIpv6StaticRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportWanVpnFeatureIpv6StaticRouteArgs();
        }

        public Builder(TransportWanVpnFeatureIpv6StaticRouteArgs defaults) {
            $ = new TransportWanVpnFeatureIpv6StaticRouteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder nextHops(@Nullable Output<List<TransportWanVpnFeatureIpv6StaticRouteNextHopArgs>> nextHops) {
            $.nextHops = nextHops;
            return this;
        }
         ...
         * 
         */
        public Builder nextHops(List<TransportWanVpnFeatureIpv6StaticRouteNextHopArgs> nextHops) {
         ...
         * 
         */
        public Builder nextHops(TransportWanVpnFeatureIpv6StaticRouteNextHopArgs... nextHops) {
        ...
        public TransportWanVpnFeatureIpv6StaticRouteArgs build() {
            return $;
        }
    }
