...
public final class ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs Empty = new ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs();
    ...
    private ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs() {}

    private ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs(ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs $) {
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs();
        }

        public Builder(ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs defaults) {
            $ = new ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceLanVpnFeatureIpv4StaticRouteNextHopArgs build() {
            return $;
        }
    }
