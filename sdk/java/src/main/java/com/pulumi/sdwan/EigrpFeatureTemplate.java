...
public class EigrpFeatureTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public EigrpFeatureTemplate(String name) {
     ...
     */
    public EigrpFeatureTemplate(String name, EigrpFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/eigrpFeatureTemplate:EigrpFeatureTemplate", name, args == null ? EigrpFeatureTemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EigrpFeatureTemplate(String name, Output<String> id, @Nullable EigrpFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/eigrpFeatureTemplate:EigrpFeatureTemplate", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static EigrpFeatureTemplate get(String name, Output<String> id, @Nullable EigrpFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
