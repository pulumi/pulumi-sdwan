...
public final class ServiceLanVpnFeatureIpv4ImportRouteTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceLanVpnFeatureIpv4ImportRouteTargetArgs Empty = new ServiceLanVpnFeatureIpv4ImportRouteTargetArgs();
    ...
    private ServiceLanVpnFeatureIpv4ImportRouteTargetArgs() {}

    private ServiceLanVpnFeatureIpv4ImportRouteTargetArgs(ServiceLanVpnFeatureIpv4ImportRouteTargetArgs $) {
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv4ImportRouteTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceLanVpnFeatureIpv4ImportRouteTargetArgs();
        }

        public Builder(ServiceLanVpnFeatureIpv4ImportRouteTargetArgs defaults) {
            $ = new ServiceLanVpnFeatureIpv4ImportRouteTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceLanVpnFeatureIpv4ImportRouteTargetArgs build() {
            return $;
        }
    }
