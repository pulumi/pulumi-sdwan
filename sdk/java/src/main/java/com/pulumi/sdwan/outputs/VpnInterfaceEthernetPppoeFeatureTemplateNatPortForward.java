...
@CustomType
public final class VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward {
    /**
    ...
    private VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward() {}
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    ...
    public static Builder builder(VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String protocol;
        public Builder() {}
        public Builder(VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward defaults) {
        ...
        public VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward build() {
            final var _resultValue = new VpnInterfaceEthernetPppoeFeatureTemplateNatPortForward();
