...
@CustomType
public final class TransportRoutingBgpFeatureIpv4Network {
    ...
    private TransportRoutingBgpFeatureIpv4Network() {}
    ...
    public static Builder builder(TransportRoutingBgpFeatureIpv4Network defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportRoutingBgpFeatureIpv4Network defaults) {
        ...
        public TransportRoutingBgpFeatureIpv4Network build() {
            final var _resultValue = new TransportRoutingBgpFeatureIpv4Network();
