...
import com.pulumi.sdwan.inputs.CiscoThousandeyesFeatureTemplateState;
import com.pulumi.sdwan.outputs.CiscoThousandeyesFeatureTemplateVirtualApplication;
 ...
 * 
 */
@ResourceType(type="sdwan:index/ciscoThousandeyesFeatureTemplate:CiscoThousandeyesFeatureTemplate")
public class CiscoThousandeyesFeatureTemplate extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="virtualApplications", refs={List.class,CiscoThousandeyesFeatureTemplateVirtualApplication.class}, tree="[0,1]")
    private Output</* @Nullable */ List<CiscoThousandeyesFeatureTemplateVirtualApplication>> virtualApplications;

    /**
     * @return Virtual application Instance
     * 
     */
    public Output<Optional<List<CiscoThousandeyesFeatureTemplateVirtualApplication>>> virtualApplications() {
