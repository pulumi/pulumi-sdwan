...
@CustomType
public final class GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily {
    /**
    ...
    private GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily() {}
    /**
     * @return Set IPv6 unicast address family
     * 
     */
    ...
    public static Builder builder(GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily defaults) {
    ...
    public static final class Builder {
        ...
        private String thresholdVariable;
        public Builder() {}
        public Builder(GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily defaults) {
        ...
        public Builder familyType(String familyType) {
            if (familyType == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "familyType");
            }
        ...
        public Builder inRoutePolicyId(String inRoutePolicyId) {
            if (inRoutePolicyId == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "inRoutePolicyId");
            }
        ...
        public Builder maxNumberOfPrefixes(Integer maxNumberOfPrefixes) {
            if (maxNumberOfPrefixes == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "maxNumberOfPrefixes");
            }
        ...
        public Builder maxNumberOfPrefixesVariable(String maxNumberOfPrefixesVariable) {
            if (maxNumberOfPrefixesVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "maxNumberOfPrefixesVariable");
            }
        ...
        public Builder outRoutePolicyId(String outRoutePolicyId) {
            if (outRoutePolicyId == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "outRoutePolicyId");
            }
        ...
        public Builder policyType(String policyType) {
            if (policyType == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "policyType");
            }
        ...
        public Builder restartInterval(Integer restartInterval) {
            if (restartInterval == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "restartInterval");
            }
        ...
        public Builder restartIntervalVariable(String restartIntervalVariable) {
            if (restartIntervalVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "restartIntervalVariable");
            }
        ...
        public Builder threshold(Integer threshold) {
            if (threshold == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "threshold");
            }
        ...
        public Builder thresholdVariable(String thresholdVariable) {
            if (thresholdVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily", "thresholdVariable");
            }
            this.thresholdVariable = thresholdVariable;
            return this;
        }
        public GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily build() {
            final var _resultValue = new GetTransportRoutingBgpProfileParcelIpv6NeighborAddressFamily();
