...
@CustomType
public final class TransportWanVpnInterfaceEthernetProfileParcelArp {
    /**
    ...
    private TransportWanVpnInterfaceEthernetProfileParcelArp() {}
    /**
     * @return IP V4 Address
     * 
     */
    ...
    public static Builder builder(TransportWanVpnInterfaceEthernetProfileParcelArp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String macAddressVariable;
        public Builder() {}
        public Builder(TransportWanVpnInterfaceEthernetProfileParcelArp defaults) {
        ...
        public TransportWanVpnInterfaceEthernetProfileParcelArp build() {
            final var _resultValue = new TransportWanVpnInterfaceEthernetProfileParcelArp();
