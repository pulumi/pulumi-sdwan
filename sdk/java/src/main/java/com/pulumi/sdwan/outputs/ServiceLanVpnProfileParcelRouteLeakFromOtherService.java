...
import com.pulumi.sdwan.outputs.ServiceLanVpnProfileParcelRouteLeakFromOtherServiceRedistribution;
...
@CustomType
public final class ServiceLanVpnProfileParcelRouteLeakFromOtherService {
    /**
     * @return Redistribute Route to specific Protocol on Current Service VPN
     * 
     */
    private @Nullable List<ServiceLanVpnProfileParcelRouteLeakFromOtherServiceRedistribution> redistributions;
    ...
    private ServiceLanVpnProfileParcelRouteLeakFromOtherService() {}
    /**
     * @return Redistribute Route to specific Protocol on Current Service VPN
     * 
     */
    public List<ServiceLanVpnProfileParcelRouteLeakFromOtherServiceRedistribution> redistributions() {
    ...
    public static Builder builder(ServiceLanVpnProfileParcelRouteLeakFromOtherService defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceVpnVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelRouteLeakFromOtherService defaults) {
        ...
        @CustomType.Setter
        public Builder redistributions(@Nullable List<ServiceLanVpnProfileParcelRouteLeakFromOtherServiceRedistribution> redistributions) {

            this.redistributions = redistributions;
            return this;
        }
        public Builder redistributions(ServiceLanVpnProfileParcelRouteLeakFromOtherServiceRedistribution... redistributions) {
        ...
        public ServiceLanVpnProfileParcelRouteLeakFromOtherService build() {
            final var _resultValue = new ServiceLanVpnProfileParcelRouteLeakFromOtherService();
