...
public final class TransportIpv6TrackerFeatureArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportIpv6TrackerFeatureArgs Empty = new TransportIpv6TrackerFeatureArgs();
    ...
    private TransportIpv6TrackerFeatureArgs() {}

    private TransportIpv6TrackerFeatureArgs(TransportIpv6TrackerFeatureArgs $) {
    ...
    public static Builder builder(TransportIpv6TrackerFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportIpv6TrackerFeatureArgs();
        }

        public Builder(TransportIpv6TrackerFeatureArgs defaults) {
            $ = new TransportIpv6TrackerFeatureArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param icmpInterval Probe Interval, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface-icmp`
         *   - Range: `2`-`1000`
         *   - Default value: `2`
         * 
         * @return builder
        ...
        /**
         * @param icmpIntervalVariable Variable name, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface-icmp`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param interval Probe Interval, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface`
         *   - Range: `20`-`600`
         *   - Default value: `60`
         * 
         * @return builder
        ...
        /**
         * @param intervalVariable Variable name, Attribute conditional on `endpointTrackerType` equal to `ipv6-interface`
         * 
         * @return builder
         * 
         */
        ...
        public TransportIpv6TrackerFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("TransportIpv6TrackerFeatureArgs", "featureProfileId");
            }
            return $;
        }
    }
