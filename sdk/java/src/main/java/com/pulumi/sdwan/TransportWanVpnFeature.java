...
public class TransportWanVpnFeature extends com.pulumi.resources.CustomResource {
     ...
     */
    public TransportWanVpnFeature(java.lang.String name, @Nullable TransportWanVpnFeatureArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TransportWanVpnFeature(java.lang.String name, @Nullable TransportWanVpnFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static TransportWanVpnFeatureArgs makeArgs(@Nullable TransportWanVpnFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
