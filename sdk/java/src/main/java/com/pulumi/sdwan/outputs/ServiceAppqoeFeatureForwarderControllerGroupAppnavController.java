...
@CustomType
public final class ServiceAppqoeFeatureForwarderControllerGroupAppnavController {
    /**
    ...
    public static Builder builder(ServiceAppqoeFeatureForwarderControllerGroupAppnavController defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer vpn;
        public Builder() {}
        public Builder(ServiceAppqoeFeatureForwarderControllerGroupAppnavController defaults) {
        ...
        public ServiceAppqoeFeatureForwarderControllerGroupAppnavController build() {
            final var _resultValue = new ServiceAppqoeFeatureForwarderControllerGroupAppnavController();
