...
@CustomType
public final class ServiceLanVpnFeatureIpv6ImportRouteTarget {
    /**
     * @return Route target
     * 
     */
    ...
    private ServiceLanVpnFeatureIpv6ImportRouteTarget() {}
    /**
     * @return Route target
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv6ImportRouteTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeTargetVariable;
        public Builder() {}
        public Builder(ServiceLanVpnFeatureIpv6ImportRouteTarget defaults) {
        ...
        public ServiceLanVpnFeatureIpv6ImportRouteTarget build() {
            final var _resultValue = new ServiceLanVpnFeatureIpv6ImportRouteTarget();
