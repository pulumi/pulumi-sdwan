...
import com.pulumi.sdwan.inputs.AllowUrlListPolicyObjectState;
import com.pulumi.sdwan.outputs.AllowUrlListPolicyObjectEntry;
 ...
 * 
 */
@ResourceType(type="sdwan:index/allowUrlListPolicyObject:AllowUrlListPolicyObject")
public class AllowUrlListPolicyObject extends com.pulumi.resources.CustomResource {
    /**
     * List of entries
     * 
     */
    @Export(name="entries", refs={List.class,AllowUrlListPolicyObjectEntry.class}, tree="[0,1]")
    private Output<List<AllowUrlListPolicyObjectEntry>> entries;

    /**
     * @return List of entries
     * 
     */
    public Output<List<AllowUrlListPolicyObjectEntry>> entries() {
        return this.entries;
    }
    /**
