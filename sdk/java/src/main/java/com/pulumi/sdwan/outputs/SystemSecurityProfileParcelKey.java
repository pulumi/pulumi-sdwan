...
@CustomType
public final class SystemSecurityProfileParcelKey {
    /**
    ...
    private SystemSecurityProfileParcelKey() {}
    /**
     * @return Configure Accept AO Mismatch
     *   - Default value: `false`
     * 
    ...
    public static Builder builder(SystemSecurityProfileParcelKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer sendLifeTimeStartEpoch;
        public Builder() {}
        public Builder(SystemSecurityProfileParcelKey defaults) {
        ...
        public SystemSecurityProfileParcelKey build() {
            final var _resultValue = new SystemSecurityProfileParcelKey();
