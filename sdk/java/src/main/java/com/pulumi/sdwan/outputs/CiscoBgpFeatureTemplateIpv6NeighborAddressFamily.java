...
import com.pulumi.sdwan.outputs.CiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy;
...
@CustomType
public final class CiscoBgpFeatureTemplateIpv6NeighborAddressFamily {
    /**
     ...
     * 
     */
    private @Nullable List<CiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies;
     ...
     * 
     */
    public List<CiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies() {
    ...
    public static Builder builder(CiscoBgpFeatureTemplateIpv6NeighborAddressFamily defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<CiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies;
        public Builder() {}
        public Builder(CiscoBgpFeatureTemplateIpv6NeighborAddressFamily defaults) {
        ...
        @CustomType.Setter
        public Builder routePolicies(@Nullable List<CiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies) {

            this.routePolicies = routePolicies;
            return this;
        }
        public Builder routePolicies(CiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy... routePolicies) {
            return routePolicies(List.of(routePolicies));
        }
        public CiscoBgpFeatureTemplateIpv6NeighborAddressFamily build() {
            final var _resultValue = new CiscoBgpFeatureTemplateIpv6NeighborAddressFamily();
