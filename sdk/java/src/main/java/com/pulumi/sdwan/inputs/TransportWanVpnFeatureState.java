...
public final class TransportWanVpnFeatureState extends com.pulumi.resources.ResourceArgs {

    public static final TransportWanVpnFeatureState Empty = new TransportWanVpnFeatureState();
    ...
    private TransportWanVpnFeatureState() {}

    private TransportWanVpnFeatureState(TransportWanVpnFeatureState $) {
    ...
    public static Builder builder(TransportWanVpnFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportWanVpnFeatureState();
        }

        public Builder(TransportWanVpnFeatureState defaults) {
            $ = new TransportWanVpnFeatureState(Objects.requireNonNull(defaults));
        }
        ...
        public TransportWanVpnFeatureState build() {
            return $;
        }
    }
