...
public final class ServiceRoutingOspfFeatureArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceRoutingOspfFeatureArgs Empty = new ServiceRoutingOspfFeatureArgs();
     ...
     */
    @Import(name="areas")
    private @Nullable Output<List<ServiceRoutingOspfFeatureAreaArgs>> areas;

    /**
     * @return Configure OSPF area
     * 
     */
    public Optional<Output<List<ServiceRoutingOspfFeatureAreaArgs>>> areas() {
    ...
    private @Nullable Output<List<ServiceRoutingOspfFeatureRedistributeArgs>> redistributes;

    /**
     * @return Redistribute routes
     * 
     */
    public Optional<Output<List<ServiceRoutingOspfFeatureRedistributeArgs>>> redistributes() {
    ...
    private @Nullable Output<List<ServiceRoutingOspfFeatureRouterLsaArgs>> routerLsas;

    /**
     * @return Advertise own router LSA with infinite distance
     * 
     */
    public Optional<Output<List<ServiceRoutingOspfFeatureRouterLsaArgs>>> routerLsas() {
    ...
    private ServiceRoutingOspfFeatureArgs() {}

    private ServiceRoutingOspfFeatureArgs(ServiceRoutingOspfFeatureArgs $) {
        this.areas = $.areas;
    ...
    public static Builder builder(ServiceRoutingOspfFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceRoutingOspfFeatureArgs();
        }

        public Builder(ServiceRoutingOspfFeatureArgs defaults) {
            $ = new ServiceRoutingOspfFeatureArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder areas(@Nullable Output<List<ServiceRoutingOspfFeatureAreaArgs>> areas) {
            $.areas = areas;
            return this;
        }
         ...
         * 
         */
        public Builder areas(List<ServiceRoutingOspfFeatureAreaArgs> areas) {
         ...
         * 
         */
        public Builder areas(ServiceRoutingOspfFeatureAreaArgs... areas) {
         ...
         * 
         */
        public Builder redistributes(@Nullable Output<List<ServiceRoutingOspfFeatureRedistributeArgs>> redistributes) {
         ...
         * 
         */
        public Builder redistributes(List<ServiceRoutingOspfFeatureRedistributeArgs> redistributes) {
         ...
         * 
         */
        public Builder redistributes(ServiceRoutingOspfFeatureRedistributeArgs... redistributes) {
         ...
         * 
         */
        public Builder routerLsas(@Nullable Output<List<ServiceRoutingOspfFeatureRouterLsaArgs>> routerLsas) {
         ...
         * 
         */
        public Builder routerLsas(List<ServiceRoutingOspfFeatureRouterLsaArgs> routerLsas) {
         ...
         * 
         */
        public Builder routerLsas(ServiceRoutingOspfFeatureRouterLsaArgs... routerLsas) {
        ...
        public ServiceRoutingOspfFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("ServiceRoutingOspfFeatureArgs", "featureProfileId");
            }
            return $;
        }
    }
