...
@CustomType
public final class ApplicationPriorityQosPolicyQosScheduler {
    /**
    ...
    public static Builder builder(ApplicationPriorityQosPolicyQosScheduler defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String schedulingType;
        public Builder() {}
        public Builder(ApplicationPriorityQosPolicyQosScheduler defaults) {
        ...
        public ApplicationPriorityQosPolicyQosScheduler build() {
            final var _resultValue = new ApplicationPriorityQosPolicyQosScheduler();
