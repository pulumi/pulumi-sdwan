...
public final class VpnInterfaceSviFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VpnInterfaceSviFeatureTemplateArgs() {}

    private VpnInterfaceSviFeatureTemplateArgs(VpnInterfaceSviFeatureTemplateArgs $) {
    ...
    public static Builder builder(VpnInterfaceSviFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpnInterfaceSviFeatureTemplateArgs();
        }

        public Builder(VpnInterfaceSviFeatureTemplateArgs defaults) {
            $ = new VpnInterfaceSviFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VpnInterfaceSviFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("VpnInterfaceSviFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("VpnInterfaceSviFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
