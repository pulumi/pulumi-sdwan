...
@CustomType
public final class ServiceLanVpnProfileParcelIpv4ExportRouteTarget {
    /**
     * @return Route target
     * 
     */
    ...
    private ServiceLanVpnProfileParcelIpv4ExportRouteTarget() {}
    /**
     * @return Route target
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnProfileParcelIpv4ExportRouteTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeTargetVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelIpv4ExportRouteTarget defaults) {
        ...
        public ServiceLanVpnProfileParcelIpv4ExportRouteTarget build() {
            final var _resultValue = new ServiceLanVpnProfileParcelIpv4ExportRouteTarget();
