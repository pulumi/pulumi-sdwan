...
@CustomType
public final class GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat {
    /**
    ...
    private GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat() {}
    /**
     * @return Direction of static NAT translation
     * 
     */
    ...
    public static Builder builder(GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat defaults) {
    ...
    public static final class Builder {
        ...
        public Builder sourceIp(String sourceIp) {
            if (sourceIp == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat", "sourceIp");
            }
        ...
        public Builder sourceIpVariable(String sourceIpVariable) {
            if (sourceIpVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat", "sourceIpVariable");
            }
        ...
        public Builder sourceVpn(Integer sourceVpn) {
            if (sourceVpn == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat", "sourceVpn");
            }
        ...
        public Builder sourceVpnVariable(String sourceVpnVariable) {
            if (sourceVpnVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat", "sourceVpnVariable");
            }
        ...
        public Builder translatedIp(String translatedIp) {
            if (translatedIp == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat", "translatedIp");
            }
        ...
        public Builder translatedIpVariable(String translatedIpVariable) {
            if (translatedIpVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceEthernetFeatureNewStaticNat", "translatedIpVariable");
            }
