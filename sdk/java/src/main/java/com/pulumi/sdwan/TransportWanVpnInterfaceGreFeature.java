...
import com.pulumi.sdwan.inputs.TransportWanVpnInterfaceGreFeatureState;
 ...
 * 
 */
@ResourceType(type="sdwan:index/transportWanVpnInterfaceGreFeature:TransportWanVpnInterfaceGreFeature")
public class TransportWanVpnInterfaceGreFeature extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="multiplexing", refs={Boolean.class}, tree="[0]")
    private Output</* @Nullable */ Boolean> multiplexing;
     ...
     * 
     */
    public Output<Optional<Boolean>> multiplexing() {
        return Codegen.optional(this.multiplexing);
    }
    /**
     * Variable name
     * 
     */
    @Export(name="multiplexingVariable", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> multiplexingVariable;

    /**
     * @return Variable name
     * 
     */
    public Output<Optional<String>> multiplexingVariable() {
        return Codegen.optional(this.multiplexingVariable);
    }
    /**
     ...
     */
    public TransportWanVpnInterfaceGreFeature(java.lang.String name) {
        this(name, TransportWanVpnInterfaceGreFeatureArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TransportWanVpnInterfaceGreFeature(java.lang.String name, TransportWanVpnInterfaceGreFeatureArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TransportWanVpnInterfaceGreFeature(java.lang.String name, TransportWanVpnInterfaceGreFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/transportWanVpnInterfaceGreFeature:TransportWanVpnInterfaceGreFeature", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TransportWanVpnInterfaceGreFeature(java.lang.String name, Output<java.lang.String> id, @Nullable TransportWanVpnInterfaceGreFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/transportWanVpnInterfaceGreFeature:TransportWanVpnInterfaceGreFeature", name, state, makeResourceOptions(options, id), false);
    }

    private static TransportWanVpnInterfaceGreFeatureArgs makeArgs(TransportWanVpnInterfaceGreFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TransportWanVpnInterfaceGreFeatureArgs.Empty : args;
    }
     ...
     */
    public static TransportWanVpnInterfaceGreFeature get(java.lang.String name, Output<java.lang.String> id, @Nullable TransportWanVpnInterfaceGreFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
