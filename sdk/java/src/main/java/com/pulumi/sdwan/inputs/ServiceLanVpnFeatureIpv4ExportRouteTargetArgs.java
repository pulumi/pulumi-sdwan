...
public final class ServiceLanVpnFeatureIpv4ExportRouteTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceLanVpnFeatureIpv4ExportRouteTargetArgs Empty = new ServiceLanVpnFeatureIpv4ExportRouteTargetArgs();
    ...
    private ServiceLanVpnFeatureIpv4ExportRouteTargetArgs() {}

    private ServiceLanVpnFeatureIpv4ExportRouteTargetArgs(ServiceLanVpnFeatureIpv4ExportRouteTargetArgs $) {
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv4ExportRouteTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceLanVpnFeatureIpv4ExportRouteTargetArgs();
        }

        public Builder(ServiceLanVpnFeatureIpv4ExportRouteTargetArgs defaults) {
            $ = new ServiceLanVpnFeatureIpv4ExportRouteTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceLanVpnFeatureIpv4ExportRouteTargetArgs build() {
            return $;
        }
    }
