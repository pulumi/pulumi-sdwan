...
@CustomType
public final class GetSystemSnmpFeatureUser {
    /**
    ...
    private GetSystemSnmpFeatureUser() {}
    /**
     * @return Specify authentication protocol password
     * 
     */
    ...
    public static Builder builder(GetSystemSnmpFeatureUser defaults) {
    ...
    public static final class Builder {
        ...
        private String privacyProtocolVariable;
        public Builder() {}
        public Builder(GetSystemSnmpFeatureUser defaults) {
        ...
        public Builder authenticationPassword(String authenticationPassword) {
            if (authenticationPassword == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "authenticationPassword");
            }
        ...
        public Builder authenticationPasswordVariable(String authenticationPasswordVariable) {
            if (authenticationPasswordVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "authenticationPasswordVariable");
            }
        ...
        public Builder authenticationProtocol(String authenticationProtocol) {
            if (authenticationProtocol == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "authenticationProtocol");
            }
        ...
        public Builder authenticationProtocolVariable(String authenticationProtocolVariable) {
            if (authenticationProtocolVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "authenticationProtocolVariable");
            }
        ...
        public Builder group(String group) {
            if (group == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "group");
            }
            this.group = group;
            return this;
        }
        ...
        public Builder groupVariable(String groupVariable) {
            if (groupVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "groupVariable");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder privacyPassword(String privacyPassword) {
            if (privacyPassword == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "privacyPassword");
            }
        ...
        public Builder privacyPasswordVariable(String privacyPasswordVariable) {
            if (privacyPasswordVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "privacyPasswordVariable");
            }
        ...
        public Builder privacyProtocol(String privacyProtocol) {
            if (privacyProtocol == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "privacyProtocol");
            }
        ...
        public Builder privacyProtocolVariable(String privacyProtocolVariable) {
            if (privacyProtocolVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemSnmpFeatureUser", "privacyProtocolVariable");
            }
            this.privacyProtocolVariable = privacyProtocolVariable;
            return this;
        }
        public GetSystemSnmpFeatureUser build() {
            final var _resultValue = new GetSystemSnmpFeatureUser();
