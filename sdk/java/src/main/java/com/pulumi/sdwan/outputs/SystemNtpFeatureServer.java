...
public final class SystemNtpFeatureServer {
    ...
    public static Builder builder(SystemNtpFeatureServer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vpnVariable;
        public Builder() {}
        public Builder(SystemNtpFeatureServer defaults) {
        ...
        public SystemNtpFeatureServer build() {
            final var _resultValue = new SystemNtpFeatureServer();
