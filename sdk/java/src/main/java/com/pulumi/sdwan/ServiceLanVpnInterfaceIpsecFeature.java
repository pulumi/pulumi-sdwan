...
import com.pulumi.sdwan.inputs.ServiceLanVpnInterfaceIpsecFeatureState;
 ...
 * 
 */
@ResourceType(type="sdwan:index/serviceLanVpnInterfaceIpsecFeature:ServiceLanVpnInterfaceIpsecFeature")
public class ServiceLanVpnInterfaceIpsecFeature extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ServiceLanVpnInterfaceIpsecFeature(java.lang.String name) {
        this(name, ServiceLanVpnInterfaceIpsecFeatureArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ServiceLanVpnInterfaceIpsecFeature(java.lang.String name, ServiceLanVpnInterfaceIpsecFeatureArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServiceLanVpnInterfaceIpsecFeature(java.lang.String name, ServiceLanVpnInterfaceIpsecFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/serviceLanVpnInterfaceIpsecFeature:ServiceLanVpnInterfaceIpsecFeature", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ServiceLanVpnInterfaceIpsecFeature(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceLanVpnInterfaceIpsecFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/serviceLanVpnInterfaceIpsecFeature:ServiceLanVpnInterfaceIpsecFeature", name, state, makeResourceOptions(options, id), false);
    }

    private static ServiceLanVpnInterfaceIpsecFeatureArgs makeArgs(ServiceLanVpnInterfaceIpsecFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ServiceLanVpnInterfaceIpsecFeatureArgs.Empty : args;
    }
     ...
     */
    public static ServiceLanVpnInterfaceIpsecFeature get(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceLanVpnInterfaceIpsecFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
