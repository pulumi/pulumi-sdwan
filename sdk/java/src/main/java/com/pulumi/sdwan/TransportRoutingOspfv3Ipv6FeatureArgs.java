...
public final class TransportRoutingOspfv3Ipv6FeatureArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportRoutingOspfv3Ipv6FeatureArgs Empty = new TransportRoutingOspfv3Ipv6FeatureArgs();
     ...
     */
    @Import(name="areas")
    private @Nullable Output<List<TransportRoutingOspfv3Ipv6FeatureAreaArgs>> areas;

    /**
     * @return Configure OSPFv3 IPv6 area
     * 
     */
    public Optional<Output<List<TransportRoutingOspfv3Ipv6FeatureAreaArgs>>> areas() {
    ...
    private @Nullable Output<List<TransportRoutingOspfv3Ipv6FeatureRedistributeArgs>> redistributes;

    /**
     * @return Redistribute routes
     * 
     */
    public Optional<Output<List<TransportRoutingOspfv3Ipv6FeatureRedistributeArgs>>> redistributes() {
    ...
    private TransportRoutingOspfv3Ipv6FeatureArgs() {}

    private TransportRoutingOspfv3Ipv6FeatureArgs(TransportRoutingOspfv3Ipv6FeatureArgs $) {
        this.areas = $.areas;
    ...
    public static Builder builder(TransportRoutingOspfv3Ipv6FeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportRoutingOspfv3Ipv6FeatureArgs();
        }

        public Builder(TransportRoutingOspfv3Ipv6FeatureArgs defaults) {
            $ = new TransportRoutingOspfv3Ipv6FeatureArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param areas Configure OSPFv3 IPv6 area
         * 
         * @return builder
         * 
         */
        public Builder areas(@Nullable Output<List<TransportRoutingOspfv3Ipv6FeatureAreaArgs>> areas) {
            $.areas = areas;
            return this;
        }
         ...
         * 
         */
        public Builder areas(List<TransportRoutingOspfv3Ipv6FeatureAreaArgs> areas) {
         ...
         * 
         */
        public Builder areas(TransportRoutingOspfv3Ipv6FeatureAreaArgs... areas) {
        ...
        /**
         * @param distance Distance - Range: `1`-`254` - Default value: `110`
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder redistributes(@Nullable Output<List<TransportRoutingOspfv3Ipv6FeatureRedistributeArgs>> redistributes) {
         ...
         * 
         */
        public Builder redistributes(List<TransportRoutingOspfv3Ipv6FeatureRedistributeArgs> redistributes) {
         ...
         * 
         */
        public Builder redistributes(TransportRoutingOspfv3Ipv6FeatureRedistributeArgs... redistributes) {
        ...
        public TransportRoutingOspfv3Ipv6FeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("TransportRoutingOspfv3Ipv6FeatureArgs", "featureProfileId");
            }
            return $;
        }
    }
