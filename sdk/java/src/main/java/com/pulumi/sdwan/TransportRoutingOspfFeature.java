...
import com.pulumi.sdwan.inputs.TransportRoutingOspfFeatureState;
import com.pulumi.sdwan.outputs.TransportRoutingOspfFeatureArea;
import com.pulumi.sdwan.outputs.TransportRoutingOspfFeatureRedistribute;
import com.pulumi.sdwan.outputs.TransportRoutingOspfFeatureRouterLsa;
 ...
 * 
 */
@ResourceType(type="sdwan:index/transportRoutingOspfFeature:TransportRoutingOspfFeature")
public class TransportRoutingOspfFeature extends com.pulumi.resources.CustomResource {
    /**
     * Configure OSPF area
     * 
     */
    @Export(name="areas", refs={List.class,TransportRoutingOspfFeatureArea.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingOspfFeatureArea>> areas;

    /**
     * @return Configure OSPF area
     * 
     */
    public Output<Optional<List<TransportRoutingOspfFeatureArea>>> areas() {
     ...
     * 
     */
    @Export(name="redistributes", refs={List.class,TransportRoutingOspfFeatureRedistribute.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingOspfFeatureRedistribute>> redistributes;

    /**
     * @return Redistribute routes
     * 
     */
    public Output<Optional<List<TransportRoutingOspfFeatureRedistribute>>> redistributes() {
     ...
     * 
     */
    @Export(name="routerLsas", refs={List.class,TransportRoutingOspfFeatureRouterLsa.class}, tree="[0,1]")
    private Output</* @Nullable */ List<TransportRoutingOspfFeatureRouterLsa>> routerLsas;

    /**
     * @return Advertise own router LSA with infinite distance
     * 
     */
    public Output<Optional<List<TransportRoutingOspfFeatureRouterLsa>>> routerLsas() {
     ...
     */
    public TransportRoutingOspfFeature(java.lang.String name) {
        this(name, TransportRoutingOspfFeatureArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TransportRoutingOspfFeature(java.lang.String name, TransportRoutingOspfFeatureArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TransportRoutingOspfFeature(java.lang.String name, TransportRoutingOspfFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/transportRoutingOspfFeature:TransportRoutingOspfFeature", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TransportRoutingOspfFeature(java.lang.String name, Output<java.lang.String> id, @Nullable TransportRoutingOspfFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/transportRoutingOspfFeature:TransportRoutingOspfFeature", name, state, makeResourceOptions(options, id), false);
    }

    private static TransportRoutingOspfFeatureArgs makeArgs(TransportRoutingOspfFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TransportRoutingOspfFeatureArgs.Empty : args;
    }
     ...
     */
    public static TransportRoutingOspfFeature get(java.lang.String name, Output<java.lang.String> id, @Nullable TransportRoutingOspfFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
