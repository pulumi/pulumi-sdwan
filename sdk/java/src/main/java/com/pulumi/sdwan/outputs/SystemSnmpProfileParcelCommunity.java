...
@CustomType
public final class SystemSnmpProfileParcelCommunity {
    /**
    ...
    private SystemSnmpProfileParcelCommunity() {}
    /**
     * @return Configure access permissions
     *   - Choices: `read-only`, `read-write`
     * 
    ...
    public static Builder builder(SystemSnmpProfileParcelCommunity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String viewVariable;
        public Builder() {}
        public Builder(SystemSnmpProfileParcelCommunity defaults) {
        ...
        public SystemSnmpProfileParcelCommunity build() {
            final var _resultValue = new SystemSnmpProfileParcelCommunity();
