...
@CustomType
public final class GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop build() {
            final var _resultValue = new GetTransportWanVpnProfileParcelIpv6StaticRouteNextHop();
