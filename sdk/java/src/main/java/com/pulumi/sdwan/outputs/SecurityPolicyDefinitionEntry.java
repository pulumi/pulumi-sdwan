...
@CustomType
public final class SecurityPolicyDefinitionEntry {
    /**
    ...
    public static Builder builder(SecurityPolicyDefinitionEntry defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceZone;
        public Builder() {}
        public Builder(SecurityPolicyDefinitionEntry defaults) {
        ...
        public SecurityPolicyDefinitionEntry build() {
            final var _resultValue = new SecurityPolicyDefinitionEntry();
