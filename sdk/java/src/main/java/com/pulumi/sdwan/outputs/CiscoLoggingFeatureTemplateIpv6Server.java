...
@CustomType
public final class CiscoLoggingFeatureTemplateIpv6Server {
    /**
    ...
    public static Builder builder(CiscoLoggingFeatureTemplateIpv6Server defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vpnIdVariable;
        public Builder() {}
        public Builder(CiscoLoggingFeatureTemplateIpv6Server defaults) {
        ...
        public CiscoLoggingFeatureTemplateIpv6Server build() {
            final var _resultValue = new CiscoLoggingFeatureTemplateIpv6Server();
