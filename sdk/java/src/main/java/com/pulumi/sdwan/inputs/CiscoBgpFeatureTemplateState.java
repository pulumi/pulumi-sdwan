...
public final class CiscoBgpFeatureTemplateState extends com.pulumi.resources.ResourceArgs {

    public static final CiscoBgpFeatureTemplateState Empty = new CiscoBgpFeatureTemplateState();
    ...
    private CiscoBgpFeatureTemplateState() {}

    private CiscoBgpFeatureTemplateState(CiscoBgpFeatureTemplateState $) {
    ...
    public static Builder builder(CiscoBgpFeatureTemplateState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoBgpFeatureTemplateState();
        }

        public Builder(CiscoBgpFeatureTemplateState defaults) {
            $ = new CiscoBgpFeatureTemplateState(Objects.requireNonNull(defaults));
        }
        ...
        public CiscoBgpFeatureTemplateState build() {
            return $;
        }
    }
