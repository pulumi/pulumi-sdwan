...
import com.pulumi.sdwan.outputs.TransportRoutingOspfv3Ipv6FeatureAreaInterface;
import com.pulumi.sdwan.outputs.TransportRoutingOspfv3Ipv6FeatureAreaRange;
...
@CustomType
public final class TransportRoutingOspfv3Ipv6FeatureArea {
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingOspfv3Ipv6FeatureAreaInterface> interfaces;
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingOspfv3Ipv6FeatureAreaRange> ranges;

    private TransportRoutingOspfv3Ipv6FeatureArea() {}
    /**
     * @return Always translate type7 LSAs
     * 
     */
     ...
     * 
     */
    public List<TransportRoutingOspfv3Ipv6FeatureAreaInterface> interfaces() {
     ...
     * 
     */
    public List<TransportRoutingOspfv3Ipv6FeatureAreaRange> ranges() {
    ...
    public static Builder builder(TransportRoutingOspfv3Ipv6FeatureArea defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<TransportRoutingOspfv3Ipv6FeatureAreaRange> ranges;
        public Builder() {}
        public Builder(TransportRoutingOspfv3Ipv6FeatureArea defaults) {
        ...
        @CustomType.Setter
        public Builder interfaces(@Nullable List<TransportRoutingOspfv3Ipv6FeatureAreaInterface> interfaces) {

            this.interfaces = interfaces;
            return this;
        }
        public Builder interfaces(TransportRoutingOspfv3Ipv6FeatureAreaInterface... interfaces) {
        ...
        @CustomType.Setter
        public Builder ranges(@Nullable List<TransportRoutingOspfv3Ipv6FeatureAreaRange> ranges) {

            this.ranges = ranges;
            return this;
        }
        public Builder ranges(TransportRoutingOspfv3Ipv6FeatureAreaRange... ranges) {
            return ranges(List.of(ranges));
        }
        public TransportRoutingOspfv3Ipv6FeatureArea build() {
            final var _resultValue = new TransportRoutingOspfv3Ipv6FeatureArea();
