...
public final class SystemLoggingFeatureState extends com.pulumi.resources.ResourceArgs {

    public static final SystemLoggingFeatureState Empty = new SystemLoggingFeatureState();
    ...
    private @Nullable Output<List<SystemLoggingFeatureIpv4ServerArgs>> ipv4Servers;

    /**
     * @return Enable logging to remote server
     * 
     */
    public Optional<Output<List<SystemLoggingFeatureIpv4ServerArgs>>> ipv4Servers() {
    ...
    private @Nullable Output<List<SystemLoggingFeatureIpv6ServerArgs>> ipv6Servers;

    /**
     * @return Enable logging to remote ipv6 server
     * 
     */
    public Optional<Output<List<SystemLoggingFeatureIpv6ServerArgs>>> ipv6Servers() {
    ...
    private @Nullable Output<List<SystemLoggingFeatureTlsProfileArgs>> tlsProfiles;

    /**
     * @return Configure a TLS profile
     * 
     */
    public Optional<Output<List<SystemLoggingFeatureTlsProfileArgs>>> tlsProfiles() {
    ...
    private SystemLoggingFeatureState() {}

    private SystemLoggingFeatureState(SystemLoggingFeatureState $) {
    ...
    public static Builder builder(SystemLoggingFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemLoggingFeatureState();
        }

        public Builder(SystemLoggingFeatureState defaults) {
            $ = new SystemLoggingFeatureState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder ipv4Servers(@Nullable Output<List<SystemLoggingFeatureIpv4ServerArgs>> ipv4Servers) {
         ...
         * 
         */
        public Builder ipv4Servers(List<SystemLoggingFeatureIpv4ServerArgs> ipv4Servers) {
         ...
         * 
         */
        public Builder ipv4Servers(SystemLoggingFeatureIpv4ServerArgs... ipv4Servers) {
         ...
         * 
         */
        public Builder ipv6Servers(@Nullable Output<List<SystemLoggingFeatureIpv6ServerArgs>> ipv6Servers) {
         ...
         * 
         */
        public Builder ipv6Servers(List<SystemLoggingFeatureIpv6ServerArgs> ipv6Servers) {
         ...
         * 
         */
        public Builder ipv6Servers(SystemLoggingFeatureIpv6ServerArgs... ipv6Servers) {
         ...
         * 
         */
        public Builder tlsProfiles(@Nullable Output<List<SystemLoggingFeatureTlsProfileArgs>> tlsProfiles) {
         ...
         * 
         */
        public Builder tlsProfiles(List<SystemLoggingFeatureTlsProfileArgs> tlsProfiles) {
         ...
         * 
         */
        public Builder tlsProfiles(SystemLoggingFeatureTlsProfileArgs... tlsProfiles) {
        ...
        public SystemLoggingFeatureState build() {
            return $;
        }
    }
