...
@CustomType
public final class GetServiceLanVpnFeatureGreRoute {
    /**
    ...
    private GetServiceLanVpnFeatureGreRoute() {}
    /**
     * @return Variable name
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnFeatureGreRoute defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vpn;
        public Builder() {}
        public Builder(GetServiceLanVpnFeatureGreRoute defaults) {
        ...
        public Builder interfaceVariable(String interfaceVariable) {
            if (interfaceVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureGreRoute", "interfaceVariable");
            }
        ...
        public Builder interfaces(List<String> interfaces) {
            if (interfaces == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureGreRoute", "interfaces");
            }
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureGreRoute", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureGreRoute", "networkAddressVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureGreRoute", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureGreRoute", "subnetMaskVariable");
            }
        ...
        public Builder vpn(Integer vpn) {
            if (vpn == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureGreRoute", "vpn");
            }
            this.vpn = vpn;
            return this;
        }
        public GetServiceLanVpnFeatureGreRoute build() {
            final var _resultValue = new GetServiceLanVpnFeatureGreRoute();
