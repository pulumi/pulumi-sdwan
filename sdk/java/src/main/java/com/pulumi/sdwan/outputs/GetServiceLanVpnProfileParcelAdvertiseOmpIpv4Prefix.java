...
@CustomType
public final class GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix {
    /**
    ...
    private GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix() {}
    /**
     * @return Aggregate Only
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetMaskVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix defaults) {
        ...
        public Builder aggregateOnly(Boolean aggregateOnly) {
            if (aggregateOnly == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix", "aggregateOnly");
            }
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix", "networkAddressVariable");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix", "region");
            }
            this.region = region;
            return this;
        }
        ...
        public Builder regionVariable(String regionVariable) {
            if (regionVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix", "regionVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix", "subnetMaskVariable");
            }
            this.subnetMaskVariable = subnetMaskVariable;
            return this;
        }
        public GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelAdvertiseOmpIpv4Prefix();
