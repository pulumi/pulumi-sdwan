...
@CustomType
public final class GetServiceLanVpnProfileParcelStaticNat {
    /**
    ...
    private GetServiceLanVpnProfileParcelStaticNat() {}
    /**
     * @return NAT Pool Name
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelStaticNat defaults) {
    ...
    public static final class Builder {
        ...
        private String translatedSourceIpVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelStaticNat defaults) {
        ...
        public Builder natPoolName(Integer natPoolName) {
            if (natPoolName == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "natPoolName");
            }
        ...
        public Builder natPoolNameVariable(String natPoolNameVariable) {
            if (natPoolNameVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "natPoolNameVariable");
            }
        ...
        public Builder sourceIp(String sourceIp) {
            if (sourceIp == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "sourceIp");
            }
        ...
        public Builder sourceIpVariable(String sourceIpVariable) {
            if (sourceIpVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "sourceIpVariable");
            }
        ...
        public Builder staticNatDirection(String staticNatDirection) {
            if (staticNatDirection == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "staticNatDirection");
            }
        ...
        public Builder staticNatDirectionVariable(String staticNatDirectionVariable) {
            if (staticNatDirectionVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "staticNatDirectionVariable");
            }
        ...
        public Builder trackerObjectId(String trackerObjectId) {
            if (trackerObjectId == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "trackerObjectId");
            }
        ...
        public Builder translatedSourceIp(String translatedSourceIp) {
            if (translatedSourceIp == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "translatedSourceIp");
            }
        ...
        public Builder translatedSourceIpVariable(String translatedSourceIpVariable) {
            if (translatedSourceIpVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelStaticNat", "translatedSourceIpVariable");
            }
            this.translatedSourceIpVariable = translatedSourceIpVariable;
            return this;
        }
        public GetServiceLanVpnProfileParcelStaticNat build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelStaticNat();
