...
public final class GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs Empty = new GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs();
    ...
    private GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs() {}

    private GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs(GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs $) {
    ...
    public static Builder builder(GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs();
        }

        public Builder(GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs defaults) {
            $ = new GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "featureProfileId");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "id");
            }
            if ($.serviceLanVpnFeatureId == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "serviceLanVpnFeatureId");
            }
            if ($.serviceLanVpnInterfaceEthernetFeatureId == null) {
                throw new MissingRequiredPropertyException("GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureArgs", "serviceLanVpnInterfaceEthernetFeatureId");
            }
            return $;
        }
    }
