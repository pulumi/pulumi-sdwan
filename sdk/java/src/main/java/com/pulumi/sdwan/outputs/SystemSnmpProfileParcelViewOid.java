...
@CustomType
public final class SystemSnmpProfileParcelViewOid {
    /**
    ...
    private SystemSnmpProfileParcelViewOid() {}
    /**
     * @return Exclude the OID
     *   - Default value: `false`
     * 
    ...
    public static Builder builder(SystemSnmpProfileParcelViewOid defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String idVariable;
        public Builder() {}
        public Builder(SystemSnmpProfileParcelViewOid defaults) {
        ...
        public SystemSnmpProfileParcelViewOid build() {
            final var _resultValue = new SystemSnmpProfileParcelViewOid();
