...
@CustomType
public final class GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward {
    /**
    ...
    private GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward() {}
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    ...
    public static Builder builder(GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward defaults) {
    ...
    public static final class Builder {
        ...
        private String protocol;
        public Builder() {}
        public Builder(GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward defaults) {
        ...
        public Builder optional(Boolean optional) {
            if (optional == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "optional");
            }
        ...
        public Builder portEndRange(Integer portEndRange) {
            if (portEndRange == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "portEndRange");
            }
        ...
        public Builder portStartRange(Integer portStartRange) {
            if (portStartRange == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "portStartRange");
            }
        ...
        public Builder privateIpAddress(String privateIpAddress) {
            if (privateIpAddress == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "privateIpAddress");
            }
        ...
        public Builder privateIpAddressVariable(String privateIpAddressVariable) {
            if (privateIpAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "privateIpAddressVariable");
            }
        ...
        public Builder privateVpn(Integer privateVpn) {
            if (privateVpn == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "privateVpn");
            }
        ...
        public Builder privateVpnVariable(String privateVpnVariable) {
            if (privateVpnVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "privateVpnVariable");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward", "protocol");
            }
            this.protocol = protocol;
            return this;
        }
        public GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward build() {
            final var _resultValue = new GetVpnInterfaceDslIpoeFeatureTemplateNatPortForward();
