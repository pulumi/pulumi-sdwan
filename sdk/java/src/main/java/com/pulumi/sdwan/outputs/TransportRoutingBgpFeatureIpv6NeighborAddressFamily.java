...
public final class TransportRoutingBgpFeatureIpv6NeighborAddressFamily {
    ...
    public static Builder builder(TransportRoutingBgpFeatureIpv6NeighborAddressFamily defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String warningMessageThresholdVariable;
        public Builder() {}
        public Builder(TransportRoutingBgpFeatureIpv6NeighborAddressFamily defaults) {
        ...
        public TransportRoutingBgpFeatureIpv6NeighborAddressFamily build() {
            final var _resultValue = new TransportRoutingBgpFeatureIpv6NeighborAddressFamily();
