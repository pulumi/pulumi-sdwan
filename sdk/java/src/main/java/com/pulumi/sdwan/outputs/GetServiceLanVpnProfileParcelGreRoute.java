...
@CustomType
public final class GetServiceLanVpnProfileParcelGreRoute {
    /**
    ...
    private GetServiceLanVpnProfileParcelGreRoute() {}
    /**
     * @return Variable name
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelGreRoute defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vpn;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelGreRoute defaults) {
        ...
        public Builder interfaceVariable(String interfaceVariable) {
            if (interfaceVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelGreRoute", "interfaceVariable");
            }
        ...
        public Builder interfaces(List<String> interfaces) {
            if (interfaces == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelGreRoute", "interfaces");
            }
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelGreRoute", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelGreRoute", "networkAddressVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelGreRoute", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelGreRoute", "subnetMaskVariable");
            }
        ...
        public Builder vpn(Integer vpn) {
            if (vpn == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelGreRoute", "vpn");
            }
            this.vpn = vpn;
            return this;
        }
        public GetServiceLanVpnProfileParcelGreRoute build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelGreRoute();
