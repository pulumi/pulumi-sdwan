...
@CustomType
public final class ServiceLanVpnInterfaceEthernetFeatureIpv6VrrpIpv6Address {
    /**
    ...
    public static Builder builder(ServiceLanVpnInterfaceEthernetFeatureIpv6VrrpIpv6Address defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String linkLocalAddressVariable;
        public Builder() {}
        public Builder(ServiceLanVpnInterfaceEthernetFeatureIpv6VrrpIpv6Address defaults) {
        ...
        public ServiceLanVpnInterfaceEthernetFeatureIpv6VrrpIpv6Address build() {
            final var _resultValue = new ServiceLanVpnInterfaceEthernetFeatureIpv6VrrpIpv6Address();
