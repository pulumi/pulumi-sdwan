...
@CustomType
public final class GetTransportManagementVpnFeatureIpv4StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private GetTransportManagementVpnFeatureIpv4StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetTransportManagementVpnFeatureIpv4StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetTransportManagementVpnFeatureIpv4StaticRouteNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv4StaticRouteNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv4StaticRouteNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv4StaticRouteNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportManagementVpnFeatureIpv4StaticRouteNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetTransportManagementVpnFeatureIpv4StaticRouteNextHop build() {
            final var _resultValue = new GetTransportManagementVpnFeatureIpv4StaticRouteNextHop();
