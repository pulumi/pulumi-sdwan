...
@CustomType
public final class ServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop {
    /**
     * @return IPv6 Address
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(ServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop defaults) {
        ...
        public ServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop build() {
            final var _resultValue = new ServiceLanVpnFeatureIpv6StaticRouteIpv6StaticRouteInterfaceNextHop();
