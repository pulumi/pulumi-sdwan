...
@CustomType
public final class TransportRoutingBgpProfileParcelIpv6Redistribute {
    /**
    ...
    private TransportRoutingBgpProfileParcelIpv6Redistribute() {}
    /**
     * @return Set the protocol to redistribute routes from
     *   - Choices: `static`, `connected`, `ospf`
     * 
    ...
    public static Builder builder(TransportRoutingBgpProfileParcelIpv6Redistribute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routePolicyId;
        public Builder() {}
        public Builder(TransportRoutingBgpProfileParcelIpv6Redistribute defaults) {
        ...
        public TransportRoutingBgpProfileParcelIpv6Redistribute build() {
            final var _resultValue = new TransportRoutingBgpProfileParcelIpv6Redistribute();
