...
public class SwitchportFeatureTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public SwitchportFeatureTemplate(String name) {
     ...
     */
    public SwitchportFeatureTemplate(String name, SwitchportFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/switchportFeatureTemplate:SwitchportFeatureTemplate", name, args == null ? SwitchportFeatureTemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SwitchportFeatureTemplate(String name, Output<String> id, @Nullable SwitchportFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/switchportFeatureTemplate:SwitchportFeatureTemplate", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static SwitchportFeatureTemplate get(String name, Output<String> id, @Nullable SwitchportFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
