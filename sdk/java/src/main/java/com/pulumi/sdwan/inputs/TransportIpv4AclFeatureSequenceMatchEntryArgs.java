...
import com.pulumi.sdwan.inputs.TransportIpv4AclFeatureSequenceMatchEntryDestinationPortArgs;
import com.pulumi.sdwan.inputs.TransportIpv4AclFeatureSequenceMatchEntrySourcePortArgs;
...
public final class TransportIpv4AclFeatureSequenceMatchEntryArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportIpv4AclFeatureSequenceMatchEntryArgs Empty = new TransportIpv4AclFeatureSequenceMatchEntryArgs();
    ...
    private @Nullable Output<List<TransportIpv4AclFeatureSequenceMatchEntryDestinationPortArgs>> destinationPorts;

    /**
     * @return Destination Port List
     * 
     */
    public Optional<Output<List<TransportIpv4AclFeatureSequenceMatchEntryDestinationPortArgs>>> destinationPorts() {
    ...
    private @Nullable Output<List<TransportIpv4AclFeatureSequenceMatchEntrySourcePortArgs>> sourcePorts;

    /**
     * @return Source Port List
     * 
     */
    public Optional<Output<List<TransportIpv4AclFeatureSequenceMatchEntrySourcePortArgs>>> sourcePorts() {
    ...
    private TransportIpv4AclFeatureSequenceMatchEntryArgs() {}

    private TransportIpv4AclFeatureSequenceMatchEntryArgs(TransportIpv4AclFeatureSequenceMatchEntryArgs $) {
    ...
    public static Builder builder(TransportIpv4AclFeatureSequenceMatchEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportIpv4AclFeatureSequenceMatchEntryArgs();
        }

        public Builder(TransportIpv4AclFeatureSequenceMatchEntryArgs defaults) {
            $ = new TransportIpv4AclFeatureSequenceMatchEntryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder destinationPorts(@Nullable Output<List<TransportIpv4AclFeatureSequenceMatchEntryDestinationPortArgs>> destinationPorts) {
         ...
         * 
         */
        public Builder destinationPorts(List<TransportIpv4AclFeatureSequenceMatchEntryDestinationPortArgs> destinationPorts) {
         ...
         * 
         */
        public Builder destinationPorts(TransportIpv4AclFeatureSequenceMatchEntryDestinationPortArgs... destinationPorts) {
         ...
         * 
         */
        public Builder sourcePorts(@Nullable Output<List<TransportIpv4AclFeatureSequenceMatchEntrySourcePortArgs>> sourcePorts) {
         ...
         * 
         */
        public Builder sourcePorts(List<TransportIpv4AclFeatureSequenceMatchEntrySourcePortArgs> sourcePorts) {
         ...
         * 
         */
        public Builder sourcePorts(TransportIpv4AclFeatureSequenceMatchEntrySourcePortArgs... sourcePorts) {
        ...
        public TransportIpv4AclFeatureSequenceMatchEntryArgs build() {
            return $;
        }
    }
