...
@CustomType
public final class GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelIpv6StaticRouteNextHop();
