...
import com.pulumi.sdwan.inputs.VpnInterfaceDslPppoaFeatureTemplateState;
import com.pulumi.sdwan.outputs.VpnInterfaceDslPppoaFeatureTemplateAccessList;
import com.pulumi.sdwan.outputs.VpnInterfaceDslPppoaFeatureTemplateNatPortForward;
import com.pulumi.sdwan.outputs.VpnInterfaceDslPppoaFeatureTemplatePolicer;
import com.pulumi.sdwan.outputs.VpnInterfaceDslPppoaFeatureTemplatePvc;
import com.pulumi.sdwan.outputs.VpnInterfaceDslPppoaFeatureTemplateTunnelInterfaceEncapsulation;
import com.pulumi.sdwan.outputs.VpnInterfaceDslPppoaFeatureTemplateVdslConfiguration;
 ...
 * 
 */
@ResourceType(type="sdwan:index/vpnInterfaceDslPppoaFeatureTemplate:VpnInterfaceDslPppoaFeatureTemplate")
public class VpnInterfaceDslPppoaFeatureTemplate extends com.pulumi.resources.CustomResource {
    /**
     * Apply ACL
     * 
     */
    @Export(name="accessLists", refs={List.class,VpnInterfaceDslPppoaFeatureTemplateAccessList.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceDslPppoaFeatureTemplateAccessList>> accessLists;

    /**
     * @return Apply ACL
     * 
     */
    public Output<Optional<List<VpnInterfaceDslPppoaFeatureTemplateAccessList>>> accessLists() {
     ...
     * 
     */
    @Export(name="atmDescription", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> atmDescription;

    /**
     * @return Interface description
     * 
     */
    public Output<Optional<String>> atmDescription() {
        return Codegen.optional(this.atmDescription);
    }
    /**
     * Variable name
     * 
     */
    @Export(name="atmDescriptionVariable", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> atmDescriptionVariable;

    /**
     * @return Variable name
     * 
     */
    public Output<Optional<String>> atmDescriptionVariable() {
        return Codegen.optional(this.atmDescriptionVariable);
    }
    /**
     * ATM Sub interface Name
     * 
     */
    @Export(name="atmSubInterfaceName", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> atmSubInterfaceName;

    /**
     * @return ATM Sub interface Name
     * 
     */
    public Output<Optional<String>> atmSubInterfaceName() {
        return Codegen.optional(this.atmSubInterfaceName);
    }
    /**
     * Variable name
     * 
     */
    @Export(name="atmSubInterfaceNameVariable", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> atmSubInterfaceNameVariable;

    /**
     * @return Variable name
     * 
     */
    public Output<Optional<String>> atmSubInterfaceNameVariable() {
        return Codegen.optional(this.atmSubInterfaceNameVariable);
    }
    /**
     ...
     * 
     */
    @Export(name="natPortForwards", refs={List.class,VpnInterfaceDslPppoaFeatureTemplateNatPortForward.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceDslPppoaFeatureTemplateNatPortForward>> natPortForwards;

    /**
     * @return Set port-forwarding rules for NAT on this interface
     * 
     */
    public Output<Optional<List<VpnInterfaceDslPppoaFeatureTemplateNatPortForward>>> natPortForwards() {
     ...
     * 
     */
    @Export(name="policers", refs={List.class,VpnInterfaceDslPppoaFeatureTemplatePolicer.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceDslPppoaFeatureTemplatePolicer>> policers;

    /**
     * @return Enable policer
     * 
     */
    public Output<Optional<List<VpnInterfaceDslPppoaFeatureTemplatePolicer>>> policers() {
     ...
     * 
     */
    @Export(name="pvcs", refs={List.class,VpnInterfaceDslPppoaFeatureTemplatePvc.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceDslPppoaFeatureTemplatePvc>> pvcs;

    /**
     * @return pvc
     * 
     */
    public Output<Optional<List<VpnInterfaceDslPppoaFeatureTemplatePvc>>> pvcs() {
        return Codegen.optional(this.pvcs);
    }
    /**
     ...
     * 
     */
    @Export(name="tunnelInterfaceEncapsulations", refs={List.class,VpnInterfaceDslPppoaFeatureTemplateTunnelInterfaceEncapsulation.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceDslPppoaFeatureTemplateTunnelInterfaceEncapsulation>> tunnelInterfaceEncapsulations;

    /**
     * @return Encapsulation for TLOC
     * 
     */
    public Output<Optional<List<VpnInterfaceDslPppoaFeatureTemplateTunnelInterfaceEncapsulation>>> tunnelInterfaceEncapsulations() {
     ...
     * 
     */
    @Export(name="vdslConfigurations", refs={List.class,VpnInterfaceDslPppoaFeatureTemplateVdslConfiguration.class}, tree="[0,1]")
    private Output</* @Nullable */ List<VpnInterfaceDslPppoaFeatureTemplateVdslConfiguration>> vdslConfigurations;

    /**
     * @return vdsl
     * 
     */
    public Output<Optional<List<VpnInterfaceDslPppoaFeatureTemplateVdslConfiguration>>> vdslConfigurations() {
     ...
     */
    public VpnInterfaceDslPppoaFeatureTemplate(java.lang.String name) {
        this(name, VpnInterfaceDslPppoaFeatureTemplateArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VpnInterfaceDslPppoaFeatureTemplate(java.lang.String name, VpnInterfaceDslPppoaFeatureTemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VpnInterfaceDslPppoaFeatureTemplate(java.lang.String name, VpnInterfaceDslPppoaFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/vpnInterfaceDslPppoaFeatureTemplate:VpnInterfaceDslPppoaFeatureTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VpnInterfaceDslPppoaFeatureTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable VpnInterfaceDslPppoaFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/vpnInterfaceDslPppoaFeatureTemplate:VpnInterfaceDslPppoaFeatureTemplate", name, state, makeResourceOptions(options, id), false);
    }

    private static VpnInterfaceDslPppoaFeatureTemplateArgs makeArgs(VpnInterfaceDslPppoaFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VpnInterfaceDslPppoaFeatureTemplateArgs.Empty : args;
    }
     ...
     */
    public static VpnInterfaceDslPppoaFeatureTemplate get(java.lang.String name, Output<java.lang.String> id, @Nullable VpnInterfaceDslPppoaFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
