...
import com.pulumi.sdwan.inputs.ExtendedCommunityListPolicyObjectState;
import com.pulumi.sdwan.outputs.ExtendedCommunityListPolicyObjectEntry;
 ...
 * 
 */
@ResourceType(type="sdwan:index/extendedCommunityListPolicyObject:ExtendedCommunityListPolicyObject")
public class ExtendedCommunityListPolicyObject extends com.pulumi.resources.CustomResource {
    /**
     * List of entries
     * 
     */
    @Export(name="entries", refs={List.class,ExtendedCommunityListPolicyObjectEntry.class}, tree="[0,1]")
    private Output<List<ExtendedCommunityListPolicyObjectEntry>> entries;

    /**
     * @return List of entries
     * 
     */
    public Output<List<ExtendedCommunityListPolicyObjectEntry>> entries() {
        return this.entries;
    }
    /**
