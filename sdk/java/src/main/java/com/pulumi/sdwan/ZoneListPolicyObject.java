...
import com.pulumi.sdwan.inputs.ZoneListPolicyObjectState;
import com.pulumi.sdwan.outputs.ZoneListPolicyObjectEntry;
 ...
 * 
 */
@ResourceType(type="sdwan:index/zoneListPolicyObject:ZoneListPolicyObject")
public class ZoneListPolicyObject extends com.pulumi.resources.CustomResource {
    /**
     * List of entries
     * 
     */
    @Export(name="entries", refs={List.class,ZoneListPolicyObjectEntry.class}, tree="[0,1]")
    private Output<List<ZoneListPolicyObjectEntry>> entries;

    /**
     * @return List of entries
     * 
     */
    public Output<List<ZoneListPolicyObjectEntry>> entries() {
        return this.entries;
    }
    /**
