...
public final class CiscoVpnFeatureTemplateState extends com.pulumi.resources.ResourceArgs {

    public static final CiscoVpnFeatureTemplateState Empty = new CiscoVpnFeatureTemplateState();
    ...
    private CiscoVpnFeatureTemplateState() {}

    private CiscoVpnFeatureTemplateState(CiscoVpnFeatureTemplateState $) {
    ...
    public static Builder builder(CiscoVpnFeatureTemplateState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoVpnFeatureTemplateState();
        }

        public Builder(CiscoVpnFeatureTemplateState defaults) {
            $ = new CiscoVpnFeatureTemplateState(Objects.requireNonNull(defaults));
        }
        ...
        public CiscoVpnFeatureTemplateState build() {
            return $;
        }
    }
