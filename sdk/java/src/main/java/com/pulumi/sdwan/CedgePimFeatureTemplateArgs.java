...
public final class CedgePimFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CedgePimFeatureTemplateArgs() {}

    private CedgePimFeatureTemplateArgs(CedgePimFeatureTemplateArgs $) {
        this.autoRp = $.autoRp;
    ...
    public static Builder builder(CedgePimFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CedgePimFeatureTemplateArgs();
        }

        public Builder(CedgePimFeatureTemplateArgs defaults) {
            $ = new CedgePimFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CedgePimFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("CedgePimFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("CedgePimFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
