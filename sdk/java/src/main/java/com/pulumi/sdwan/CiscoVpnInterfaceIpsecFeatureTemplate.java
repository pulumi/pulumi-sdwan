...
public class CiscoVpnInterfaceIpsecFeatureTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public CiscoVpnInterfaceIpsecFeatureTemplate(String name) {
     ...
     */
    public CiscoVpnInterfaceIpsecFeatureTemplate(String name, CiscoVpnInterfaceIpsecFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/ciscoVpnInterfaceIpsecFeatureTemplate:CiscoVpnInterfaceIpsecFeatureTemplate", name, args == null ? CiscoVpnInterfaceIpsecFeatureTemplateArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private CiscoVpnInterfaceIpsecFeatureTemplate(String name, Output<String> id, @Nullable CiscoVpnInterfaceIpsecFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/ciscoVpnInterfaceIpsecFeatureTemplate:CiscoVpnInterfaceIpsecFeatureTemplate", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static CiscoVpnInterfaceIpsecFeatureTemplate get(String name, Output<String> id, @Nullable CiscoVpnInterfaceIpsecFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
