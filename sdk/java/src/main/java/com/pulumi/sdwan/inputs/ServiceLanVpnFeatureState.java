...
public final class ServiceLanVpnFeatureState extends com.pulumi.resources.ResourceArgs {

    public static final ServiceLanVpnFeatureState Empty = new ServiceLanVpnFeatureState();
    ...
    private ServiceLanVpnFeatureState() {}

    private ServiceLanVpnFeatureState(ServiceLanVpnFeatureState $) {
    ...
    public static Builder builder(ServiceLanVpnFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceLanVpnFeatureState();
        }

        public Builder(ServiceLanVpnFeatureState defaults) {
            $ = new ServiceLanVpnFeatureState(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceLanVpnFeatureState build() {
            return $;
        }
    }
