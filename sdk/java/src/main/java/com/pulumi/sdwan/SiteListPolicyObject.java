...
public class SiteListPolicyObject extends com.pulumi.resources.CustomResource {
     ...
     */
    public SiteListPolicyObject(String name) {
     ...
     */
    public SiteListPolicyObject(String name, SiteListPolicyObjectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/siteListPolicyObject:SiteListPolicyObject", name, args == null ? SiteListPolicyObjectArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SiteListPolicyObject(String name, Output<String> id, @Nullable SiteListPolicyObjectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/siteListPolicyObject:SiteListPolicyObject", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static SiteListPolicyObject get(String name, Output<String> id, @Nullable SiteListPolicyObjectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
