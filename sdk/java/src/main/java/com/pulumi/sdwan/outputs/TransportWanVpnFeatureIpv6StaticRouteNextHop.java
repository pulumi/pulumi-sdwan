...
@CustomType
public final class TransportWanVpnFeatureIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private TransportWanVpnFeatureIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(TransportWanVpnFeatureIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(TransportWanVpnFeatureIpv6StaticRouteNextHop defaults) {
        ...
        public TransportWanVpnFeatureIpv6StaticRouteNextHop build() {
            final var _resultValue = new TransportWanVpnFeatureIpv6StaticRouteNextHop();
