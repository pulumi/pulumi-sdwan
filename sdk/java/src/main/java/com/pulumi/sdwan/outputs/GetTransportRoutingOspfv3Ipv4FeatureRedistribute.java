    ...
    public static final class Builder {
        ...
        public Builder translateRibMetric(Boolean translateRibMetric) {
            if (translateRibMetric == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingOspfv3Ipv4FeatureRedistribute", "translateRibMetric");
            }
        ...
        public Builder translateRibMetricVariable(String translateRibMetricVariable) {
            if (translateRibMetricVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingOspfv3Ipv4FeatureRedistribute", "translateRibMetricVariable");
            }
