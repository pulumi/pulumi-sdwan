...
@CustomType
public final class GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily {
    /**
    ...
    private GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily() {}
    /**
     * @return Set IPv4 unicast address family
     * 
     */
    ...
    public static Builder builder(GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily defaults) {
    ...
    public static final class Builder {
        ...
        private String thresholdVariable;
        public Builder() {}
        public Builder(GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily defaults) {
        ...
        public Builder familyType(String familyType) {
            if (familyType == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "familyType");
            }
        ...
        public Builder inRoutePolicyId(String inRoutePolicyId) {
            if (inRoutePolicyId == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "inRoutePolicyId");
            }
        ...
        public Builder maxNumberOfPrefixes(Integer maxNumberOfPrefixes) {
            if (maxNumberOfPrefixes == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "maxNumberOfPrefixes");
            }
        ...
        public Builder maxNumberOfPrefixesVariable(String maxNumberOfPrefixesVariable) {
            if (maxNumberOfPrefixesVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "maxNumberOfPrefixesVariable");
            }
        ...
        public Builder outRoutePolicyId(String outRoutePolicyId) {
            if (outRoutePolicyId == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "outRoutePolicyId");
            }
        ...
        public Builder policyType(String policyType) {
            if (policyType == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "policyType");
            }
        ...
        public Builder restartInterval(Integer restartInterval) {
            if (restartInterval == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "restartInterval");
            }
        ...
        public Builder restartIntervalVariable(String restartIntervalVariable) {
            if (restartIntervalVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "restartIntervalVariable");
            }
        ...
        public Builder threshold(Integer threshold) {
            if (threshold == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "threshold");
            }
        ...
        public Builder thresholdVariable(String thresholdVariable) {
            if (thresholdVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily", "thresholdVariable");
            }
            this.thresholdVariable = thresholdVariable;
            return this;
        }
        public GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily build() {
            final var _resultValue = new GetTransportRoutingBgpProfileParcelIpv4NeighborAddressFamily();
