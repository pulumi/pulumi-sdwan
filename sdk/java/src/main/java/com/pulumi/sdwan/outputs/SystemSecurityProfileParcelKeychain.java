...
@CustomType
public final class SystemSecurityProfileParcelKeychain {
    /**
    ...
    public static Builder builder(SystemSecurityProfileParcelKeychain defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer keyId;
        public Builder() {}
        public Builder(SystemSecurityProfileParcelKeychain defaults) {
        ...
        public SystemSecurityProfileParcelKeychain build() {
            final var _resultValue = new SystemSecurityProfileParcelKeychain();
