...
@CustomType
public final class TransportWanVpnInterfaceCellularFeatureArp {
    /**
    ...
    public static Builder builder(TransportWanVpnInterfaceCellularFeatureArp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String macAddressVariable;
        public Builder() {}
        public Builder(TransportWanVpnInterfaceCellularFeatureArp defaults) {
        ...
        public TransportWanVpnInterfaceCellularFeatureArp build() {
            final var _resultValue = new TransportWanVpnInterfaceCellularFeatureArp();
