...
public final class HubAndSpokeTopologyPolicyDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final HubAndSpokeTopologyPolicyDefinitionArgs Empty = new HubAndSpokeTopologyPolicyDefinitionArgs();
    ...
    private Output<List<HubAndSpokeTopologyPolicyDefinitionTopologyArgs>> topologies;

    /**
     * @return List of topologies
     * 
     */
    public Output<List<HubAndSpokeTopologyPolicyDefinitionTopologyArgs>> topologies() {
    ...
    private HubAndSpokeTopologyPolicyDefinitionArgs() {}

    private HubAndSpokeTopologyPolicyDefinitionArgs(HubAndSpokeTopologyPolicyDefinitionArgs $) {
    ...
    public static Builder builder(HubAndSpokeTopologyPolicyDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HubAndSpokeTopologyPolicyDefinitionArgs();
        }

        public Builder(HubAndSpokeTopologyPolicyDefinitionArgs defaults) {
            $ = new HubAndSpokeTopologyPolicyDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder topologies(Output<List<HubAndSpokeTopologyPolicyDefinitionTopologyArgs>> topologies) {
        ...
        public HubAndSpokeTopologyPolicyDefinitionArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("HubAndSpokeTopologyPolicyDefinitionArgs", "description");
            }
            if ($.topologies == null) {
                throw new MissingRequiredPropertyException("HubAndSpokeTopologyPolicyDefinitionArgs", "topologies");
            }
            return $;
        }
    }
