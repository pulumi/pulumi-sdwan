...
public final class LocalApplicationListPolicyObjectEntryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LocalApplicationListPolicyObjectEntryArgs Empty = new LocalApplicationListPolicyObjectEntryArgs();
    ...
    public static Builder builder(LocalApplicationListPolicyObjectEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalApplicationListPolicyObjectEntryArgs();
        }

        public Builder(LocalApplicationListPolicyObjectEntryArgs defaults) {
            $ = new LocalApplicationListPolicyObjectEntryArgs(Objects.requireNonNull(defaults));
        }
