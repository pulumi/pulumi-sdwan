...
import com.pulumi.sdwan.outputs.GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy;
...
@CustomType
public final class GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily {
    /**
     ...
     * 
     */
    private List<GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies;

    private GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily() {}
    /**
     * @return Set BGP address family
     * 
     */
     ...
     * 
     */
    public List<GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies() {
    ...
    public static Builder builder(GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies;
        public Builder() {}
        public Builder(GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily defaults) {
        ...
        public Builder familyType(String familyType) {
            if (familyType == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "familyType");
            }
        ...
        public Builder maximumPrefixes(Integer maximumPrefixes) {
            if (maximumPrefixes == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixes");
            }
        ...
        public Builder maximumPrefixesRestart(Integer maximumPrefixesRestart) {
            if (maximumPrefixesRestart == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixesRestart");
            }
        ...
        public Builder maximumPrefixesRestartVariable(String maximumPrefixesRestartVariable) {
            if (maximumPrefixesRestartVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixesRestartVariable");
            }
        ...
        public Builder maximumPrefixesThreshold(Integer maximumPrefixesThreshold) {
            if (maximumPrefixesThreshold == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixesThreshold");
            }
        ...
        public Builder maximumPrefixesThresholdVariable(String maximumPrefixesThresholdVariable) {
            if (maximumPrefixesThresholdVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixesThresholdVariable");
            }
        ...
        public Builder maximumPrefixesVariable(String maximumPrefixesVariable) {
            if (maximumPrefixesVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixesVariable");
            }
        ...
        public Builder maximumPrefixesWarningOnly(Boolean maximumPrefixesWarningOnly) {
            if (maximumPrefixesWarningOnly == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixesWarningOnly");
            }
        ...
        public Builder maximumPrefixesWarningOnlyVariable(String maximumPrefixesWarningOnlyVariable) {
            if (maximumPrefixesWarningOnlyVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "maximumPrefixesWarningOnlyVariable");
            }
        ...
        public Builder optional(Boolean optional) {
            if (optional == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "optional");
            }
            this.optional = optional;
            return this;
        }
        @CustomType.Setter
        public Builder routePolicies(List<GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy> routePolicies) {
            if (routePolicies == null) {
              throw new MissingRequiredPropertyException("GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily", "routePolicies");
            }
            this.routePolicies = routePolicies;
            return this;
        }
        public Builder routePolicies(GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamilyRoutePolicy... routePolicies) {
            return routePolicies(List.of(routePolicies));
        }
        public GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily build() {
            final var _resultValue = new GetCiscoBgpFeatureTemplateIpv6NeighborAddressFamily();
