...
@CustomType
public final class SystemBfdFeatureColor {
    /**
    ...
    public static Builder builder(SystemBfdFeatureColor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String pmtuDiscoveryVariable;
        public Builder() {}
        public Builder(SystemBfdFeatureColor defaults) {
        ...
        public SystemBfdFeatureColor build() {
            final var _resultValue = new SystemBfdFeatureColor();
