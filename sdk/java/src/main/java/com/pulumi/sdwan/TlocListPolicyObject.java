...
import com.pulumi.sdwan.inputs.TlocListPolicyObjectState;
import com.pulumi.sdwan.outputs.TlocListPolicyObjectEntry;
 ...
 * 
 */
@ResourceType(type="sdwan:index/tlocListPolicyObject:TlocListPolicyObject")
public class TlocListPolicyObject extends com.pulumi.resources.CustomResource {
    /**
     * List of entries
     * 
     */
    @Export(name="entries", refs={List.class,TlocListPolicyObjectEntry.class}, tree="[0,1]")
    private Output<List<TlocListPolicyObjectEntry>> entries;

    /**
     * @return List of entries
     * 
     */
    public Output<List<TlocListPolicyObjectEntry>> entries() {
        return this.entries;
    }
    /**
