...
import com.pulumi.sdwan.outputs.TransportManagementVpnProfileParcelIpv6StaticRouteNextHop;
...
@CustomType
public final class TransportManagementVpnProfileParcelIpv6StaticRoute {
    /**
     * @return IPv6 Nat
     *   - Choices: `NAT64`, `NAT66`
     * 
     ...
     * 
     */
    private @Nullable List<TransportManagementVpnProfileParcelIpv6StaticRouteNextHop> nextHops;
    /**
     * @return IPv6 Route Gateway Next Hop
     * 
     */
     ...
     * 
     */
    public List<TransportManagementVpnProfileParcelIpv6StaticRouteNextHop> nextHops() {
    ...
    public static Builder builder(TransportManagementVpnProfileParcelIpv6StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String prefixVariable;
        public Builder() {}
        public Builder(TransportManagementVpnProfileParcelIpv6StaticRoute defaults) {
        ...
        @CustomType.Setter
        public Builder nextHops(@Nullable List<TransportManagementVpnProfileParcelIpv6StaticRouteNextHop> nextHops) {

            this.nextHops = nextHops;
            return this;
        }
        public Builder nextHops(TransportManagementVpnProfileParcelIpv6StaticRouteNextHop... nextHops) {
        ...
        public TransportManagementVpnProfileParcelIpv6StaticRoute build() {
            final var _resultValue = new TransportManagementVpnProfileParcelIpv6StaticRoute();
