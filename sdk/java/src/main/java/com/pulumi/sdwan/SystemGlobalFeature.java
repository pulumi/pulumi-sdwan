...
import com.pulumi.sdwan.inputs.SystemGlobalFeatureState;
...
public class SystemGlobalFeature extends com.pulumi.resources.CustomResource {
    ...
    public Output<Optional<Boolean>> ignoreBootp() {
        return Codegen.optional(this.ignoreBootp);
    }
    /**
     * Variable name
     * 
     */
    @Export(name="ignoreBootpVariable", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> ignoreBootpVariable;

    /**
     * @return Variable name
     * 
     */
    public Output<Optional<String>> ignoreBootpVariable() {
    ...
    public Output<Optional<Boolean>> vtyLineLogging() {
        return Codegen.optional(this.vtyLineLogging);
    }
    /**
     * Variable name
     * 
     */
    @Export(name="vtyLineLoggingVariable", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> vtyLineLoggingVariable;

    /**
     * @return Variable name
     * 
     */
    public Output<Optional<String>> vtyLineLoggingVariable() {
        return Codegen.optional(this.vtyLineLoggingVariable);
    }
     ...
     */
    public SystemGlobalFeature(java.lang.String name) {
        this(name, SystemGlobalFeatureArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SystemGlobalFeature(java.lang.String name, SystemGlobalFeatureArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SystemGlobalFeature(java.lang.String name, SystemGlobalFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemGlobalFeature:SystemGlobalFeature", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SystemGlobalFeature(java.lang.String name, Output<java.lang.String> id, @Nullable SystemGlobalFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemGlobalFeature:SystemGlobalFeature", name, state, makeResourceOptions(options, id), false);
    }

    private static SystemGlobalFeatureArgs makeArgs(SystemGlobalFeatureArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SystemGlobalFeatureArgs.Empty : args;
    }
     ...
     */
    public static SystemGlobalFeature get(java.lang.String name, Output<java.lang.String> id, @Nullable SystemGlobalFeatureState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SystemGlobalFeature(name, id, state, options);
    }
}
