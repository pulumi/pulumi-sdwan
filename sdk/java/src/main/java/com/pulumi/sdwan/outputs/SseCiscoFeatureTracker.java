...
@CustomType
public final class SseCiscoFeatureTracker {
    /**
    ...
    private SseCiscoFeatureTracker() {}
    /**
     * @return API url of endpoint
     * 
     */
    ...
    public static Builder builder(SseCiscoFeatureTracker defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String thresholdVariable;
        public Builder() {}
        public Builder(SseCiscoFeatureTracker defaults) {
        ...
        public SseCiscoFeatureTracker build() {
            final var _resultValue = new SseCiscoFeatureTracker();
