...
import com.pulumi.sdwan.outputs.ServiceLanVpnProfileParcelIpv4StaticRouteNextHop;
import com.pulumi.sdwan.outputs.ServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker;
...
@CustomType
public final class ServiceLanVpnProfileParcelIpv4StaticRoute {
    /**
     ...
     * 
     */
    private @Nullable List<ServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker> nextHopWithTrackers;
    /**
     * @return IPv4 Route Gateway Next Hop
     * 
     */
    private @Nullable List<ServiceLanVpnProfileParcelIpv4StaticRouteNextHop> nextHops;
    /**
     * @return IPv4 Route Gateway Next Hop
     * 
     */
    ...
    private ServiceLanVpnProfileParcelIpv4StaticRoute() {}
    /**
     * @return IPv4 Route Gateway DHCP
     * 
     */
     ...
     * 
     */
    public List<ServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker> nextHopWithTrackers() {
     ...
     * 
     */
    public List<ServiceLanVpnProfileParcelIpv4StaticRouteNextHop> nextHops() {
    ...
    public static Builder builder(ServiceLanVpnProfileParcelIpv4StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean vpn;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelIpv4StaticRoute defaults) {
        ...
        @CustomType.Setter
        public Builder nextHopWithTrackers(@Nullable List<ServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker> nextHopWithTrackers) {

            this.nextHopWithTrackers = nextHopWithTrackers;
            return this;
        }
        public Builder nextHopWithTrackers(ServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker... nextHopWithTrackers) {
            return nextHopWithTrackers(List.of(nextHopWithTrackers));
        }
        @CustomType.Setter
        public Builder nextHops(@Nullable List<ServiceLanVpnProfileParcelIpv4StaticRouteNextHop> nextHops) {

            this.nextHops = nextHops;
            return this;
        }
        public Builder nextHops(ServiceLanVpnProfileParcelIpv4StaticRouteNextHop... nextHops) {
        ...
        public ServiceLanVpnProfileParcelIpv4StaticRoute build() {
            final var _resultValue = new ServiceLanVpnProfileParcelIpv4StaticRoute();
