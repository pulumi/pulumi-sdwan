...
public final class ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs() {}

    private ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs(ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs $) {
    ...
    public static Builder builder(ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs();
        }

        public Builder(ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs defaults) {
            $ = new ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ApplicationAwareRoutingPolicyDefinitionSequenceMatchEntryArgs", "type");
            }
            return $;
        }
    }
