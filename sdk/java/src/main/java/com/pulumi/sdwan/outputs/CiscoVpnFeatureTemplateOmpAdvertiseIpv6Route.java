...
import com.pulumi.sdwan.outputs.CiscoVpnFeatureTemplateOmpAdvertiseIpv6RoutePrefix;
...
@CustomType
public final class CiscoVpnFeatureTemplateOmpAdvertiseIpv6Route {
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    private @Nullable Boolean optional;
    private @Nullable List<CiscoVpnFeatureTemplateOmpAdvertiseIpv6RoutePrefix> prefixes;
    /**
    ...
    public List<CiscoVpnFeatureTemplateOmpAdvertiseIpv6RoutePrefix> prefixes() {
    ...
    public static Builder builder(CiscoVpnFeatureTemplateOmpAdvertiseIpv6Route defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routePolicyVariable;
        public Builder() {}
        public Builder(CiscoVpnFeatureTemplateOmpAdvertiseIpv6Route defaults) {
        ...
        @CustomType.Setter
        public Builder prefixes(@Nullable List<CiscoVpnFeatureTemplateOmpAdvertiseIpv6RoutePrefix> prefixes) {

            this.prefixes = prefixes;
            return this;
        }
        public Builder prefixes(CiscoVpnFeatureTemplateOmpAdvertiseIpv6RoutePrefix... prefixes) {
        ...
        public CiscoVpnFeatureTemplateOmpAdvertiseIpv6Route build() {
            final var _resultValue = new CiscoVpnFeatureTemplateOmpAdvertiseIpv6Route();
