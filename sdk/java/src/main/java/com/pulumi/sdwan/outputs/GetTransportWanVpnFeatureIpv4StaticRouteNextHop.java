...
@CustomType
public final class GetTransportWanVpnFeatureIpv4StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private GetTransportWanVpnFeatureIpv4StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetTransportWanVpnFeatureIpv4StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetTransportWanVpnFeatureIpv4StaticRouteNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnFeatureIpv4StaticRouteNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnFeatureIpv4StaticRouteNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnFeatureIpv4StaticRouteNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnFeatureIpv4StaticRouteNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetTransportWanVpnFeatureIpv4StaticRouteNextHop build() {
            final var _resultValue = new GetTransportWanVpnFeatureIpv4StaticRouteNextHop();
