...
public final class SystemSnmpFeatureState extends com.pulumi.resources.ResourceArgs {

    public static final SystemSnmpFeatureState Empty = new SystemSnmpFeatureState();
    ...
    private SystemSnmpFeatureState() {}

    private SystemSnmpFeatureState(SystemSnmpFeatureState $) {
    ...
    public static Builder builder(SystemSnmpFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemSnmpFeatureState();
        }

        public Builder(SystemSnmpFeatureState defaults) {
            $ = new SystemSnmpFeatureState(Objects.requireNonNull(defaults));
        }
        ...
        public SystemSnmpFeatureState build() {
            return $;
        }
    }
