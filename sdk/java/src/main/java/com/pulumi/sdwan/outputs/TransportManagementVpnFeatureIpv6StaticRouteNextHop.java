...
@CustomType
public final class TransportManagementVpnFeatureIpv6StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private TransportManagementVpnFeatureIpv6StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(TransportManagementVpnFeatureIpv6StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(TransportManagementVpnFeatureIpv6StaticRouteNextHop defaults) {
        ...
        public TransportManagementVpnFeatureIpv6StaticRouteNextHop build() {
            final var _resultValue = new TransportManagementVpnFeatureIpv6StaticRouteNextHop();
