...
public class CellularControllerFeatureTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public CellularControllerFeatureTemplate(java.lang.String name) {
     ...
     */
    public CellularControllerFeatureTemplate(java.lang.String name, CellularControllerFeatureTemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CellularControllerFeatureTemplate(java.lang.String name, CellularControllerFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/cellularControllerFeatureTemplate:CellularControllerFeatureTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CellularControllerFeatureTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable CellularControllerFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/cellularControllerFeatureTemplate:CellularControllerFeatureTemplate", name, state, makeResourceOptions(options, id), false);
    }

    private static CellularControllerFeatureTemplateArgs makeArgs(CellularControllerFeatureTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CellularControllerFeatureTemplateArgs.Empty : args;
    }
     ...
     */
    public static CellularControllerFeatureTemplate get(java.lang.String name, Output<java.lang.String> id, @Nullable CellularControllerFeatureTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
