...
@CustomType
public final class GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward {
    /**
    ...
    private GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward() {}
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    ...
    public static Builder builder(GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward defaults) {
    ...
    public static final class Builder {
        ...
        private String protocol;
        public Builder() {}
        public Builder(GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward defaults) {
        ...
        public Builder optional(Boolean optional) {
            if (optional == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "optional");
            }
        ...
        public Builder portEndRange(Integer portEndRange) {
            if (portEndRange == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "portEndRange");
            }
        ...
        public Builder portStartRange(Integer portStartRange) {
            if (portStartRange == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "portStartRange");
            }
        ...
        public Builder privateIpAddress(String privateIpAddress) {
            if (privateIpAddress == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "privateIpAddress");
            }
        ...
        public Builder privateIpAddressVariable(String privateIpAddressVariable) {
            if (privateIpAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "privateIpAddressVariable");
            }
        ...
        public Builder privateVpn(Integer privateVpn) {
            if (privateVpn == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "privateVpn");
            }
        ...
        public Builder privateVpnVariable(String privateVpnVariable) {
            if (privateVpnVariable == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "privateVpnVariable");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward", "protocol");
            }
            this.protocol = protocol;
            return this;
        }
        public GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward build() {
            final var _resultValue = new GetVpnInterfaceEthernetPppoeFeatureTemplateNatPortForward();
