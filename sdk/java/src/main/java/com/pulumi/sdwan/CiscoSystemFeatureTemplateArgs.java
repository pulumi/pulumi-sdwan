...
public final class CiscoSystemFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final CiscoSystemFeatureTemplateArgs Empty = new CiscoSystemFeatureTemplateArgs();
    ...
    private CiscoSystemFeatureTemplateArgs() {}

    private CiscoSystemFeatureTemplateArgs(CiscoSystemFeatureTemplateArgs $) {
    ...
    public static Builder builder(CiscoSystemFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoSystemFeatureTemplateArgs();
        }

        public Builder(CiscoSystemFeatureTemplateArgs defaults) {
            $ = new CiscoSystemFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param affinityGroupNumber Set the affinity group number for router
         *   - Range: `1`-`255`
         * 
         * @return builder
         * 
        ...
        /**
         * @param enableMrfMigration Enable migration mode to Multi-Region Fabric
         *   - Choices: `enabled`, `enabled-from-bgp-core`
         * 
         * @return builder
         * 
        ...
        /**
         * @param enhancedAppAwareRouting Enhanced App Aware Routing
         *   - Choices: `disabled`, `aggressive`, `moderate`, `conservative`
         *   - Default value: `disabled`
         * 
         * @return builder
        ...
        /**
         * @param geoFencing Enable Geo fencing
         *   - Default value: `false`
         * 
         * @return builder
         * 
        ...
        /**
         * @param geoFencingRange Set the device’s geo fencing range
         *   - Range: `100`-`10000`
         *   - Default value: `100`
         * 
         * @return builder
        ...
        /**
         * @param geoFencingSms Enable Geo fencing
         *   - Default value: `false`
         * 
         * @return builder
         * 
        ...
        /**
         * @param latitude Set the device’s physical latitude
         *   - Range: `-90`-`90`
         * 
         * @return builder
         * 
        ...
        /**
         * @param longitude Set the device’s physical longitude
         *   - Range: `-180`-`180`
         * 
         * @return builder
         * 
        ...
        /**
         * @param onDemandTunnel Enable or disable On-demand Tunnel
         *   - Default value: `false`
         * 
         * @return builder
         * 
        ...
        /**
         * @param onDemandTunnelIdleTimeout Idle CLI timeout in minutes
         *   - Range: `0`-`300`
         * 
         * @return builder
         * 
        ...
        /**
         * @param siteId Set the site identifier
         *   - Range: `1`-`4294967295`
         * 
         * @return builder
         * 
        ...
        public CiscoSystemFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("CiscoSystemFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("CiscoSystemFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
