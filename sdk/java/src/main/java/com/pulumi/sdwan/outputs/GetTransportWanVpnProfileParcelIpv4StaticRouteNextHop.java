...
@CustomType
public final class GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private String administrativeDistanceVariable;
        public Builder() {}
        public Builder(GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop", "administrativeDistanceVariable");
            }
            this.administrativeDistanceVariable = administrativeDistanceVariable;
            return this;
        }
        public GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop build() {
            final var _resultValue = new GetTransportWanVpnProfileParcelIpv4StaticRouteNextHop();
