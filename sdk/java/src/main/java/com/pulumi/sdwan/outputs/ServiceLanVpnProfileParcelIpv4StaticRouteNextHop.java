...
@CustomType
public final class ServiceLanVpnProfileParcelIpv4StaticRouteNextHop {
    /**
     * @return Address
     * 
     */
    ...
    private ServiceLanVpnProfileParcelIpv4StaticRouteNextHop() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(ServiceLanVpnProfileParcelIpv4StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelIpv4StaticRouteNextHop defaults) {
        ...
        public ServiceLanVpnProfileParcelIpv4StaticRouteNextHop build() {
            final var _resultValue = new ServiceLanVpnProfileParcelIpv4StaticRouteNextHop();
