...
import com.pulumi.sdwan.outputs.TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo;
...
@CustomType
public final class TransportManagementVpnProfileParcelIpv4StaticRoute {
    /**
     ...
     * 
     */
    private @Nullable List<TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo> ipv4RouteGatewayNextHos;
    /**
     * @return IP Address
     * 
     */
     ...
     * 
     */
    public List<TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo> ipv4RouteGatewayNextHos() {
        return this.ipv4RouteGatewayNextHos == null ? List.of() : this.ipv4RouteGatewayNextHos;
    }
    /**
     * @return IP Address
     * 
    ...
    public static Builder builder(TransportManagementVpnProfileParcelIpv4StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportManagementVpnProfileParcelIpv4StaticRoute defaults) {
        ...
        @CustomType.Setter
        public Builder ipv4RouteGatewayNextHos(@Nullable List<TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo> ipv4RouteGatewayNextHos) {

            this.ipv4RouteGatewayNextHos = ipv4RouteGatewayNextHos;
            return this;
        }
        public Builder ipv4RouteGatewayNextHos(TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo... ipv4RouteGatewayNextHos) {
        ...
        public TransportManagementVpnProfileParcelIpv4StaticRoute build() {
            final var _resultValue = new TransportManagementVpnProfileParcelIpv4StaticRoute();
