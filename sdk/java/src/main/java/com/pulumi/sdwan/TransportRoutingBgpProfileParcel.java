...
public class TransportRoutingBgpProfileParcel extends com.pulumi.resources.CustomResource {
     ...
     */
    public TransportRoutingBgpProfileParcel(String name) {
     ...
     */
    public TransportRoutingBgpProfileParcel(String name, TransportRoutingBgpProfileParcelArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TransportRoutingBgpProfileParcel(String name, TransportRoutingBgpProfileParcelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/transportRoutingBgpProfileParcel:TransportRoutingBgpProfileParcel", name, args == null ? TransportRoutingBgpProfileParcelArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private TransportRoutingBgpProfileParcel(String name, Output<String> id, @Nullable TransportRoutingBgpProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/transportRoutingBgpProfileParcel:TransportRoutingBgpProfileParcel", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static TransportRoutingBgpProfileParcel get(String name, Output<String> id, @Nullable TransportRoutingBgpProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
