...
@CustomType
public final class VpnInterfaceCellularFeatureTemplateNatPortForward {
    /**
    ...
    private VpnInterfaceCellularFeatureTemplateNatPortForward() {}
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    ...
    public static Builder builder(VpnInterfaceCellularFeatureTemplateNatPortForward defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String protocol;
        public Builder() {}
        public Builder(VpnInterfaceCellularFeatureTemplateNatPortForward defaults) {
        ...
        public VpnInterfaceCellularFeatureTemplateNatPortForward build() {
            final var _resultValue = new VpnInterfaceCellularFeatureTemplateNatPortForward();
