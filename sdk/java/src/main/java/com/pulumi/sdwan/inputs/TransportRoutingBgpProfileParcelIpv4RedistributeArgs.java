...
public final class TransportRoutingBgpProfileParcelIpv4RedistributeArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportRoutingBgpProfileParcelIpv4RedistributeArgs Empty = new TransportRoutingBgpProfileParcelIpv4RedistributeArgs();
    ...
    private TransportRoutingBgpProfileParcelIpv4RedistributeArgs() {}

    private TransportRoutingBgpProfileParcelIpv4RedistributeArgs(TransportRoutingBgpProfileParcelIpv4RedistributeArgs $) {
    ...
    public static Builder builder(TransportRoutingBgpProfileParcelIpv4RedistributeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportRoutingBgpProfileParcelIpv4RedistributeArgs();
        }

        public Builder(TransportRoutingBgpProfileParcelIpv4RedistributeArgs defaults) {
            $ = new TransportRoutingBgpProfileParcelIpv4RedistributeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransportRoutingBgpProfileParcelIpv4RedistributeArgs build() {
            return $;
        }
    }
