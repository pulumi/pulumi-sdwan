...
@CustomType
public final class TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo {
    /**
     * @return Address
     * 
     */
    ...
    private TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String administrativeDistanceVariable;
        public Builder() {}
        public Builder(TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo defaults) {
        ...
        public TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo build() {
            final var _resultValue = new TransportManagementVpnProfileParcelIpv4StaticRouteIpv4RouteGatewayNextHo();
