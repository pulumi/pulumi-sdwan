...
import com.pulumi.sdwan.inputs.ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnRedistributionArgs;
...
public final class ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs Empty = new ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs();
    ...
    private @Nullable Output<List<ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnRedistributionArgs>> redistributions;

    /**
     * @return Redistribute Routes to specific Protocol on Service VPN
     * 
     */
    public Optional<Output<List<ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnRedistributionArgs>>> redistributions() {
    ...
    private ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs() {}

    private ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs(ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs $) {
    ...
    public static Builder builder(ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs();
        }

        public Builder(ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs defaults) {
            $ = new ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder redistributions(@Nullable Output<List<ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnRedistributionArgs>> redistributions) {
         ...
         * 
         */
        public Builder redistributions(List<ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnRedistributionArgs> redistributions) {
         ...
         * 
         */
        public Builder redistributions(ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnRedistributionArgs... redistributions) {
        ...
        public ServiceLanVpnProfileParcelRouteLeakFromGlobalVpnArgs build() {
            return $;
        }
    }
