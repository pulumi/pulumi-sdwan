...
import com.pulumi.sdwan.outputs.TransportIpv4AclFeatureSequenceMatchEntryDestinationPort;
import com.pulumi.sdwan.outputs.TransportIpv4AclFeatureSequenceMatchEntrySourcePort;
...
@CustomType
public final class TransportIpv4AclFeatureSequenceMatchEntry {
    /**
     ...
     * 
     */
    private @Nullable List<TransportIpv4AclFeatureSequenceMatchEntryDestinationPort> destinationPorts;
    /**
     * @return DSCP number
     * 
     */
     ...
     * 
     */
    private @Nullable List<TransportIpv4AclFeatureSequenceMatchEntrySourcePort> sourcePorts;
    /**
     * @return TCP States
     *   - Choices: `syn`
     * 
    ...
    private TransportIpv4AclFeatureSequenceMatchEntry() {}
    /**
     * @return Destination Data IP Prefix
     * 
     */
     ...
     * 
     */
    public List<TransportIpv4AclFeatureSequenceMatchEntryDestinationPort> destinationPorts() {
     ...
     * 
     */
    public List<TransportIpv4AclFeatureSequenceMatchEntrySourcePort> sourcePorts() {
    ...
    public static Builder builder(TransportIpv4AclFeatureSequenceMatchEntry defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tcpState;
        public Builder() {}
        public Builder(TransportIpv4AclFeatureSequenceMatchEntry defaults) {
        ...
        @CustomType.Setter
        public Builder destinationPorts(@Nullable List<TransportIpv4AclFeatureSequenceMatchEntryDestinationPort> destinationPorts) {

            this.destinationPorts = destinationPorts;
            return this;
        }
        public Builder destinationPorts(TransportIpv4AclFeatureSequenceMatchEntryDestinationPort... destinationPorts) {
        ...
        @CustomType.Setter
        public Builder sourcePorts(@Nullable List<TransportIpv4AclFeatureSequenceMatchEntrySourcePort> sourcePorts) {

            this.sourcePorts = sourcePorts;
            return this;
        }
        public Builder sourcePorts(TransportIpv4AclFeatureSequenceMatchEntrySourcePort... sourcePorts) {
        ...
        public TransportIpv4AclFeatureSequenceMatchEntry build() {
            final var _resultValue = new TransportIpv4AclFeatureSequenceMatchEntry();
