...
import com.pulumi.sdwan.outputs.TransportRoutingOspfv3Ipv4FeatureAreaInterface;
import com.pulumi.sdwan.outputs.TransportRoutingOspfv3Ipv4FeatureAreaRange;
...
@CustomType
public final class TransportRoutingOspfv3Ipv4FeatureArea {
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingOspfv3Ipv4FeatureAreaInterface> interfaces;
    /**
     ...
     * 
     */
    private @Nullable List<TransportRoutingOspfv3Ipv4FeatureAreaRange> ranges;
     ...
     * 
     */
    public List<TransportRoutingOspfv3Ipv4FeatureAreaInterface> interfaces() {
     ...
     * 
     */
    public List<TransportRoutingOspfv3Ipv4FeatureAreaRange> ranges() {
    ...
    public static Builder builder(TransportRoutingOspfv3Ipv4FeatureArea defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<TransportRoutingOspfv3Ipv4FeatureAreaRange> ranges;
        public Builder() {}
        public Builder(TransportRoutingOspfv3Ipv4FeatureArea defaults) {
        ...
        @CustomType.Setter
        public Builder interfaces(@Nullable List<TransportRoutingOspfv3Ipv4FeatureAreaInterface> interfaces) {

            this.interfaces = interfaces;
            return this;
        }
        public Builder interfaces(TransportRoutingOspfv3Ipv4FeatureAreaInterface... interfaces) {
        ...
        @CustomType.Setter
        public Builder ranges(@Nullable List<TransportRoutingOspfv3Ipv4FeatureAreaRange> ranges) {

            this.ranges = ranges;
            return this;
        }
        public Builder ranges(TransportRoutingOspfv3Ipv4FeatureAreaRange... ranges) {
            return ranges(List.of(ranges));
        }
        public TransportRoutingOspfv3Ipv4FeatureArea build() {
            final var _resultValue = new TransportRoutingOspfv3Ipv4FeatureArea();
