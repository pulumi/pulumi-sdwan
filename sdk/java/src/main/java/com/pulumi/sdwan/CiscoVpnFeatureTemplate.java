 ...
 *                     Map.entry("address", "11.1.1.1"),
 *                     Map.entry("distance", 20)
 *                 )))
 *                 .track_next_hops(List.of(Map.ofEntries(
 *                     Map.entry("address", "12.1.1.1"),
 *                     Map.entry("distance", 20),
 *                     Map.entry("tracker", "tracker1")
 *                 )))
 *                 .build())
 ...
 *                 .protocol("bgp")
 *                 .route_policy("rp1")
 *                 .protocol_sub_type(List.of("external"))
