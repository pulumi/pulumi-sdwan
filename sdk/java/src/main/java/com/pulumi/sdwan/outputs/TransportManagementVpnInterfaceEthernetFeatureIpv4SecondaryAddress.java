...
@CustomType
public final class TransportManagementVpnInterfaceEthernetFeatureIpv4SecondaryAddress {
    /**
     * @return IpV4 Address
     * 
     */
    ...
    public static Builder builder(TransportManagementVpnInterfaceEthernetFeatureIpv4SecondaryAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetMaskVariable;
        public Builder() {}
        public Builder(TransportManagementVpnInterfaceEthernetFeatureIpv4SecondaryAddress defaults) {
        ...
        public TransportManagementVpnInterfaceEthernetFeatureIpv4SecondaryAddress build() {
            final var _resultValue = new TransportManagementVpnInterfaceEthernetFeatureIpv4SecondaryAddress();
