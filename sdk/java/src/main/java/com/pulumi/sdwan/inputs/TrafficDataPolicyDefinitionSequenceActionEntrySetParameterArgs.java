...
public final class TrafficDataPolicyDefinitionSequenceActionEntrySetParameterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param dscp DSCP, Attribute conditional on `type` equal to `dscp`
         *   - Range: `0`-`63`
         * 
         * @return builder
         * 
        ...
        /**
         * @param forwardingClass Forwarding class, Attribute conditional on `type` equal to `forwardingClass`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param localTlocListColor Local TLOC list color. Space separated list of colors., Attribute conditional on `type` equal to `localTlocList`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param localTlocListEncap Local TLOC list encapsulation., Attribute conditional on `type` equal to `localTlocList`
         *   - Choices: `ipsec`, `gre`, `ipsec gre`
         * 
         * @return builder
         * 
        ...
        /**
         * @param localTlocListRestrict Local TLOC list restrict, Attribute conditional on `type` equal to `localTlocList`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nextHopLoose Use routing table entry to forward the packet in case Next-hop is not available, Attribute conditional on `type` equal to `nextHopLoose`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param policerListId Policer list ID, Attribute conditional on `type` equal to `policer`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceTlocColor Service TLOC color, Attribute conditional on `type` equal to `service`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceTlocEncapsulation Service TLOC encapsulation, Attribute conditional on `type` equal to `service`
         *   - Choices: `ipsec`, `gre`, `ipsec gre`
         * 
         * @return builder
         * 
        ...
        /**
         * @param serviceTlocIp Service TLOC IP address, Attribute conditional on `type` equal to `service`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceTlocListId Service TLOC list ID, Attribute conditional on `type` equal to `service`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceTlocLocal Service TLOC Local, Attribute conditional on `type` equal to `service`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceTlocRestrict Service TLOC Restrict, Attribute conditional on `type` equal to `service`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceType Service type, Attribute conditional on `type` equal to `service`
         *   - Choices: `FW`, `IDP`, `IDS`, `netsvc1`, `netsvc2`, `netsvc3`, `netsvc4`, `netsvc5`
         * 
         * @return builder
         * 
        ...
        /**
         * @param serviceVpnId Service VPN ID, Attribute conditional on `type` equal to `service`
         *   - Range: `0`-`65536`
         * 
         * @return builder
         * 
        ...
        /**
         * @param vpnId DSCP, Attribute conditional on `type` equal to `vpn`
         *   - Range: `0`-`65530`
         * 
         * @return builder
         * 
