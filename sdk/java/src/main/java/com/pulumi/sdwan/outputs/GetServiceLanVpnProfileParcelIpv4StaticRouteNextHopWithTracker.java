...
@CustomType
public final class GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker {
    /**
     * @return Address
     * 
     */
    ...
    private GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker() {}
    /**
     * @return Address
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker defaults) {
    ...
    public static final class Builder {
        ...
        private String trackerId;
        public Builder() {}
        public Builder(GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker", "address");
            }
        ...
        public Builder addressVariable(String addressVariable) {
            if (addressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker", "addressVariable");
            }
        ...
        public Builder administrativeDistance(Integer administrativeDistance) {
            if (administrativeDistance == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker", "administrativeDistance");
            }
        ...
        public Builder administrativeDistanceVariable(String administrativeDistanceVariable) {
            if (administrativeDistanceVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker", "administrativeDistanceVariable");
            }
        ...
        public Builder trackerId(String trackerId) {
            if (trackerId == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker", "trackerId");
            }
            this.trackerId = trackerId;
            return this;
        }
        public GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker build() {
            final var _resultValue = new GetServiceLanVpnProfileParcelIpv4StaticRouteNextHopWithTracker();
