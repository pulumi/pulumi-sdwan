...
import com.pulumi.sdwan.outputs.ServiceLanVpnProfileParcelIpv6StaticRouteNextHop;
...
@CustomType
public final class ServiceLanVpnProfileParcelIpv6StaticRoute {
    /**
     * @return IPv6 Nat
     *   - Choices: `NAT64`, `NAT66`
     * 
     ...
     * 
     */
    private @Nullable List<ServiceLanVpnProfileParcelIpv6StaticRouteNextHop> nextHops;
    /**
     * @return IPv6 Route Gateway Next Hop
     * 
     */
    ...
    private ServiceLanVpnProfileParcelIpv6StaticRoute() {}
    /**
     * @return IPv6 Nat
     *   - Choices: `NAT64`, `NAT66`
     * 
     ...
     * 
     */
    public List<ServiceLanVpnProfileParcelIpv6StaticRouteNextHop> nextHops() {
    ...
    public static Builder builder(ServiceLanVpnProfileParcelIpv6StaticRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String prefixVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelIpv6StaticRoute defaults) {
        ...
        @CustomType.Setter
        public Builder nextHops(@Nullable List<ServiceLanVpnProfileParcelIpv6StaticRouteNextHop> nextHops) {

            this.nextHops = nextHops;
            return this;
        }
        public Builder nextHops(ServiceLanVpnProfileParcelIpv6StaticRouteNextHop... nextHops) {
        ...
        public ServiceLanVpnProfileParcelIpv6StaticRoute build() {
            final var _resultValue = new ServiceLanVpnProfileParcelIpv6StaticRoute();
