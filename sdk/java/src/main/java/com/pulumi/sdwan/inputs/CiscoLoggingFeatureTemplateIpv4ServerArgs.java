...
public final class CiscoLoggingFeatureTemplateIpv4ServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final CiscoLoggingFeatureTemplateIpv4ServerArgs Empty = new CiscoLoggingFeatureTemplateIpv4ServerArgs();
    ...
    private CiscoLoggingFeatureTemplateIpv4ServerArgs() {}

    private CiscoLoggingFeatureTemplateIpv4ServerArgs(CiscoLoggingFeatureTemplateIpv4ServerArgs $) {
    ...
    public static Builder builder(CiscoLoggingFeatureTemplateIpv4ServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CiscoLoggingFeatureTemplateIpv4ServerArgs();
        }

        public Builder(CiscoLoggingFeatureTemplateIpv4ServerArgs defaults) {
            $ = new CiscoLoggingFeatureTemplateIpv4ServerArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param hostnameIp Set hostname or IPv4 address of server
         * 
         * @return builder
         * 
         */
        ...
        public CiscoLoggingFeatureTemplateIpv4ServerArgs build() {
            return $;
        }
    }
