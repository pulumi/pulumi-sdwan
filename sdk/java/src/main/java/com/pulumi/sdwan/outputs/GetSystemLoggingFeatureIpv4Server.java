...
public final class GetSystemLoggingFeatureIpv4Server {
    ...
    public static Builder builder(GetSystemLoggingFeatureIpv4Server defaults) {
    ...
    public static final class Builder {
        ...
        private String vpnVariable;
        public Builder() {}
        public Builder(GetSystemLoggingFeatureIpv4Server defaults) {
        ...
        public Builder hostnameIp(String hostnameIp) {
            if (hostnameIp == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "hostnameIp");
            }
        ...
        public Builder hostnameIpVariable(String hostnameIpVariable) {
            if (hostnameIpVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "hostnameIpVariable");
            }
        ...
        public Builder priority(String priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "priority");
            }
        ...
        public Builder priorityVariable(String priorityVariable) {
            if (priorityVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "priorityVariable");
            }
        ...
        public Builder sourceInterface(String sourceInterface) {
            if (sourceInterface == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "sourceInterface");
            }
        ...
        public Builder sourceInterfaceVariable(String sourceInterfaceVariable) {
            if (sourceInterfaceVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "sourceInterfaceVariable");
            }
        ...
        public Builder tlsEnable(Boolean tlsEnable) {
            if (tlsEnable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "tlsEnable");
            }
        ...
        public Builder tlsEnableVariable(String tlsEnableVariable) {
            if (tlsEnableVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "tlsEnableVariable");
            }
        ...
        public Builder tlsPropertiesCustomProfile(Boolean tlsPropertiesCustomProfile) {
            if (tlsPropertiesCustomProfile == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "tlsPropertiesCustomProfile");
            }
        ...
        public Builder tlsPropertiesCustomProfileVariable(String tlsPropertiesCustomProfileVariable) {
            if (tlsPropertiesCustomProfileVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "tlsPropertiesCustomProfileVariable");
            }
        ...
        public Builder tlsPropertiesProfile(String tlsPropertiesProfile) {
            if (tlsPropertiesProfile == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "tlsPropertiesProfile");
            }
        ...
        public Builder tlsPropertiesProfileVariable(String tlsPropertiesProfileVariable) {
            if (tlsPropertiesProfileVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "tlsPropertiesProfileVariable");
            }
        ...
        public Builder vpn(Integer vpn) {
            if (vpn == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "vpn");
            }
            this.vpn = vpn;
            return this;
        }
        ...
        public Builder vpnVariable(String vpnVariable) {
            if (vpnVariable == null) {
              throw new MissingRequiredPropertyException("GetSystemLoggingFeatureIpv4Server", "vpnVariable");
            }
            this.vpnVariable = vpnVariable;
            return this;
        }
        public GetSystemLoggingFeatureIpv4Server build() {
            final var _resultValue = new GetSystemLoggingFeatureIpv4Server();
