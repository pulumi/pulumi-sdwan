...
import com.pulumi.sdwan.outputs.VpnInterfaceSviFeatureTemplateIpv4VrrpIpv4SecondaryAddress;
import com.pulumi.sdwan.outputs.VpnInterfaceSviFeatureTemplateIpv4VrrpTrackingObject;
...
@CustomType
public final class VpnInterfaceSviFeatureTemplateIpv4Vrrp {
    /**
     * @return Group ID
     *   - Range: `1`-`255`
     * 
     ...
     * 
     */
    private @Nullable List<VpnInterfaceSviFeatureTemplateIpv4VrrpIpv4SecondaryAddress> ipv4SecondaryAddresses;
    /**
     ...
     * 
     */
    private @Nullable List<VpnInterfaceSviFeatureTemplateIpv4VrrpTrackingObject> trackingObjects;
     ...
     * 
     */
    public List<VpnInterfaceSviFeatureTemplateIpv4VrrpIpv4SecondaryAddress> ipv4SecondaryAddresses() {
     ...
     * 
     */
    public List<VpnInterfaceSviFeatureTemplateIpv4VrrpTrackingObject> trackingObjects() {
    ...
    public static Builder builder(VpnInterfaceSviFeatureTemplateIpv4Vrrp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<VpnInterfaceSviFeatureTemplateIpv4VrrpTrackingObject> trackingObjects;
        public Builder() {}
        public Builder(VpnInterfaceSviFeatureTemplateIpv4Vrrp defaults) {
        ...
        @CustomType.Setter
        public Builder ipv4SecondaryAddresses(@Nullable List<VpnInterfaceSviFeatureTemplateIpv4VrrpIpv4SecondaryAddress> ipv4SecondaryAddresses) {

            this.ipv4SecondaryAddresses = ipv4SecondaryAddresses;
            return this;
        }
        public Builder ipv4SecondaryAddresses(VpnInterfaceSviFeatureTemplateIpv4VrrpIpv4SecondaryAddress... ipv4SecondaryAddresses) {
        ...
        @CustomType.Setter
        public Builder trackingObjects(@Nullable List<VpnInterfaceSviFeatureTemplateIpv4VrrpTrackingObject> trackingObjects) {

            this.trackingObjects = trackingObjects;
            return this;
        }
        public Builder trackingObjects(VpnInterfaceSviFeatureTemplateIpv4VrrpTrackingObject... trackingObjects) {
            return trackingObjects(List.of(trackingObjects));
        }
        public VpnInterfaceSviFeatureTemplateIpv4Vrrp build() {
            final var _resultValue = new VpnInterfaceSviFeatureTemplateIpv4Vrrp();
