...
@CustomType
public final class GetServiceLanVpnFeatureNat64V4Pool {
    /**
    ...
    private GetServiceLanVpnFeatureNat64V4Pool() {}
    /**
     * @return NAT64 v4 Pool Name
     * 
     */
    ...
    public static Builder builder(GetServiceLanVpnFeatureNat64V4Pool defaults) {
    ...
    public static final class Builder {
        ...
        private String rangeStartVariable;
        public Builder() {}
        public Builder(GetServiceLanVpnFeatureNat64V4Pool defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder nameVariable(String nameVariable) {
            if (nameVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "nameVariable");
            }
        ...
        public Builder overload(Boolean overload) {
            if (overload == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "overload");
            }
        ...
        public Builder overloadVariable(String overloadVariable) {
            if (overloadVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "overloadVariable");
            }
        ...
        public Builder rangeEnd(String rangeEnd) {
            if (rangeEnd == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "rangeEnd");
            }
        ...
        public Builder rangeEndVariable(String rangeEndVariable) {
            if (rangeEndVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "rangeEndVariable");
            }
        ...
        public Builder rangeStart(String rangeStart) {
            if (rangeStart == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "rangeStart");
            }
        ...
        public Builder rangeStartVariable(String rangeStartVariable) {
            if (rangeStartVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceLanVpnFeatureNat64V4Pool", "rangeStartVariable");
            }
            this.rangeStartVariable = rangeStartVariable;
            return this;
        }
        public GetServiceLanVpnFeatureNat64V4Pool build() {
            final var _resultValue = new GetServiceLanVpnFeatureNat64V4Pool();
