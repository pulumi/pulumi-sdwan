...
public final class SystemLoggingFeatureIpv6Server {
    ...
    public static Builder builder(SystemLoggingFeatureIpv6Server defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vpnVariable;
        public Builder() {}
        public Builder(SystemLoggingFeatureIpv6Server defaults) {
        ...
        public SystemLoggingFeatureIpv6Server build() {
            final var _resultValue = new SystemLoggingFeatureIpv6Server();
