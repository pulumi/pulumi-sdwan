...
public final class SystemAaaFeatureState extends com.pulumi.resources.ResourceArgs {

    public static final SystemAaaFeatureState Empty = new SystemAaaFeatureState();
    ...
    private SystemAaaFeatureState() {}

    private SystemAaaFeatureState(SystemAaaFeatureState $) {
    ...
    public static Builder builder(SystemAaaFeatureState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemAaaFeatureState();
        }

        public Builder(SystemAaaFeatureState defaults) {
            $ = new SystemAaaFeatureState(Objects.requireNonNull(defaults));
        }
        ...
        public SystemAaaFeatureState build() {
            return $;
        }
    }
