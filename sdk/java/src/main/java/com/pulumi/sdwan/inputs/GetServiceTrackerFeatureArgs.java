...
public final class GetServiceTrackerFeatureArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final GetServiceTrackerFeatureArgs Empty = new GetServiceTrackerFeatureArgs();
    ...
    public static Builder builder(GetServiceTrackerFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceTrackerFeatureArgs();
        }

        public Builder(GetServiceTrackerFeatureArgs defaults) {
            $ = new GetServiceTrackerFeatureArgs(Objects.requireNonNull(defaults));
        }
