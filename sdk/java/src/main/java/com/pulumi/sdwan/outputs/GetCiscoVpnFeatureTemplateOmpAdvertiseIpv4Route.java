...
import com.pulumi.sdwan.outputs.GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4RoutePrefix;
...
@CustomType
public final class GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route {
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    private Boolean optional;
    private List<GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4RoutePrefix> prefixes;
    /**
    ...
    private GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route() {}
    /**
     * @return Indicates if list item is considered optional.
     * 
     */
    ...
    public List<GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4RoutePrefix> prefixes() {
    ...
    public static Builder builder(GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route defaults) {
    ...
    public static final class Builder {
        ...
        private String routePolicyVariable;
        public Builder() {}
        public Builder(GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route defaults) {
        ...
        public Builder optional(Boolean optional) {
            if (optional == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "optional");
            }
            this.optional = optional;
            return this;
        }
        @CustomType.Setter
        public Builder prefixes(List<GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4RoutePrefix> prefixes) {
            if (prefixes == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "prefixes");
            }
            this.prefixes = prefixes;
            return this;
        }
        public Builder prefixes(GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4RoutePrefix... prefixes) {
            return prefixes(List.of(prefixes));
        }
        @CustomType.Setter
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "protocol");
            }
        ...
        public Builder protocolSubTypeVariable(String protocolSubTypeVariable) {
            if (protocolSubTypeVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "protocolSubTypeVariable");
            }
        ...
        public Builder protocolSubTypes(List<String> protocolSubTypes) {
            if (protocolSubTypes == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "protocolSubTypes");
            }
        ...
        public Builder protocolVariable(String protocolVariable) {
            if (protocolVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "protocolVariable");
            }
        ...
        public Builder routePolicy(String routePolicy) {
            if (routePolicy == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "routePolicy");
            }
        ...
        public Builder routePolicyVariable(String routePolicyVariable) {
            if (routePolicyVariable == null) {
              throw new MissingRequiredPropertyException("GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route", "routePolicyVariable");
            }
            this.routePolicyVariable = routePolicyVariable;
            return this;
        }
        public GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route build() {
            final var _resultValue = new GetCiscoVpnFeatureTemplateOmpAdvertiseIpv4Route();
