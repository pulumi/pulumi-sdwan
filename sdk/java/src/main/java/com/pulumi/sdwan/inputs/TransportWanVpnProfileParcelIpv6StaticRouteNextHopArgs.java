...
public final class TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs Empty = new TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs();
    ...
    private TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs() {}

    private TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs(TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs $) {
    ...
    public static Builder builder(TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs();
        }

        public Builder(TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs defaults) {
            $ = new TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransportWanVpnProfileParcelIpv6StaticRouteNextHopArgs build() {
            return $;
        }
    }
