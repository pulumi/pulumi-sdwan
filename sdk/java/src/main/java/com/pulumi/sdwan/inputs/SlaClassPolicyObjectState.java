...
public final class SlaClassPolicyObjectState extends com.pulumi.resources.ResourceArgs {

    public static final SlaClassPolicyObjectState Empty = new SlaClassPolicyObjectState();
    ...
    private SlaClassPolicyObjectState() {}

    private SlaClassPolicyObjectState(SlaClassPolicyObjectState $) {
    ...
    public static Builder builder(SlaClassPolicyObjectState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SlaClassPolicyObjectState();
        }

        public Builder(SlaClassPolicyObjectState defaults) {
            $ = new SlaClassPolicyObjectState(Objects.requireNonNull(defaults));
        }
        ...
        public SlaClassPolicyObjectState build() {
            return $;
        }
    }
