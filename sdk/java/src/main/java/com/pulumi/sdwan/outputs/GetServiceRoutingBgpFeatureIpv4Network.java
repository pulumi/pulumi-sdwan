...
@CustomType
public final class GetServiceRoutingBgpFeatureIpv4Network {
    ...
    private GetServiceRoutingBgpFeatureIpv4Network() {}
    ...
    public static Builder builder(GetServiceRoutingBgpFeatureIpv4Network defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetMaskVariable;
        public Builder() {}
        public Builder(GetServiceRoutingBgpFeatureIpv4Network defaults) {
        ...
        public Builder networkAddress(String networkAddress) {
            if (networkAddress == null) {
              throw new MissingRequiredPropertyException("GetServiceRoutingBgpFeatureIpv4Network", "networkAddress");
            }
        ...
        public Builder networkAddressVariable(String networkAddressVariable) {
            if (networkAddressVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceRoutingBgpFeatureIpv4Network", "networkAddressVariable");
            }
        ...
        public Builder subnetMask(String subnetMask) {
            if (subnetMask == null) {
              throw new MissingRequiredPropertyException("GetServiceRoutingBgpFeatureIpv4Network", "subnetMask");
            }
        ...
        public Builder subnetMaskVariable(String subnetMaskVariable) {
            if (subnetMaskVariable == null) {
              throw new MissingRequiredPropertyException("GetServiceRoutingBgpFeatureIpv4Network", "subnetMaskVariable");
            }
            this.subnetMaskVariable = subnetMaskVariable;
            return this;
        }
        public GetServiceRoutingBgpFeatureIpv4Network build() {
            final var _resultValue = new GetServiceRoutingBgpFeatureIpv4Network();
