...
public final class GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs Empty = new GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs();
    ...
    private GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs() {}

    private GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs(GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs $) {
    ...
    public static Builder builder(GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs();
        }

        public Builder(GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs defaults) {
            $ = new GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs build() {
            if ($.featureProfileId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs", "featureProfileId");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs", "id");
            }
            if ($.transportWanVpnFeatureId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs", "transportWanVpnFeatureId");
            }
            if ($.transportWanVpnInterfaceCellularFeatureId == null) {
                throw new MissingRequiredPropertyException("GetTransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs", "transportWanVpnInterfaceCellularFeatureId");
            }
            return $;
        }
    }
