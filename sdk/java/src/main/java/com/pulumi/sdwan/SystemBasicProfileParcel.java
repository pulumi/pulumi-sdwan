...
import com.pulumi.sdwan.SystemBasicProfileParcelArgs;
import com.pulumi.sdwan.Utilities;
import com.pulumi.sdwan.inputs.SystemBasicProfileParcelState;
import com.pulumi.sdwan.outputs.SystemBasicProfileParcelAffinityPerVrf;
import com.pulumi.sdwan.outputs.SystemBasicProfileParcelGpsSmsMobileNumber;
 ...
 * 
 */
@ResourceType(type="sdwan:index/systemBasicProfileParcel:SystemBasicProfileParcel")
public class SystemBasicProfileParcel extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="affinityPerVrfs", refs={List.class,SystemBasicProfileParcelAffinityPerVrf.class}, tree="[0,1]")
    private Output</* @Nullable */ List<SystemBasicProfileParcelAffinityPerVrf>> affinityPerVrfs;

    /**
     * @return Affinity Group Number for VRFs
     * 
     */
    public Output<Optional<List<SystemBasicProfileParcelAffinityPerVrf>>> affinityPerVrfs() {
     ...
     * 
     */
    @Export(name="gpsLatitude", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> gpsLatitude;

    /**
     * @return Set the device physical latitude - Range: `-90`-`90`
     * 
     */
    public Output<Optional<Integer>> gpsLatitude() {
     ...
     * 
     */
    @Export(name="gpsLongitude", refs={Integer.class}, tree="[0]")
    private Output</* @Nullable */ Integer> gpsLongitude;

    /**
     * @return Set the device physical longitude - Range: `-180`-`180`
     * 
     */
    public Output<Optional<Integer>> gpsLongitude() {
     ...
     * 
     */
    @Export(name="gpsSmsMobileNumbers", refs={List.class,SystemBasicProfileParcelGpsSmsMobileNumber.class}, tree="[0,1]")
    private Output</* @Nullable */ List<SystemBasicProfileParcelGpsSmsMobileNumber>> gpsSmsMobileNumbers;

    /**
     * @return Set device’s geo fencing SMS phone number
     * 
     */
    public Output<Optional<List<SystemBasicProfileParcelGpsSmsMobileNumber>>> gpsSmsMobileNumbers() {
     ...
     */
    public SystemBasicProfileParcel(java.lang.String name) {
        this(name, SystemBasicProfileParcelArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SystemBasicProfileParcel(java.lang.String name, @Nullable SystemBasicProfileParcelArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SystemBasicProfileParcel(java.lang.String name, @Nullable SystemBasicProfileParcelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemBasicProfileParcel:SystemBasicProfileParcel", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SystemBasicProfileParcel(java.lang.String name, Output<java.lang.String> id, @Nullable SystemBasicProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemBasicProfileParcel:SystemBasicProfileParcel", name, state, makeResourceOptions(options, id), false);
    }

    private static SystemBasicProfileParcelArgs makeArgs(@Nullable SystemBasicProfileParcelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SystemBasicProfileParcelArgs.Empty : args;
    }
     ...
     */
    public static SystemBasicProfileParcel get(java.lang.String name, Output<java.lang.String> id, @Nullable SystemBasicProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SystemBasicProfileParcel(name, id, state, options);
    }
}
