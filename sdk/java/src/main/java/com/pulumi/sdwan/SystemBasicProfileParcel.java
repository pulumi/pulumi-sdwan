...
public class SystemBasicProfileParcel extends com.pulumi.resources.CustomResource {
     ...
     */
    public SystemBasicProfileParcel(String name) {
     ...
     */
    public SystemBasicProfileParcel(String name, @Nullable SystemBasicProfileParcelArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SystemBasicProfileParcel(String name, @Nullable SystemBasicProfileParcelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemBasicProfileParcel:SystemBasicProfileParcel", name, args == null ? SystemBasicProfileParcelArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SystemBasicProfileParcel(String name, Output<String> id, @Nullable SystemBasicProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/systemBasicProfileParcel:SystemBasicProfileParcel", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static SystemBasicProfileParcel get(String name, Output<String> id, @Nullable SystemBasicProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
