...
import com.pulumi.sdwan.outputs.ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistribution;
...
@CustomType
public final class ServiceLanVpnProfileParcelRouteLeakToGlobalVpn {
    /**
     * @return Redistribute Routes to specific Protocol on Global VPN
     * 
     */
    private @Nullable List<ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistribution> redistributions;
    ...
    private ServiceLanVpnProfileParcelRouteLeakToGlobalVpn() {}
    /**
     * @return Redistribute Routes to specific Protocol on Global VPN
     * 
     */
    public List<ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistribution> redistributions() {
    ...
    public static Builder builder(ServiceLanVpnProfileParcelRouteLeakToGlobalVpn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String routeProtocolVariable;
        public Builder() {}
        public Builder(ServiceLanVpnProfileParcelRouteLeakToGlobalVpn defaults) {
        ...
        @CustomType.Setter
        public Builder redistributions(@Nullable List<ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistribution> redistributions) {

            this.redistributions = redistributions;
            return this;
        }
        public Builder redistributions(ServiceLanVpnProfileParcelRouteLeakToGlobalVpnRedistribution... redistributions) {
        ...
        public ServiceLanVpnProfileParcelRouteLeakToGlobalVpn build() {
            final var _resultValue = new ServiceLanVpnProfileParcelRouteLeakToGlobalVpn();
