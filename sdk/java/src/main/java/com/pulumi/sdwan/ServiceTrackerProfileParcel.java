...
public class ServiceTrackerProfileParcel extends com.pulumi.resources.CustomResource {
     ...
     */
    public ServiceTrackerProfileParcel(String name) {
     ...
     */
    public ServiceTrackerProfileParcel(String name, ServiceTrackerProfileParcelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/serviceTrackerProfileParcel:ServiceTrackerProfileParcel", name, args == null ? ServiceTrackerProfileParcelArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ServiceTrackerProfileParcel(String name, Output<String> id, @Nullable ServiceTrackerProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("sdwan:index/serviceTrackerProfileParcel:ServiceTrackerProfileParcel", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ServiceTrackerProfileParcel get(String name, Output<String> id, @Nullable ServiceTrackerProfileParcelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
