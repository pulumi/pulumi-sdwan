...
public final class CedgeGlobalFeatureTemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CedgeGlobalFeatureTemplateArgs() {}

    private CedgeGlobalFeatureTemplateArgs(CedgeGlobalFeatureTemplateArgs $) {
    ...
    public static Builder builder(CedgeGlobalFeatureTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CedgeGlobalFeatureTemplateArgs();
        }

        public Builder(CedgeGlobalFeatureTemplateArgs defaults) {
            $ = new CedgeGlobalFeatureTemplateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CedgeGlobalFeatureTemplateArgs build() {
            if ($.description == null) {
                throw new MissingRequiredPropertyException("CedgeGlobalFeatureTemplateArgs", "description");
            }
            if ($.deviceTypes == null) {
                throw new MissingRequiredPropertyException("CedgeGlobalFeatureTemplateArgs", "deviceTypes");
            }
            return $;
        }
    }
